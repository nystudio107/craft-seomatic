 ...
 */
class Pond extends MetaJsonLd implements PondInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
    use PondTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Pond';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Pond';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A pond.';
