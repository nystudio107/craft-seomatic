 ...
 * RadioChannel - A unique instance of a radio BroadcastService on a CableOrSatelliteService
 * lineup.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class RadioChannel extends MetaJsonLd implements RadioChannelInterface, BroadcastChannelInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'RadioChannel';
