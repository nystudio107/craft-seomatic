...
class RadioChannel extends BroadcastChannel
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RadioChannel';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RadioChannel';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A unique instance of a radio BroadcastService on a CableOrSatelliteService lineup.';
