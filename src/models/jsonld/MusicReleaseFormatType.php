...
/**
 * MusicReleaseFormatType - Format of this release (the type of recording
 * media used, ie. compact disc, digital media, LP, etc.).
 * Extends: Enumeration
...
class MusicReleaseFormatType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MusicReleaseFormatType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MusicReleaseFormatType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Format of this release (the type of recording media used, ie. compact disc, digital media, LP, etc.).';
