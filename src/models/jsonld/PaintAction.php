...
/**
 * PaintAction - The act of producing a painting, typically with paint and
...
class PaintAction extends CreateAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PaintAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PaintAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of producing a painting, typically with paint and canvas as instruments.';
