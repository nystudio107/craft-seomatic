...
class PaintAction extends CreateAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PaintAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PaintAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of producing a painting, typically with paint and canvas as instruments.';
