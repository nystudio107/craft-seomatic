 ...
 */
class DriveWheelConfigurationValue extends MetaJsonLd implements DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DriveWheelConfigurationValue';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DriveWheelConfigurationValue';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'QualitativeValue';
