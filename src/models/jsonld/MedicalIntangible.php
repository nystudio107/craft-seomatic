...
/**
 * MedicalIntangible - A utility class that serves as the umbrella for a
 * number of 'intangible' things in the medical space.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MedicalIntangible extends MedicalEntity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalIntangible';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MedicalIntangible';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A utility class that serves as the umbrella for a number of \'intangible\' things in the medical space.';
