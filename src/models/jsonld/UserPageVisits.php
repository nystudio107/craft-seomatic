 ...
 * UserPageVisits - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserPageVisits extends MetaJsonLd implements UserPageVisitsInterface, UserInteractionInterface, EventInterface, ThingInterface
{
	use UserPageVisitsTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'UserPageVisits';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/UserPageVisits';
