...
class InternetCafe extends MetaJsonLd implements InternetCafeInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'InternetCafe';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/InternetCafe';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An internet cafe.';
