 ...
 */
class InternetCafe extends MetaJsonLd implements InternetCafeInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use InternetCafeTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'InternetCafe';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/InternetCafe';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An internet cafe.';
