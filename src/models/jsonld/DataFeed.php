 ...
 * DataFeed - A single feed providing structured information about one or more entities
 * or topics.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class DataFeed extends MetaJsonLd implements DataFeedInterface, DatasetInterface, CreativeWorkInterface, ThingInterface
{
    use DataFeedTrait;
    use DatasetTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DataFeed';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DataFeed';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'Dataset';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A single feed providing structured information about one or more entities or topics.';
