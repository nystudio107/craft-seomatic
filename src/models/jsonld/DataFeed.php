...
class DataFeed extends MetaJsonLd implements DataFeedInterface, DatasetInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DataFeed';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DataFeed';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Dataset';
