...
/**
 * UsageOrScheduleHealthAspect - Content about how, when, frequency and dosage
 * of a topic.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/UsageOrScheduleHealthAspect
 */
class UsageOrScheduleHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'UsageOrScheduleHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Content about how, when, frequency and dosage of a topic.';
