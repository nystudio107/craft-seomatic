...
class UsageOrScheduleHealthAspect extends MetaJsonLd implements UsageOrScheduleHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UsageOrScheduleHealthAspect';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UsageOrScheduleHealthAspect';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Content about how, when, frequency and dosage of a topic.';
