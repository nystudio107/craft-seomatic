...
/**
 * MedicalGuidelineContraindication - A guideline contraindication that
 * designates a process as harmful and where quality of the data supporting
...
class MedicalGuidelineContraindication extends MedicalGuideline
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A guideline contraindication that designates a process as harmful and where quality of the data supporting the contraindication is sound.';
