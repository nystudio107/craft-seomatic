 ...
 * MedicalGuidelineContraindication - A guideline contraindication that designates a process as harmful and where
 ...
 */
class MedicalGuidelineContraindication extends MetaJsonLd implements MedicalGuidelineContraindicationInterface, MedicalGuidelineInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalGuidelineContraindication';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalGuidelineContraindication';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalGuideline';
...
SCHEMADESC;
    ...
    use MedicalGuidelineContraindicationTrait;
