...
class EmailMessage extends MetaJsonLd implements EmailMessageInterface, MessageInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'EmailMessage';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/EmailMessage';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Message';
