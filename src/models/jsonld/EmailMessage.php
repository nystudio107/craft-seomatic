 ...
 */
class EmailMessage extends MetaJsonLd implements EmailMessageInterface, MessageInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EmailMessage';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EmailMessage';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'Message';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An email message.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'bccRecipient' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]', 'array', 'ContactPoint', 'ContactPoint[]'],
            'ccRecipient' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]', 'array', 'ContactPoint', 'ContactPoint[]'],
            ...
            'dateRead' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]'],
            'dateReceived' => ['array', 'DateTime', 'DateTime[]'],
            'dateSent' => ['array', 'DateTime', 'DateTime[]'],
            ...
            'messageAttachment' => ['array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'recipient' => ['array', 'Organization', 'Organization[]', 'array', 'Audience', 'Audience[]', 'array', 'Person', 'Person[]', 'array', 'ContactPoint', 'ContactPoint[]'],
            ...
            'sender' => ['array', 'Organization', 'Organization[]', 'array', 'Audience', 'Audience[]', 'array', 'Person', 'Person[]'],
            ...
            'toRecipient' => ['array', 'Organization', 'Organization[]', 'array', 'Audience', 'Audience[]', 'array', 'Person', 'Person[]', 'array', 'ContactPoint', 'ContactPoint[]'],
