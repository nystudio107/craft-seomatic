...
class EmailMessage extends Message
{
     ...
     * @var string
     */
    static $schemaTypeName = 'EmailMessage';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/EmailMessage';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An email message.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Message';
