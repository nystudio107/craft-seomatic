...
class EmailMessage extends MetaJsonLd implements EmailMessageInterface, MessageInterface, CreativeWorkInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'bccRecipient' => ['array', 'ContactPoint', 'ContactPoint[]', 'array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'ccRecipient' => ['array', 'ContactPoint', 'ContactPoint[]', 'array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'recipient' => ['array', 'Audience', 'Audience[]', 'array', 'ContactPoint', 'ContactPoint[]', 'array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'sender' => ['array', 'Audience', 'Audience[]', 'array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'toRecipient' => ['array', 'Audience', 'Audience[]', 'array', 'ContactPoint', 'ContactPoint[]', 'array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
