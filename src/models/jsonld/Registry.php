 ...
 */
class Registry extends MetaJsonLd implements RegistryInterface, MedicalObservationalStudyDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Registry';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Registry';
