 ...
 * clarifications, anecdotes, documentation, etc., on an issue, for reporting
 * purposes.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class AskPublicNewsArticle extends NewsArticle
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AskPublicNewsArticle';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A NewsArticle expressing an open call by a NewsMediaOrganization asking the public for input, insights, clarifications, anecdotes, documentation, etc., on an issue, for reporting purposes.';
