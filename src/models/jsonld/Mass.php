...
class Mass extends Quantity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Mass';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Mass';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Properties that take Mass as values are of the form \'<Number> <Mass unit of measure>\'. E.g., \'7 kg\'.';
