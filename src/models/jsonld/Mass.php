...
/**
 * Mass - Properties that take Mass as values are of the form '<Number> <Mass
...
class Mass extends Quantity
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Mass';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Mass';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Properties that take Mass as values are of the form \'<Number> <Mass unit of measure>\'. E.g., \'7 kg\'.';
