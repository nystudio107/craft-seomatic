...
class Order extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Order';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Order';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An order is a confirmation of a transaction (a receipt), which can contain multiple line items, each represented by an Offer that has been accepted by the customer.';
