 ...
 */
class NewsMediaOrganization extends MetaJsonLd implements NewsMediaOrganizationInterface, OrganizationInterface, ThingInterface
{
	use NewsMediaOrganizationTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'NewsMediaOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/NewsMediaOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A News/Media organization such as a newspaper or TV station.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'masthead' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
		    ...
		    'missionCoveragePrioritiesPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
		    'naics' => ['array', 'Text', 'Text[]'],
		    'name' => ['array', 'Text', 'Text[]'],
		    'noBylinesPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
		    ...
		    'verificationFactCheckingPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]']
		];
	}
