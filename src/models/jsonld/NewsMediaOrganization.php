...
class NewsMediaOrganization extends MetaJsonLd implements NewsMediaOrganizationInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'NewsMediaOrganization';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/NewsMediaOrganization';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'url' => ['URL'],
            'vatID' => ['Text'],
            'verificationFactCheckingPolicy' => ['URL', 'CreativeWork']
        ];
    }
