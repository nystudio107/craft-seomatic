...
class NewsMediaOrganization extends MetaJsonLd implements NewsMediaOrganizationInterface, OrganizationInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'missionCoveragePrioritiesPolicy' => ['array', 'URL', 'URL[]', 'array', 'CreativeWork', 'CreativeWork[]'],
            'naics' => ['array', 'Text', 'Text[]'],
            'name' => ['array', 'Text', 'Text[]'],
            'noBylinesPolicy' => ['array', 'URL', 'URL[]', 'array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'verificationFactCheckingPolicy' => ['array', 'URL', 'URL[]', 'array', 'CreativeWork', 'CreativeWork[]'],
        ];
    }
