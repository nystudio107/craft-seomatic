...
class NewsMediaOrganization extends MetaJsonLd implements NewsMediaOrganizationInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'NewsMediaOrganization';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/NewsMediaOrganization';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A News/Media organization such as a newspaper or TV station.';
