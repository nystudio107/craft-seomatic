 ...
 */
class SideEffectsHealthAspect extends MetaJsonLd implements SideEffectsHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SideEffectsHealthAspect';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SideEffectsHealthAspect';
...
SCHEMADESC;
    ...
    use SideEffectsHealthAspectTrait;
