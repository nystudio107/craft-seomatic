...
/**
 * SideEffectsHealthAspect - Side effects that can be observed from the usage
 * of the topic.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/SideEffectsHealthAspect
 */
class SideEffectsHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SideEffectsHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Side effects that can be observed from the usage of the topic.';
