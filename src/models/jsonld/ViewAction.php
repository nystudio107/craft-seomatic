...
class ViewAction extends MetaJsonLd implements ViewActionInterface, ConsumeActionInterface, ActionInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ViewAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ViewAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'The act of consuming static visual content.';
