 ...
 */
class ViewAction extends MetaJsonLd implements ViewActionInterface, ConsumeActionInterface, ActionInterface, ThingInterface
{
    use ViewActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ViewAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ViewAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of consuming static visual content.';
