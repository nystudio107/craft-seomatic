 ...
 * ReservationPackage - A group of multiple reservations with common values for all
 * sub-reservations.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class ReservationPackage extends MetaJsonLd implements ReservationPackageInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ReservationPackage';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ReservationPackage';
