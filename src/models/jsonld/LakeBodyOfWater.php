...
class LakeBodyOfWater extends BodyOfWater
{
     ...
     * @var string
     */
    static $schemaTypeName = 'LakeBodyOfWater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/LakeBodyOfWater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A lake (for example, Lake Pontrachain).';
