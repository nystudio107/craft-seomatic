 ...
 */
class LakeBodyOfWater extends MetaJsonLd implements LakeBodyOfWaterInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	use LakeBodyOfWaterTrait;
