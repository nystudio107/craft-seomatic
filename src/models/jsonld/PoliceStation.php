 ...
 */
class PoliceStation extends MetaJsonLd implements PoliceStationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, EmergencyServiceInterface, LocalBusinessInterface, OrganizationInterface
{
    use PoliceStationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PoliceStation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PoliceStation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A police station.';
