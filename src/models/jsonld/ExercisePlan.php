 ...
 * ExercisePlan - Fitness-related activity designed for a specific health-related purpose,
...
class ExercisePlan extends MetaJsonLd implements ExercisePlanInterface, CreativeWorkInterface, ThingInterface, PhysicalActivityInterface, LifestyleModificationInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ExercisePlan';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ExercisePlan';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'activityDuration' => ['array', 'QuantitativeValue', 'QuantitativeValue[]', 'array', 'Duration', 'Duration[]'],
            'activityFrequency' => ['array', 'Text', 'Text[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
            'additionalType' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'additionalVariable' => ['array', 'Text', 'Text[]'],
            ...
            'intensity' => ['array', 'QuantitativeValue', 'QuantitativeValue[]', 'array', 'Text', 'Text[]'],
            ...
            'repetitions' => ['array', 'Number', 'Number[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
            'restPeriods' => ['array', 'QuantitativeValue', 'QuantitativeValue[]', 'array', 'Text', 'Text[]'],
            ...
            'workload' => ['array', 'Energy', 'Energy[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
        ];
    }
