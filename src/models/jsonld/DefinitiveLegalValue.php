 ...
 * DefinitiveLegalValue - Indicates a document for which the text is conclusively what the law says
 * and is legally binding. (e.g. The digitally signed version of an Official
 * Journal.)   Something "Definitive" is considered to be also
 ...
 */
class DefinitiveLegalValue extends MetaJsonLd implements DefinitiveLegalValueInterface, LegalValueLevelInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DefinitiveLegalValue';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DefinitiveLegalValue';
...
SCHEMADESC;
    ...
    use DefinitiveLegalValueTrait;
    use LegalValueLevelTrait;
