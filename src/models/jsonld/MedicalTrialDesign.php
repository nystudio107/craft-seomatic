 ...
 */
class MedicalTrialDesign extends MetaJsonLd implements MedicalTrialDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalTrialDesign';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalTrialDesign';
