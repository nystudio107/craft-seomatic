 ...
 */
class Ear extends MetaJsonLd implements EarInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
    use EarTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Ear';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Ear';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Ear function assessment with clinical examination.';
