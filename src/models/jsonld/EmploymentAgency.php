 ...
 */
class EmploymentAgency extends MetaJsonLd implements EmploymentAgencyInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use EmploymentAgencyTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EmploymentAgency';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EmploymentAgency';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An employment agency.';
