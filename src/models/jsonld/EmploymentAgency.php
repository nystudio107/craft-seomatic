...
class EmploymentAgency extends MetaJsonLd implements EmploymentAgencyInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'EmploymentAgency';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/EmploymentAgency';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'An employment agency.';
