...
class ReserveAction extends MetaJsonLd implements ReserveActionInterface, PlanActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ReserveAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ReserveAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PlanAction';
