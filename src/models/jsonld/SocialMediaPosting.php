 ...
 * SocialMediaPosting - A post to a social media platform, including blog posts, tweets, Facebook
 * posts, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class SocialMediaPosting extends MetaJsonLd implements SocialMediaPostingInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
