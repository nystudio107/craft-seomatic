 ...
 */
class VenueMap extends MetaJsonLd implements VenueMapInterface, MapCategoryTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VenueMap';
