 ...
 */
class BowlingAlley extends MetaJsonLd implements BowlingAlleyInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use BowlingAlleyTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BowlingAlley';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BowlingAlley';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bowling alley.';
