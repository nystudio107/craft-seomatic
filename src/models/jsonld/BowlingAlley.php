...
class BowlingAlley extends MetaJsonLd implements BowlingAlleyInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'BowlingAlley';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/BowlingAlley';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A bowling alley.';
