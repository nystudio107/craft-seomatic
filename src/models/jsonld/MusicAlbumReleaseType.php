...
class MusicAlbumReleaseType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MusicAlbumReleaseType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MusicAlbumReleaseType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The kind of release which this album is: single, EP or album.';
