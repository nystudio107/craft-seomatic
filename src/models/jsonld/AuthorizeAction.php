 ...
 */
class AuthorizeAction extends MetaJsonLd implements AuthorizeActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AuthorizeAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AuthorizeAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of granting permission to an object.';
