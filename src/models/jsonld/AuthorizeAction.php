...
class AuthorizeAction extends MetaJsonLd implements AuthorizeActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AuthorizeAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AuthorizeAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of granting permission to an object.';
