 ...
 */
class AutoPartsStore extends MetaJsonLd implements AutoPartsStoreInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, StoreInterface
{
	use AutoPartsStoreTrait;
