 ...
 */
class AutoPartsStore extends MetaJsonLd implements AutoPartsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, AutomotiveBusinessInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'AutoPartsStore';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/AutoPartsStore';
