...
/**
 * Consortium - A Consortium is a membership Organization whose members are
 * typically Organizations.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/Consortium
 */
class Consortium extends Organization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Consortium';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A Consortium is a membership Organization whose members are typically Organizations.';
