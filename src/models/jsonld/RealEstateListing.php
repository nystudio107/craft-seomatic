 ...
 * RealEstateListing - A [[RealEstateListing]] is a listing that describes one or more real-estate
 ...
 */
class RealEstateListing extends MetaJsonLd implements RealEstateListingInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	use RealEstateListingTrait;
	use WebPageTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'RealEstateListing';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/RealEstateListing';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = "A [[RealEstateListing]] is a listing that describes one or more real-estate [[Offer]]s (whose [[businessFunction]] is typically to lease out, or to sell).\n  The [[RealEstateListing]] type itself represents the overall listing, as manifested in some [[WebPage]].\n  ";
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'breadcrumb' => ['array', 'BreadcrumbList', 'BreadcrumbList[]', 'array', 'Text', 'Text[]'],
		    ...
		    'mainContentOfPage' => ['array', 'WebPageElement', 'WebPageElement[]'],
		    ...
		    'primaryImageOfPage' => ['array', 'ImageObject', 'ImageObject[]'],
		    ...
		    'relatedLink' => ['array', 'URL', 'URL[]'],
		    'releasedEvent' => ['array', 'PublicationEvent', 'PublicationEvent[]'],
		    'review' => ['array', 'Review', 'Review[]'],
		    'reviewedBy' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    ...
		    'significantLink' => ['array', 'URL', 'URL[]'],
		    'significantLinks' => ['array', 'URL', 'URL[]'],
		    ...
		    'speakable' => ['array', 'SpeakableSpecification', 'SpeakableSpecification[]', 'array', 'URL', 'URL[]'],
		    'specialty' => ['array', 'Specialty', 'Specialty[]'],
