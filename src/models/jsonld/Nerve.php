 ...
 */
class Nerve extends MetaJsonLd implements NerveInterface, AnatomicalStructureInterface, MedicalEntityInterface, ThingInterface
{
    use NerveTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'branch' => ['array', 'AnatomicalStructure', 'AnatomicalStructure[]'],
            ...
            'nerveMotor' => ['array', 'Muscle', 'Muscle[]'],
            ...
            'sensoryUnit' => ['array', 'AnatomicalStructure', 'AnatomicalStructure[]', 'array', 'SuperficialAnatomy', 'SuperficialAnatomy[]'],
            'sourcedFrom' => ['array', 'BrainStructure', 'BrainStructure[]'],
