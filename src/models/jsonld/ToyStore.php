 ...
 */
class ToyStore extends MetaJsonLd implements ToyStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use ToyStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ToyStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ToyStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A toy store.';
