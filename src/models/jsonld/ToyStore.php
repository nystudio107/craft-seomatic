 ...
 */
class ToyStore extends MetaJsonLd implements ToyStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use ToyStoreTrait;
    use StoreTrait;
