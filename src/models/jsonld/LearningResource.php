...
class LearningResource extends MetaJsonLd implements LearningResourceInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LearningResource';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LearningResource';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'competencyRequired' => ['Text', 'DefinedTerm', 'URL'],
