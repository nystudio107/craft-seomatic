 ...
 */
class BeautySalon extends MetaJsonLd implements BeautySalonInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use BeautySalonTrait;
