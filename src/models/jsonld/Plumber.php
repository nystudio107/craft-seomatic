 ...
 */
class Plumber extends MetaJsonLd implements PlumberInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use PlumberTrait;
