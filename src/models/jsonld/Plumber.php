 ...
 */
class Plumber extends MetaJsonLd implements PlumberInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use PlumberTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Plumber';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Plumber';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A plumbing service.';
