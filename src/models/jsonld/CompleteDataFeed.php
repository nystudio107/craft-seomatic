 ...
 * CompleteDataFeed - A [[CompleteDataFeed]] is a [[DataFeed]] whose standard representation
 * includes content for every item currently in the feed.  This is the
 * equivalent of Atom's element as defined in Feed Paging and Archiving [RFC
 * 5005](https://tools.ietf.org/html/rfc5005), for example (and as defined for
 * Atom), when using data from a feed that represents a collection of items
 * that varies over time (e.g. "Top Twenty Records") there is no need to have
 * newer entries mixed in alongside older, obsolete entries. By marking this
 * feed as a CompleteDataFeed, old entries can be safely discarded when the
 * feed is refreshed, since we can assume the feed has provided descriptions
 ...
 */
class CompleteDataFeed extends MetaJsonLd implements CompleteDataFeedInterface, DataFeedInterface, DatasetInterface, CreativeWorkInterface, ThingInterface
{
    use CompleteDataFeedTrait;
    use DataFeedTrait;
    use DatasetTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CompleteDataFeed';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CompleteDataFeed';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'DataFeed';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "A [[CompleteDataFeed]] is a [[DataFeed]] whose standard representation includes content for every item currently in the feed.\n\nThis is the equivalent of Atom's element as defined in Feed Paging and Archiving [RFC 5005](https://tools.ietf.org/html/rfc5005), for example (and as defined for Atom), when using data from a feed that represents a collection of items that varies over time (e.g. \"Top Twenty Records\") there is no need to have newer entries mixed in alongside older, obsolete entries. By marking this feed as a CompleteDataFeed, old entries can be safely discarded when the feed is refreshed, since we can assume the feed has provided descriptions for all current items.";
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'catalog' => ['array', 'DataCatalog', 'DataCatalog[]'],
            ...
            'dataFeedElement' => ['array', 'Text', 'Text[]', 'array', 'DataFeedItem', 'DataFeedItem[]', 'array', 'Thing', 'Thing[]'],
            'datasetTimeInterval' => ['array', 'DateTime', 'DateTime[]'],
            ...
            'distribution' => ['array', 'DataDownload', 'DataDownload[]'],
            ...
            'includedDataCatalog' => ['array', 'DataCatalog', 'DataCatalog[]'],
            'includedInDataCatalog' => ['array', 'DataCatalog', 'DataCatalog[]'],
