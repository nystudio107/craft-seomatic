 ...
 */
class DeleteAction extends MetaJsonLd implements DeleteActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DeleteAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DeleteAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of editing a recipient by removing one of its objects.';
