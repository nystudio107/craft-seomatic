 ...
 */
class MusicVideoObject extends MetaJsonLd implements MusicVideoObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
	use MusicVideoObjectTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'MusicVideoObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/MusicVideoObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A music video file.';
