...
class MusicVideoObject extends MetaJsonLd implements MusicVideoObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MusicVideoObject';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MusicVideoObject';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A music video file.';
