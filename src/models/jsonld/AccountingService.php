 ...
 * AccountingService - Accountancy business.  As a [[LocalBusiness]] it can be described as a
 ...
 */
class AccountingService extends MetaJsonLd implements AccountingServiceInterface, FinancialServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AccountingService';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AccountingService';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "Accountancy business.\\n\\nAs a [[LocalBusiness]] it can be described as a [[provider]] of one or more [[Service]]\\(s).\n      ";
