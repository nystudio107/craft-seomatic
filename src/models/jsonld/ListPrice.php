 ...
 * ListPrice - Represents the list price of an offered product. Typically the same as the
 ...
 */
class ListPrice extends MetaJsonLd implements ListPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use ListPriceTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ListPrice';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ListPrice';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Represents the list price of an offered product. Typically the same as the [MSRP](https://schema.org/MSRP).';
