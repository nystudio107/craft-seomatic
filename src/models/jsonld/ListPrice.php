...
class ListPrice extends MetaJsonLd implements ListPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ListPrice';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ListPrice';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Represents the list price of an offered product. Typically the same as the [MSRP](https://schema.org/MSRP).';
