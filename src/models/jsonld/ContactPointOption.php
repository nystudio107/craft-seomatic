...
class ContactPointOption extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ContactPointOption';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ContactPointOption';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Enumerated options related to a ContactPoint.';
