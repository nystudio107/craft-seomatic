...
class ContactPointOption extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ContactPointOption';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ContactPointOption';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Enumerated options related to a ContactPoint.';
