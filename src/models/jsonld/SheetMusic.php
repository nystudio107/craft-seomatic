 ...
 */
class SheetMusic extends MetaJsonLd implements SheetMusicInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SheetMusic';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SheetMusic';
