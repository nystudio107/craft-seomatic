 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/SheetMusic
 */
class SheetMusic extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SheetMusic';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Printed music, as opposed to performed or recorded music.';
