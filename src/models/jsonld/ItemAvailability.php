...
class ItemAvailability extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ItemAvailability';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ItemAvailability';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A list of possible product availability options.';
