 ...
 */
class InfectiousAgentClass extends MetaJsonLd implements InfectiousAgentClassInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'InfectiousAgentClass';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/InfectiousAgentClass';
