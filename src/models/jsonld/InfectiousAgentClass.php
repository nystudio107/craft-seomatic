...
/**
 * InfectiousAgentClass - Classes of agents or pathogens that transmit
 * infectious diseases. Enumerated type.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class InfectiousAgentClass extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'InfectiousAgentClass';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Classes of agents or pathogens that transmit infectious diseases. Enumerated type.';
