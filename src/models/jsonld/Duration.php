...
class Duration extends Quantity
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Duration';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Duration';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Quantity: Duration (use ISO 8601 duration format).';
