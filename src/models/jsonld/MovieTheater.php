 ...
 */
class MovieTheater extends MetaJsonLd implements MovieTheaterInterface, CivicStructureInterface, PlaceInterface, ThingInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface
{
    use MovieTheaterTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MovieTheater';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MovieTheater';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A movie theater.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'screenCount' => ['array', 'Number', 'Number[]'],
