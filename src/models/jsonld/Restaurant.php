 ...
 */
class Restaurant extends MetaJsonLd implements RestaurantInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use RestaurantTrait;
