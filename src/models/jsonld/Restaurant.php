 ...
 */
class Restaurant extends MetaJsonLd implements RestaurantInterface, FoodEstablishmentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use RestaurantTrait;
