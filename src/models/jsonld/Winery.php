 ...
 */
class Winery extends MetaJsonLd implements WineryInterface, FoodEstablishmentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use WineryTrait;
