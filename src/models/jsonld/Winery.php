 ...
 */
class Winery extends MetaJsonLd implements WineryInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use WineryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Winery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Winery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A winery.';
