...
class GatedResidenceCommunity extends Residence
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GatedResidenceCommunity';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GatedResidenceCommunity';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Residence type: Gated community.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Residence';
