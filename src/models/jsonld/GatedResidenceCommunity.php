 ...
 */
class GatedResidenceCommunity extends MetaJsonLd implements GatedResidenceCommunityInterface, ResidenceInterface, PlaceInterface, ThingInterface
{
    use GatedResidenceCommunityTrait;
    use ResidenceTrait;
    use PlaceTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'GatedResidenceCommunity';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/GatedResidenceCommunity';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Residence type: Gated community.';
