...
class Continent extends Landform
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Continent';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Continent';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'One of the continents (for example, Europe or Africa).';
