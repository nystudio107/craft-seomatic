...
class Continent extends Landform
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Continent';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Continent';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'One of the continents (for example, Europe or Africa).';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Landform';
