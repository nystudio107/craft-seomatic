 ...
 * FullGameAvailability - Indicates full game availability.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class FullGameAvailability extends MetaJsonLd implements FullGameAvailabilityInterface, GameAvailabilityEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'FullGameAvailability';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/FullGameAvailability';
