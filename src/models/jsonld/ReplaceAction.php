 ...
 * ReplaceAction - The act of editing a recipient by replacing an old object with a new
 * object.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class ReplaceAction extends MetaJsonLd implements ReplaceActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
    use ReplaceActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ReplaceAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ReplaceAction';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'UpdateAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of editing a recipient by replacing an old object with a new object.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'replacee' => ['array', 'Thing', 'Thing[]'],
            'replacer' => ['array', 'Thing', 'Thing[]'],
            ...
            'targetCollection' => ['array', 'Thing', 'Thing[]'],
            'url' => ['array', 'URL', 'URL[]'],
        ];
    }
