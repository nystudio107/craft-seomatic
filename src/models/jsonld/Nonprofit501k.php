...
class Nonprofit501k extends MetaJsonLd implements Nonprofit501kInterface, USNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Nonprofit501k';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Nonprofit501k';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Nonprofit501k: Non-profit type referring to Child Care Organizations.';
