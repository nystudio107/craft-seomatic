 ...
 * UserComments - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserComments extends MetaJsonLd implements UserCommentsInterface, UserInteractionInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'UserComments';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/UserComments';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'UserInteraction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use [[Action]]-based vocabulary, alongside types such as [[Comment]].';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'commentText' => ['array', 'Text', 'Text[]'],
		    'commentTime' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]'],
		    ...
		    'discusses' => ['array', 'CreativeWork', 'CreativeWork[]'],
