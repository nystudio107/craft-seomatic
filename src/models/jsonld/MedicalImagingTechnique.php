...
/**
 * MedicalImagingTechnique - Any medical imaging modality typically used for
 * diagnostic purposes. Enumerated type.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MedicalImagingTechnique extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalImagingTechnique';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Any medical imaging modality typically used for diagnostic purposes. Enumerated type.';
