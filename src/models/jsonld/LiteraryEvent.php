 ...
 */
class LiteraryEvent extends MetaJsonLd implements LiteraryEventInterface, EventInterface, ThingInterface
{
    use LiteraryEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'LiteraryEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/LiteraryEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Literary event.';
