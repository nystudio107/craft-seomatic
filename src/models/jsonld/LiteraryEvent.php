...
class LiteraryEvent extends MetaJsonLd implements LiteraryEventInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'LiteraryEvent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/LiteraryEvent';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Event type: Literary event.';
