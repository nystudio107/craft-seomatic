...
class DigitalDocumentPermissionType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DigitalDocumentPermissionType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DigitalDocumentPermissionType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A type of permission which can be granted for accessing a digital document.';
