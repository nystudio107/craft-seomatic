 ...
 * for accessing a digital document.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class DigitalDocumentPermissionType extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DigitalDocumentPermissionType';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DigitalDocumentPermissionType';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A type of permission which can be granted for accessing a digital document.';
