...
class RentalCarReservation extends MetaJsonLd implements RentalCarReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'RentalCarReservation';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/RentalCarReservation';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A reservation for a rental car.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations.';
