...
use nystudio107\seomatic\models\jsonld\BroadcastService;

/**
 * RadioBroadcastService - A delivery service through which radio content is
 * provided via broadcast over the air or online.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class RadioBroadcastService extends BroadcastService
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A delivery service through which radio content is provided via broadcast over the air or online.';
