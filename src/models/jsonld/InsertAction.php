 ...
 */
class InsertAction extends MetaJsonLd implements InsertActionInterface, AddActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'InsertAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/InsertAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'AddAction';
