...
class BloodTest extends MetaJsonLd implements BloodTestInterface, MedicalTestInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BloodTest';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BloodTest';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A medical test performed on a sample of a patient\'s blood.';
