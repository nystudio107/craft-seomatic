...
class HotelRoom extends MetaJsonLd implements HotelRoomInterface, RoomInterface, AccommodationInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HotelRoom';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/HotelRoom';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Room';
