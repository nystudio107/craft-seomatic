 ...
 */
class AmusementPark extends MetaJsonLd implements AmusementParkInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use AmusementParkTrait;
