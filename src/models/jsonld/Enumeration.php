...
class Enumeration extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Enumeration';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Enumeration';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Lists or enumerations—for example, a list of cuisines or music genres, etc.';
