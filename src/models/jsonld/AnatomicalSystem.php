...
class AnatomicalSystem extends MetaJsonLd implements AnatomicalSystemInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AnatomicalSystem';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AnatomicalSystem';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'comprisedOf' => ['array', 'AnatomicalSystem', 'AnatomicalSystem[]', 'array', 'AnatomicalStructure', 'AnatomicalStructure[]'],
            ...
            'relatedStructure' => ['array', 'AnatomicalStructure', 'AnatomicalStructure[]'],
