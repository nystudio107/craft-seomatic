 ...
 * CommunityHealth - A field of public health focusing on improving health characteristics of a
 ...
 */
class CommunityHealth extends MetaJsonLd implements CommunityHealthInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use CommunityHealthTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'CommunityHealth';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/CommunityHealth';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A field of public health focusing on improving health characteristics of a defined population in relation with their geographical or environment areas.';
