 ...
 */
class Book extends MetaJsonLd implements BookInterface, CreativeWorkInterface, ThingInterface
{
    use BookTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Book';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Book';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A book.';
