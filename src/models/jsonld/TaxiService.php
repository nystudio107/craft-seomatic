 ...
 * TaxiService - A service for a vehicle for hire with a driver for local travel. Fares are
 ...
 */
class TaxiService extends MetaJsonLd implements TaxiServiceInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TaxiService';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TaxiService';
