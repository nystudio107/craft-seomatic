 ...
 */
class ComputerStore extends MetaJsonLd implements ComputerStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ComputerStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ComputerStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ComputerStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A computer store.';
