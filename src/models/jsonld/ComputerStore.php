...
class ComputerStore extends MetaJsonLd implements ComputerStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ComputerStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ComputerStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A computer store.';
