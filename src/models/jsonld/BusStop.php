 ...
 */
class BusStop extends MetaJsonLd implements BusStopInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use BusStopTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BusStop';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BusStop';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bus stop.';
