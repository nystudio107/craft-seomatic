 ...
 */
class TaxiStand extends MetaJsonLd implements TaxiStandInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use TaxiStandTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TaxiStand';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TaxiStand';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A taxi stand.';
