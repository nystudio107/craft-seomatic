 ...
 * OperatingSystem - System software that manages computer hardware and software resources, and
 ...
 */
class OperatingSystem extends MetaJsonLd implements OperatingSystemInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'OperatingSystem';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/OperatingSystem';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'System software that manages computer hardware and software resources, and provides common services for computer programs.';
