...
class OperatingSystem extends MetaJsonLd implements OperatingSystemInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'OperatingSystem';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/OperatingSystem';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'System software that manages computer hardware and software resources, and provides common services for computer programs.';
