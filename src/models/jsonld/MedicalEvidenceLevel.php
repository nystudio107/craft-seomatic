...
/**
 * MedicalEvidenceLevel - Level of evidence for a medical guideline.
 * Enumerated type.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MedicalEvidenceLevel extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Level of evidence for a medical guideline. Enumerated type.';
