...
class MortgageLoan extends MetaJsonLd implements MortgageLoanInterface, LoanOrCreditInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MortgageLoan';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MortgageLoan';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'LoanOrCredit';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A loan in which property or real estate is used as collateral. (A loan securitized against some real estate.)';
