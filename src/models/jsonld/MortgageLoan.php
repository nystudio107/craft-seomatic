...
class MortgageLoan extends MetaJsonLd implements MortgageLoanInterface, LoanOrCreditInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MortgageLoan';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MortgageLoan';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'LoanOrCredit';
