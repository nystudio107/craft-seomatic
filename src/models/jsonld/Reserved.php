...
class Reserved extends MetaJsonLd implements ReservedInterface, ItemAvailabilityInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Reserved';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Reserved';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Indicates that the item is reserved and therefore not available.';
