 ...
 * Reserved - Indicates that the item is reserved and therefore not available.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/Reserved
 */
class Reserved extends MetaJsonLd implements ReservedInterface, ItemAvailabilityInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use ReservedTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Reserved';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Reserved';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Indicates that the item is reserved and therefore not available.';
