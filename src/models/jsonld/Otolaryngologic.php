 ...
 */
class Otolaryngologic extends MetaJsonLd implements OtolaryngologicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Otolaryngologic';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Otolaryngologic';
