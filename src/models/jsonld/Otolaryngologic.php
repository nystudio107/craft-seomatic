 ...
 * Otolaryngologic - A specific branch of medical science that is concerned with the ear, nose
 ...
 */
class Otolaryngologic extends MetaJsonLd implements OtolaryngologicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use OtolaryngologicTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Otolaryngologic';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Otolaryngologic';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A specific branch of medical science that is concerned with the ear, nose and throat and their respective disease states.';
