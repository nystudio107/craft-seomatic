...
class State extends AdministrativeArea
{
     ...
     * @var string
     */
    static $schemaTypeName = 'State';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/State';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A state or province of a country.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'AdministrativeArea';
