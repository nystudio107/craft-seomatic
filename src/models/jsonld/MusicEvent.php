...
class MusicEvent extends MetaJsonLd implements MusicEventInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MusicEvent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MusicEvent';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Event type: Music event.';
