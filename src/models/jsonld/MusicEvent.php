 ...
 */
class MusicEvent extends MetaJsonLd implements MusicEventInterface, EventInterface, ThingInterface
{
    use MusicEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusicEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusicEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Music event.';
