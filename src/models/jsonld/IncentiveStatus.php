...
class IncentiveStatus extends MetaJsonLd implements IncentiveStatusInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'IncentiveStatus';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/IncentiveStatus';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Enumerates a status for an incentive, such as whether it is active.';
