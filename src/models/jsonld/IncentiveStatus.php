 ...
 * IncentiveStatus - Enumerates a status for an incentive, such as whether it is active.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/IncentiveStatus
 */
class IncentiveStatus extends MetaJsonLd implements IncentiveStatusInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'IncentiveStatus';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/IncentiveStatus';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Enumerates a status for an incentive, such as whether it is active.';
