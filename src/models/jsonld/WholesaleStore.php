 ...
 */
class WholesaleStore extends MetaJsonLd implements WholesaleStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
