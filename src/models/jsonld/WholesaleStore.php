...
class WholesaleStore extends MetaJsonLd implements WholesaleStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'WholesaleStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/WholesaleStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A wholesale store.';
