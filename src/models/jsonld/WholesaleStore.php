 ...
 */
class WholesaleStore extends MetaJsonLd implements WholesaleStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use WholesaleStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'WholesaleStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/WholesaleStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A wholesale store.';
