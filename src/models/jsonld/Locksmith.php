 ...
 */
class Locksmith extends MetaJsonLd implements LocksmithInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use LocksmithTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Locksmith';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Locksmith';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A locksmith.';
