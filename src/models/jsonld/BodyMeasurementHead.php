 ...
 */
class BodyMeasurementHead extends MetaJsonLd implements BodyMeasurementHeadInterface, BodyMeasurementTypeEnumerationInterface, MeasurementTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BodyMeasurementHead';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BodyMeasurementHead';
