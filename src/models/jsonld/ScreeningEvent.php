 ...
 */
class ScreeningEvent extends MetaJsonLd implements ScreeningEventInterface, EventInterface, ThingInterface
{
	use ScreeningEventTrait;
	use EventTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ScreeningEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ScreeningEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A screening of a movie or other video.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'workPresented' => ['array', 'Movie', 'Movie[]']
		];
	}
