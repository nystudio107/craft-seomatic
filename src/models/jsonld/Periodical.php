 ...
 */
class Periodical extends MetaJsonLd implements PeriodicalInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
    use PeriodicalTrait;
