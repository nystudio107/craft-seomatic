 ...
 * SurgicalProcedure - A medical procedure involving an incision with instruments; performed for
 ...
 */
class SurgicalProcedure extends MetaJsonLd implements SurgicalProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
    use SurgicalProcedureTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'SurgicalProcedure';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/SurgicalProcedure';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes.';
