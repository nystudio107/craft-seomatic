 ...
 */
class Country extends MetaJsonLd implements CountryInterface, AdministrativeAreaInterface, PlaceInterface, ThingInterface
{
	use CountryTrait;
	use AdministrativeAreaTrait;
	use PlaceTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Country';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Country';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A country.';
