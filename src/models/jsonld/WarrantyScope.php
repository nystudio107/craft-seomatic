...
/**
 * WarrantyScope - A range of of services that will be provided to a customer
 * free of charge in case of a defect or malfunction of a product. Commonly
 * used values: http://purl.org/goodrelations/v1#Labor-BringIn
...
class WarrantyScope extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'WarrantyScope';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/WarrantyScope';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A range of of services that will be provided to a customer free of charge in case of a defect or malfunction of a product. Commonly used values: http://purl.org/goodrelations/v1#Labor-BringIn http://purl.org/goodrelations/v1#PartsAndLabor-BringIn http://purl.org/goodrelations/v1#PartsAndLabor-PickUp';
