...
class Drug extends MetaJsonLd implements DrugInterface, ProductInterface, ThingInterface, SubstanceInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Drug';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Drug';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A chemical or biologic substance, used as a medical therapy, that has a physiological effect on an organism. Here the term drug is used interchangeably with the term medicine although clinical knowledge makes a clear difference between them.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'clincalPharmacology' => ['array', 'Text', 'Text[]'],
            'clinicalPharmacology' => ['array', 'Text', 'Text[]'],
            'code' => ['array', 'MedicalCode', 'MedicalCode[]'],
            'color' => ['array', 'Text', 'Text[]'],
            'colorSwatch' => ['array', 'ImageObject', 'ImageObject[]', 'array', 'URL', 'URL[]'],
            ...
            'dosageForm' => ['array', 'Text', 'Text[]'],
            'doseSchedule' => ['array', 'DoseSchedule', 'DoseSchedule[]'],
            'drugClass' => ['array', 'DrugClass', 'DrugClass[]'],
            'drugUnit' => ['array', 'Text', 'Text[]'],
            'foodWarning' => ['array', 'Text', 'Text[]'],
            ...
            'includedInHealthInsurancePlan' => ['array', 'HealthInsurancePlan', 'HealthInsurancePlan[]'],
            'interactingDrug' => ['array', 'Drug', 'Drug[]'],
            'isAccessoryOrSparePartFor' => ['array', 'Product', 'Product[]'],
            'isAvailableGenerically' => ['array', 'Boolean', 'Boolean[]'],
            'isConsumableFor' => ['array', 'Product', 'Product[]'],
            'isFamilyFriendly' => ['array', 'Boolean', 'Boolean[]'],
            'isProprietary' => ['array', 'Boolean', 'Boolean[]'],
            ...
            'maximumIntake' => ['array', 'MaximumDoseSchedule', 'MaximumDoseSchedule[]'],
            'mechanismOfAction' => ['array', 'Text', 'Text[]'],
            ...
            'negativeNotes' => ['array', 'ItemList', 'ItemList[]', 'array', 'ListItem', 'ListItem[]', 'array', 'Text', 'Text[]', 'array', 'WebContent', 'WebContent[]'],
            'nonProprietaryName' => ['array', 'Text', 'Text[]'],
            'nsn' => ['array', 'Text', 'Text[]'],
            'offers' => ['array', 'Demand', 'Demand[]', 'array', 'Offer', 'Offer[]'],
            'overdosage' => ['array', 'Text', 'Text[]'],
            'owner' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'pattern' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]'],
            'positiveNotes' => ['array', 'ItemList', 'ItemList[]', 'array', 'ListItem', 'ListItem[]', 'array', 'Text', 'Text[]', 'array', 'WebContent', 'WebContent[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'pregnancyCategory' => ['array', 'DrugPregnancyCategory', 'DrugPregnancyCategory[]'],
            'pregnancyWarning' => ['array', 'Text', 'Text[]'],
            'prescribingInfo' => ['array', 'URL', 'URL[]'],
            'prescriptionStatus' => ['array', 'DrugPrescriptionStatus', 'DrugPrescriptionStatus[]', 'array', 'Text', 'Text[]'],
            'productID' => ['array', 'Text', 'Text[]'],
            'productionDate' => ['array', 'Date', 'Date[]'],
            'proprietaryName' => ['array', 'Text', 'Text[]'],
            'purchaseDate' => ['array', 'Date', 'Date[]'],
            'recognizingAuthority' => ['array', 'Organization', 'Organization[]'],
            'relatedDrug' => ['array', 'Drug', 'Drug[]'],
            ...
            'url' => ['array', 'URL', 'URL[]'],
            'warning' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
