...
/**
 * DanceGroup - A dance group—for example, the Alvin Ailey Dance Theater or
 * Riverdance.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DanceGroup extends PerformingGroup
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DanceGroup';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DanceGroup';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A dance group—for example, the Alvin Ailey Dance Theater or Riverdance.';
