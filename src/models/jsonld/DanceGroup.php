...
class DanceGroup extends PerformingGroup
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DanceGroup';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DanceGroup';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A dance group—for example, the Alvin Ailey Dance Theater or Riverdance.';
