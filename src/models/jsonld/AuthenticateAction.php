 ...
 * AuthenticateAction - The action of authenticating into a device or application.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/AuthenticateAction
 */
class AuthenticateAction extends MetaJsonLd implements AuthenticateActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
	use AuthenticateActionTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'AuthenticateAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/AuthenticateAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The action of authenticating into a device or application.';
