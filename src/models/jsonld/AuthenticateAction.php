...
class AuthenticateAction extends MetaJsonLd implements AuthenticateActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AuthenticateAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AuthenticateAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The action of authenticating into a device or application.';
