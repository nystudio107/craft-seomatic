...
class TrainTrip extends MetaJsonLd implements TrainTripInterface, TripInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'TrainTrip';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/TrainTrip';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A trip on a commercial train line.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'arrivalPlatform' => ['array', 'Text', 'Text[]'],
            'arrivalStation' => ['array', 'TrainStation', 'TrainStation[]'],
            'arrivalTime' => ['array', 'DateTime', 'DateTime[]', 'array', 'Time', 'Time[]'],
            'departurePlatform' => ['array', 'Text', 'Text[]'],
            'departureStation' => ['array', 'TrainStation', 'TrainStation[]'],
            ...
            'trainName' => ['array', 'Text', 'Text[]'],
            'trainNumber' => ['array', 'Text', 'Text[]'],
