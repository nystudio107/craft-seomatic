 ...
 */
class WriteAction extends MetaJsonLd implements WriteActionInterface, CreateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WriteAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WriteAction';
