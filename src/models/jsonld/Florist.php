 ...
 */
class Florist extends MetaJsonLd implements FloristInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use FloristTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Florist';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Florist';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A florist.';
