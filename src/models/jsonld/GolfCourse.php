 ...
 */
class GolfCourse extends MetaJsonLd implements GolfCourseInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use GolfCourseTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'GolfCourse';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/GolfCourse';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A golf course.';
