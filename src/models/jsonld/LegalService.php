...
/**
 * LegalService - A LegalService is a business that provides legally-oriented
 * services, advice and representation, e.g. law firms. As a LocalBusiness it
...
class LegalService extends LocalBusiness
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'LegalService';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/LegalService';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A LegalService is a business that provides legally-oriented services, advice and representation, e.g. law firms. As a LocalBusiness it can be described as a provider of one or more Service(s).';
