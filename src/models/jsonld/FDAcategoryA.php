 ...
 * FDAcategoryA - A designation by the US FDA signifying that adequate and well-controlled
 ...
 */
class FDAcategoryA extends MetaJsonLd implements FDAcategoryAInterface, DrugPregnancyCategoryInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'FDAcategoryA';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/FDAcategoryA';
