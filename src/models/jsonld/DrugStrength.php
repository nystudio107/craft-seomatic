...
/**
 * DrugStrength - A specific strength in which a medical drug is available in
 * a specific country.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DrugStrength extends MedicalIntangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DrugStrength';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A specific strength in which a medical drug is available in a specific country.';
