 ...
 * DrugStrength - A specific strength in which a medical drug is available in a specific
 * country.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DrugStrength extends MetaJsonLd implements DrugStrengthInterface, MedicalIntangibleInterface, MedicalEntityInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'availableIn' => ['array', 'AdministrativeArea', 'AdministrativeArea[]'],
            ...
            'strengthUnit' => ['array', 'Text', 'Text[]'],
            'strengthValue' => ['array', 'Number', 'Number[]'],
