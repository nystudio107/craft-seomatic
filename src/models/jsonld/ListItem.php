...
class ListItem extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ListItem';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ListItem';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An list item, e.g. a step in a checklist or how-to description.';
