 ...
 */
class ListItem extends MetaJsonLd implements ListItemInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ListItem';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ListItem';
