 ...
 * SuspendAction - The act of momentarily pausing a device or application (e.g. pause music
 ...
 */
class SuspendAction extends MetaJsonLd implements SuspendActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SuspendAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/SuspendAction';
