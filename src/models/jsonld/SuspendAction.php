...
/**
 * SuspendAction - The act of momentarily pausing a device or application
...
class SuspendAction extends ControlAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SuspendAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SuspendAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of momentarily pausing a device or application (e.g. pause music playback or pause a timer).';
