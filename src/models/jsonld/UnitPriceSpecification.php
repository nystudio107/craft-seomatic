...
class UnitPriceSpecification extends PriceSpecification
{
     ...
     * @var string
     */
    static $schemaTypeName = 'UnitPriceSpecification';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/UnitPriceSpecification';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The price asked for a given offer by the respective organization or person.';
