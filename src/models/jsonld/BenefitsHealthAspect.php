 ...
 */
class BenefitsHealthAspect extends MetaJsonLd implements BenefitsHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BenefitsHealthAspect';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BenefitsHealthAspect';
