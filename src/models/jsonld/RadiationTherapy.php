 ...
 */
class RadiationTherapy extends MetaJsonLd implements RadiationTherapyInterface, MedicalTherapyInterface, TherapeuticProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
    use RadiationTherapyTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RadiationTherapy';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RadiationTherapy';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A process of care using radiation aimed at improving a health condition.';
