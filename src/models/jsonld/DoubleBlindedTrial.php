 ...
 * DoubleBlindedTrial - A trial design in which neither the researcher nor the patient knows the
 ...
 */
class DoubleBlindedTrial extends MetaJsonLd implements DoubleBlindedTrialInterface, MedicalTrialDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DoubleBlindedTrial';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DoubleBlindedTrial';
