...
class BedDetails extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BedDetails';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BedDetails';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An entity holding detailed information about the available bed types, e.g. the quantity of twin beds for a hotel room. For the single case of just one bed of a certain type, you can use bed directly with a text. See also BedType (under development).';
