 ...
 * Downpayment - Represents the downpayment (up-front payment) price component of the total
 ...
 */
class Downpayment extends MetaJsonLd implements DownpaymentInterface, PriceComponentTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Downpayment';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Downpayment';
