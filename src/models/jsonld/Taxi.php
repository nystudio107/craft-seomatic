 ...
 */
class Taxi extends MetaJsonLd implements TaxiInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
    use TaxiTrait;
    use ServiceTrait;
    use IntangibleTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Taxi';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Taxi';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A taxi.';
