 ...
 */
class BarOrPub extends MetaJsonLd implements BarOrPubInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use BarOrPubTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BarOrPub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BarOrPub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bar or pub.';
