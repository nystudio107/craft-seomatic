...
/**
 * PhysicalActivityCategory - Categories of physical activity, organized by
...
class PhysicalActivityCategory extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PhysicalActivityCategory';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PhysicalActivityCategory';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Categories of physical activity, organized by physiologic classification.';
