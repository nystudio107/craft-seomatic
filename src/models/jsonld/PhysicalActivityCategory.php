...
class PhysicalActivityCategory extends MetaJsonLd implements PhysicalActivityCategoryInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PhysicalActivityCategory';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PhysicalActivityCategory';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Categories of physical activity, organized by physiologic classification.';
