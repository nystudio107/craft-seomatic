 ...
 */
class VideoGame extends MetaJsonLd implements VideoGameInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface, GameInterface
{
    use VideoGameTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'gameLocation' => ['array', 'PostalAddress', 'PostalAddress[]', 'array', 'Place', 'Place[]', 'array', 'URL', 'URL[]'],
            'gamePlatform' => ['array', 'Thing', 'Thing[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            ...
            'softwareRequirements' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
