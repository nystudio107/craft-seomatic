 ...
 */
class VideoGame extends MetaJsonLd implements VideoGameInterface, GameInterface, CreativeWorkInterface, ThingInterface, SoftwareApplicationInterface
{
    use VideoGameTrait;
    use GameTrait;
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'Game';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'actor' => ['array', 'PerformingGroup', 'PerformingGroup[]', 'array', 'Person', 'Person[]'],
            'actors' => ['array', 'Person', 'Person[]'],
            'additionalType' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'aggregateRating' => ['array', 'AggregateRating', 'AggregateRating[]'],
            'alternateName' => ['array', 'Text', 'Text[]'],
            'alternativeHeadline' => ['array', 'Text', 'Text[]'],
            'applicationCategory' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'applicationSubCategory' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'applicationSuite' => ['array', 'Text', 'Text[]'],
            ...
            'availableOnDevice' => ['array', 'Text', 'Text[]'],
            'award' => ['array', 'Text', 'Text[]'],
            'awards' => ['array', 'Text', 'Text[]'],
            'character' => ['array', 'Person', 'Person[]'],
            'characterAttribute' => ['array', 'Thing', 'Thing[]'],
            'cheatCode' => ['array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'countriesNotSupported' => ['array', 'Text', 'Text[]'],
            'countriesSupported' => ['array', 'Text', 'Text[]'],
            ...
            'featureList' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'fileFormat' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'fileSize' => ['array', 'Text', 'Text[]'],
            'funder' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'funding' => ['array', 'Grant', 'Grant[]'],
            'gameEdition' => ['array', 'Text', 'Text[]'],
            'gameItem' => ['array', 'Thing', 'Thing[]'],
            'gameLocation' => ['array', 'Place', 'Place[]', 'array', 'PostalAddress', 'PostalAddress[]', 'array', 'URL', 'URL[]'],
            'gamePlatform' => ['array', 'Text', 'Text[]', 'array', 'Thing', 'Thing[]', 'array', 'URL', 'URL[]'],
            'gameServer' => ['array', 'GameServer', 'GameServer[]'],
            'gameTip' => ['array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'memoryRequirements' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'mentions' => ['array', 'Thing', 'Thing[]'],
            'musicBy' => ['array', 'MusicGroup', 'MusicGroup[]', 'array', 'Person', 'Person[]'],
            'name' => ['array', 'Text', 'Text[]'],
            'numberOfPlayers' => ['array', 'QuantitativeValue', 'QuantitativeValue[]'],
            'offers' => ['array', 'Demand', 'Demand[]', 'array', 'Offer', 'Offer[]'],
            'operatingSystem' => ['array', 'OperatingSystem', 'OperatingSystem[]', 'array', 'Text', 'Text[]'],
            'owner' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'pattern' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]'],
            'permissions' => ['array', 'Text', 'Text[]'],
            'playMode' => ['array', 'GamePlayMode', 'GamePlayMode[]'],
            'position' => ['array', 'Integer', 'Integer[]', 'array', 'Text', 'Text[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'processorRequirements' => ['array', 'Text', 'Text[]'],
            ...
            'quest' => ['array', 'Thing', 'Thing[]'],
            'recordedAt' => ['array', 'Event', 'Event[]'],
            'releaseNotes' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'releasedEvent' => ['array', 'PublicationEvent', 'PublicationEvent[]'],
            'requirements' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'review' => ['array', 'Review', 'Review[]'],
            'reviews' => ['array', 'Review', 'Review[]'],
            'runtimePlatform' => ['array', 'RuntimePlatform', 'RuntimePlatform[]', 'array', 'Text', 'Text[]'],
            'sameAs' => ['array', 'URL', 'URL[]'],
            'schemaVersion' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'screenshot' => ['array', 'ImageObject', 'ImageObject[]', 'array', 'URL', 'URL[]'],
            ...
            'softwareAddOn' => ['array', 'SoftwareApplication', 'SoftwareApplication[]'],
            'softwareHelp' => ['array', 'CreativeWork', 'CreativeWork[]'],
            'softwareRequirements' => ['array', 'SoftwareApplication', 'SoftwareApplication[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'softwareVersion' => ['array', 'Text', 'Text[]'],
            ...
            'storageRequirements' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'subjectOf' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'Event', 'Event[]'],
            'supportingData' => ['array', 'DataFeed', 'DataFeed[]'],
            ...
            'trailer' => ['array', 'VideoObject', 'VideoObject[]'],
