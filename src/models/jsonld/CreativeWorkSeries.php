 ...
 */
class CreativeWorkSeries extends MetaJsonLd implements CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
