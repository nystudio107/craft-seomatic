...
class CreativeWorkSeries extends MetaJsonLd implements CreativeWorkSeriesInterface, SeriesInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'CreativeWorkSeries';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/CreativeWorkSeries';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'Series';
