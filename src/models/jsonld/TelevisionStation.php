...
class TelevisionStation extends MetaJsonLd implements TelevisionStationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TelevisionStation';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TelevisionStation';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A television station.';
