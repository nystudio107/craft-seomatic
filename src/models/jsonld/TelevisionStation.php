 ...
 */
class TelevisionStation extends MetaJsonLd implements TelevisionStationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use TelevisionStationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'TelevisionStation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/TelevisionStation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A television station.';
