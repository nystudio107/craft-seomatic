...
/**
 * MedicalDevicePurpose - Categories of medical devices, organized by the
...
class MedicalDevicePurpose extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Categories of medical devices, organized by the purpose or intended use of the device.';
