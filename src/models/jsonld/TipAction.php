 ...
 * TipAction - The act of giving money voluntarily to a beneficiary in recognition of
 * services rendered.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class TipAction extends MetaJsonLd implements TipActionInterface, TradeActionInterface, ActionInterface, ThingInterface
{
	use TipActionTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TipAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TipAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The act of giving money voluntarily to a beneficiary in recognition of services rendered.';
