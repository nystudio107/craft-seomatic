 ...
 */
class TireShop extends MetaJsonLd implements TireShopInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use TireShopTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TireShop';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TireShop';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A tire shop.';
