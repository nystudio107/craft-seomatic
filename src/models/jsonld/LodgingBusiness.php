...
class LodgingBusiness extends MetaJsonLd implements LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'LodgingBusiness';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/LodgingBusiness';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A lodging business, such as a motel, hotel, or inn.';
