 ...
 */
class LodgingBusiness extends MetaJsonLd implements LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'LodgingBusiness';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/LodgingBusiness';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A lodging business, such as a motel, hotel, or inn.';
