...
class ImageGallery extends MetaJsonLd implements ImageGalleryInterface, MediaGalleryInterface, CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ImageGallery';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ImageGallery';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MediaGallery';
