 ...
 */
class ImageGallery extends MetaJsonLd implements ImageGalleryInterface, MediaGalleryInterface, CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	use ImageGalleryTrait;
	use MediaGalleryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ImageGallery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ImageGallery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'MediaGallery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Web page type: Image gallery page.';
