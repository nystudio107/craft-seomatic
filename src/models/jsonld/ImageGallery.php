...
class ImageGallery extends MetaJsonLd implements ImageGalleryInterface, MediaGalleryInterface, CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ImageGallery';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ImageGallery';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Web page type: Image gallery page.';
