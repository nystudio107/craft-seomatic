...
class FlightReservation extends MetaJsonLd implements FlightReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'FlightReservation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/FlightReservation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A reservation for air travel.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'name' => ['Text'],
		    'passengerPriorityStatus' => ['Text', 'QualitativeValue'],
