...
class FlightReservation extends MetaJsonLd implements FlightReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'FlightReservation';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/FlightReservation';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A reservation for air travel.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].';
