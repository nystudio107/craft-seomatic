 ...
 * MobileApplication - A software application designed specifically to work well on a mobile
 ...
 */
class MobileApplication extends MetaJsonLd implements MobileApplicationInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
	use MobileApplicationTrait;
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'carrierRequirements' => ['array', 'Text', 'Text[]'],
