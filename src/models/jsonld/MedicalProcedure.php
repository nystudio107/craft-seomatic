 ...
 * MedicalProcedure - A process of care used in either a diagnostic, therapeutic, preventive or
 ...
 */
class MedicalProcedure extends MetaJsonLd implements MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalProcedure';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalProcedure';
