 ...
 */
class Infectious extends MetaJsonLd implements InfectiousInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, SpecialtyInterface
{
    use InfectiousTrait;
