 ...
 * PurchaseType - Enumerates a purchase type for an item.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/PurchaseType
 */
class PurchaseType extends MetaJsonLd implements PurchaseTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PurchaseType';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PurchaseType';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Enumerates a purchase type for an item.';
