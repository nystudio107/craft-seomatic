...
class PurchaseType extends MetaJsonLd implements PurchaseTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'PurchaseType';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/PurchaseType';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Enumerates a purchase type for an item.';
