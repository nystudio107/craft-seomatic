 ...
 * BoatReservation - A reservation for boat travel.  Note: This type is for information about
 ...
 */
class BoatReservation extends MetaJsonLd implements BoatReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
    use BoatReservationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BoatReservation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BoatReservation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "A reservation for boat travel.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].";
