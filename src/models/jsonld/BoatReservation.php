...
class BoatReservation extends MetaJsonLd implements BoatReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'BoatReservation';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/BoatReservation';
     ...
     * @var string
     */
    public static $schemaTypeDescription = "A reservation for boat travel.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].";
