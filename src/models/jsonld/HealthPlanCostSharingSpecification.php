...
/**
 * HealthPlanCostSharingSpecification - A description of costs to the patient
 * under a given network or formulary.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class HealthPlanCostSharingSpecification extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HealthPlanCostSharingSpecification';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/HealthPlanCostSharingSpecification';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A description of costs to the patient under a given network or formulary.';
