 ...
 * CardiovascularExam - Cardiovascular system assessment with clinical examination.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/CardiovascularExam
 */
class CardiovascularExam extends MetaJsonLd implements CardiovascularExamInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CardiovascularExam';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CardiovascularExam';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Cardiovascular system assessment with clinical examination.';
