...
/**
 * CheckAction - An agent inspects/determines/investigates/inquire or examine
...
class CheckAction extends FindAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CheckAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CheckAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An agent inspects/determines/investigates/inquire or examine an object\'s accuracy/quality/condition or state.';
