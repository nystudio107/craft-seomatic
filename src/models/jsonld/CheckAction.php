...
/**
 * CheckAction - An agent inspects, determines, investigates, inquires, or
 * examines an object's accuracy, quality, condition, or state.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class CheckAction extends FindAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CheckAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An agent inspects, determines, investigates, inquires, or examines an object\'s accuracy, quality, condition, or state.';
