 ...
 * CheckAction - An agent inspects, determines, investigates, inquires, or examines an
 ...
 */
class CheckAction extends MetaJsonLd implements CheckActionInterface, FindActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CheckAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CheckAction';
