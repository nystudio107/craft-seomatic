 ...
 * Certification - A Certification is an official and authoritative statement about a subject,
 ...
 * certified, Food products can be certified Organic or Vegan, a Person can be
 * a certified professional, a Place can be certified for food processing.
 * There are certifications for many domains: regulatory, organizational,
 * recycling, food, efficiency, educational, ecological, etc. A certification
 * is a form of credential, as are accreditations and licenses. Mapped from
 * the
 ...
 */
class Certification extends MetaJsonLd implements CertificationInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Certification';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Certification';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A Certification is an official and authoritative statement about a subject, for example a product, service, person, or organization. A certification is typically issued by an indendent certification body, for example a professional organization or government. It formally attests certain characteristics about the subject, for example Organizations can be ISO certified, Food products can be certified Organic or Vegan, a Person can be a certified professional, a Place can be certified for food processing. There are certifications for many domains: regulatory, organizational, recycling, food, efficiency, educational, ecological, etc. A certification is a form of credential, as are accreditations and licenses. Mapped from the [gs1:CertificationDetails](https://www.gs1.org/voc/CertificationDetails) class in the GS1 Web Vocabulary.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'auditDate' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]'],
		    'author' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'award' => ['array', 'Text', 'Text[]'],
		    'awards' => ['array', 'Text', 'Text[]'],
		    'certificationIdentification' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]'],
		    'certificationRating' => ['array', 'Rating', 'Rating[]'],
		    'certificationStatus' => ['array', 'CertificationStatusEnumeration', 'CertificationStatusEnumeration[]'],
