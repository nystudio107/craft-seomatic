...
use nystudio107\seomatic\models\jsonld\Project;

/**
 * FundingAgency - A FundingAgency is an organization that implements one or
 * more FundingSchemes and manages the granting process (via Grants, typically
 * MonetaryGrants). A funding agency is not always required for grant funding,
 * e.g. philanthropic giving, corporate sponsorship etc. Examples of funding
...
class FundingAgency extends Project
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'FundingAgency';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/FundingAgency';
     ...
     * @var string
     */
    static public $schemaTypeExtends = 'Project';
