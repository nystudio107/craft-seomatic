 ...
 * UserCheckins - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserCheckins extends MetaJsonLd implements UserCheckinsInterface, UserInteractionInterface, EventInterface, ThingInterface
{
	use UserCheckinsTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'UserCheckins';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/UserCheckins';
