 ...
 */
class Brewery extends MetaJsonLd implements BreweryInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use BreweryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Brewery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Brewery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Brewery.';
