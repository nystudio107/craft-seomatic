...
/**
 * MedicalTest - Any medical test, typically performed for diagnostic
 * purposes.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MedicalTest extends MedicalEntity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalTest';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Any medical test, typically performed for diagnostic purposes.';
