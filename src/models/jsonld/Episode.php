...
class Episode extends CreativeWork
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Episode';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Episode';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A media episode (e.g. TV, radio, video game) which can be part of a series or season.';
