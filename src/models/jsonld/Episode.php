 ...
 * Episode - A media episode (e.g. TV, radio, video game) which can be part of a series
 * or season.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Episode extends MetaJsonLd implements EpisodeInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Episode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Episode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A media episode (e.g. TV, radio, video game) which can be part of a series or season.';
