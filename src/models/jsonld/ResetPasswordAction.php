 ...
 * ResetPasswordAction - The action of resetting the password of a device or application.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/ResetPasswordAction
 */
class ResetPasswordAction extends MetaJsonLd implements ResetPasswordActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
	use ResetPasswordActionTrait;
	use ControlActionTrait;
	use ActionTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ResetPasswordAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ResetPasswordAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The action of resetting the password of a device or application.';
