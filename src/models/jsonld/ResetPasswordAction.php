...
class ResetPasswordAction extends MetaJsonLd implements ResetPasswordActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ResetPasswordAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ResetPasswordAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'The action of resetting the password of a device or application.';
