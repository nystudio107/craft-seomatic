 ...
 */
class MusculoskeletalExam extends MetaJsonLd implements MusculoskeletalExamInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
    use MusculoskeletalExamTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusculoskeletalExam';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusculoskeletalExam';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Musculoskeletal system clinical examination.';
