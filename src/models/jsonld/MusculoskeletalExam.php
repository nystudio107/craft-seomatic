...
class MusculoskeletalExam extends MetaJsonLd implements MusculoskeletalExamInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MusculoskeletalExam';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MusculoskeletalExam';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Musculoskeletal system clinical examination.';
