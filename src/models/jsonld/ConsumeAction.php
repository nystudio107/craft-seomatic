 ...
 */
class ConsumeAction extends MetaJsonLd implements ConsumeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ConsumeAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ConsumeAction';
