 ...
 */
class Cemetery extends MetaJsonLd implements CemeteryInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use CemeteryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Cemetery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Cemetery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A graveyard.';
