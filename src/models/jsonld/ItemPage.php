...
class ItemPage extends WebPage
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ItemPage';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ItemPage';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A page devoted to a single item, such as a particular product or hotel.';
