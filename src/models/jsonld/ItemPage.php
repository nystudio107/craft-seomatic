...
/**
 * ItemPage - A page devoted to a single item, such as a particular product or
 * hotel.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ItemPage extends WebPage
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ItemPage';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ItemPage';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A page devoted to a single item, such as a particular product or hotel.';
