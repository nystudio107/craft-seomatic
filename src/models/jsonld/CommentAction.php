...
class CommentAction extends MetaJsonLd implements CommentActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'CommentAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/CommentAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of generating a comment about a subject.';
