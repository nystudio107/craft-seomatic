 ...
 */
class CommentAction extends MetaJsonLd implements CommentActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
    use CommentActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CommentAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CommentAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of generating a comment about a subject.';
