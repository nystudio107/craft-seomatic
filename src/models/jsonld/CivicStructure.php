...
class CivicStructure extends Place
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CivicStructure';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CivicStructure';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A public structure, such as a town hall or concert hall.';
