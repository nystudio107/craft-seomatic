 ...
 * Blog - A [blog](https://en.wikipedia.org/wiki/Blog), sometimes known as a
 * "weblog". Note that the individual posts ([[BlogPosting]]s) in a [[Blog]]
 ...
 */
class Blog extends MetaJsonLd implements BlogInterface, CreativeWorkInterface, ThingInterface
{
    use BlogTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Blog';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Blog';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A [blog](https://en.wikipedia.org/wiki/Blog), sometimes known as a "weblog". Note that the individual posts ([[BlogPosting]]s) in a [[Blog]] are often colloquially referred to by the same term.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'blogPost' => ['array', 'BlogPosting', 'BlogPosting[]'],
            'blogPosts' => ['array', 'BlogPosting', 'BlogPosting[]'],
