...
class CorrectionComment extends MetaJsonLd implements CorrectionCommentInterface, CommentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CorrectionComment';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CorrectionComment';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A [[comment]] that corrects [[CreativeWork]].';
