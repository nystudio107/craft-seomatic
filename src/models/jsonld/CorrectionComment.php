...
class CorrectionComment extends Comment
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CorrectionComment';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/CorrectionComment';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A comment that corrects CreativeWork.';
