 ...
 */
class VideoGallery extends MetaJsonLd implements VideoGalleryInterface, MediaGalleryInterface, CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'VideoGallery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/VideoGallery';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Web page type: Video gallery page.';
