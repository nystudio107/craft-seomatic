...
class VideoGallery extends CollectionPage
{
     ...
     * @var string
     */
    static $schemaTypeName = 'VideoGallery';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/VideoGallery';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Web page type: Video gallery page.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'CollectionPage';
