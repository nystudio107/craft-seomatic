 ...
 * InvestmentFund - A company or fund that gathers capital from a number of investors to create
...
class InvestmentFund extends MetaJsonLd implements InvestmentFundInterface, InvestmentOrDepositInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'InvestmentFund';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/InvestmentFund';
