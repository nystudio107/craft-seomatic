...
/**
 * InvestmentFund - A company or fund that gathers capital from a number of
 * investors to create a pool of money that is then re-invested into stocks,
...
class InvestmentFund extends InvestmentOrDeposit
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'InvestmentFund';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets.';
