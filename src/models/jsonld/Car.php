...
class Car extends Vehicle
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Car';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Car';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A car is a wheeled, self-powered motor vehicle used for transportation.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Vehicle';
