 ...
 */
class HealthClub extends MetaJsonLd implements HealthClubInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, SportsActivityLocationInterface
{
	use HealthClubTrait;
