 ...
 */
class HealthClub extends MetaJsonLd implements HealthClubInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, SportsActivityLocationInterface
{
	use HealthClubTrait;
