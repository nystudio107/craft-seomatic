 ...
 * Geriatric - A specific branch of medical science that is concerned with the diagnosis
 ...
 */
class Geriatric extends MetaJsonLd implements GeriatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use GeriatricTrait;
