 ...
 * Manuscript - A book, document, or piece of music written by hand rather than typed or
 * printed.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Manuscript extends MetaJsonLd implements ManuscriptInterface, CreativeWorkInterface, ThingInterface
{
    use ManuscriptTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Manuscript';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Manuscript';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A book, document, or piece of music written by hand rather than typed or printed.';
