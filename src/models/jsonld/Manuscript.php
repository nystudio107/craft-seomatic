...
/**
 * Manuscript - A book, document, or piece of music written by hand rather
 * than typed or printed.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/Manuscript
 */
class Manuscript extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Manuscript';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Manuscript';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A book, document, or piece of music written by hand rather than typed or printed.';
