...
class Manuscript extends MetaJsonLd implements ManuscriptInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Manuscript';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Manuscript';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A book, document, or piece of music written by hand rather than typed or printed.';
