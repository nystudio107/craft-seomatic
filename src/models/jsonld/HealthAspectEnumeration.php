...
/**
 * HealthAspectEnumeration - HealthAspectEnumeration enumerates several
 * aspects of health content online, each of which might be described using
 * hasHealthAspect and HealthTopicContent.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/HealthAspectEnumeration
 */
class HealthAspectEnumeration extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HealthAspectEnumeration';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'HealthAspectEnumeration enumerates several aspects of health content online, each of which might be described using hasHealthAspect and HealthTopicContent.';
