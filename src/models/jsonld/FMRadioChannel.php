 ...
 */
class FMRadioChannel extends MetaJsonLd implements FMRadioChannelInterface, RadioChannelInterface, BroadcastChannelInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'FMRadioChannel';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/FMRadioChannel';
