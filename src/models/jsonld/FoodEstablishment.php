 ...
 */
class FoodEstablishment extends MetaJsonLd implements FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FoodEstablishment';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FoodEstablishment';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A food-related business.';
