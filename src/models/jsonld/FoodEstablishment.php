...
class FoodEstablishment extends MetaJsonLd implements FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'FoodEstablishment';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/FoodEstablishment';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A food-related business.';
