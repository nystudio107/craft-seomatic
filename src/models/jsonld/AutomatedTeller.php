...
class AutomatedTeller extends MetaJsonLd implements AutomatedTellerInterface, FinancialServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'AutomatedTeller';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/AutomatedTeller';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'ATM/cash machine.';
