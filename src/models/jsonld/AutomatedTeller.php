 ...
 */
class AutomatedTeller extends MetaJsonLd implements AutomatedTellerInterface, FinancialServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use AutomatedTellerTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AutomatedTeller';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AutomatedTeller';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'ATM/cash machine.';
