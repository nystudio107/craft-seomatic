 ...
 * Physician - An individual physician or a physician's office considered as a
 * [[MedicalOrganization]].
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Physician extends MetaJsonLd implements PhysicianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
	use PhysicianTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Physician';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Physician';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An individual physician or a physician\'s office considered as a [[MedicalOrganization]].';
