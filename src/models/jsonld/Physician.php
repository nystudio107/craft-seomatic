...
class Physician extends MetaJsonLd implements PhysicianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Physician';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Physician';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An individual physician or a physician\'s office considered as a [[MedicalOrganization]].';
