 ...
 */
class Physician extends MetaJsonLd implements PhysicianInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface
{
    use PhysicianTrait;
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A doctor\'s office.';
