 ...
 */
class Prion extends MetaJsonLd implements PrionInterface, InfectiousAgentClassInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Prion';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Prion';
