...
class ReservationStatusType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ReservationStatusType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ReservationStatusType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Enumerated status values for Reservation.';
