...
class SportsTeam extends MetaJsonLd implements SportsTeamInterface, SportsOrganizationInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SportsTeam';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SportsTeam';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'SportsOrganization';
