...
class OceanBodyOfWater extends BodyOfWater
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'OceanBodyOfWater';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/OceanBodyOfWater';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An ocean (for example, the Pacific).';
