...
class OceanBodyOfWater extends BodyOfWater
{
     ...
     * @var string
     */
    static $schemaTypeName = 'OceanBodyOfWater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/OceanBodyOfWater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An ocean (for example, the Pacific).';
