...
class OceanBodyOfWater extends MetaJsonLd implements OceanBodyOfWaterInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'OceanBodyOfWater';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/OceanBodyOfWater';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'An ocean (for example, the Pacific).';
