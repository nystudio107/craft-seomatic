 ...
 */
class BankOrCreditUnion extends MetaJsonLd implements BankOrCreditUnionInterface, FinancialServiceInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
