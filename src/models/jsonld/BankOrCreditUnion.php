...
class BankOrCreditUnion extends MetaJsonLd implements BankOrCreditUnionInterface, FinancialServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'BankOrCreditUnion';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/BankOrCreditUnion';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Bank or credit union.';
