 ...
 */
class BankOrCreditUnion extends MetaJsonLd implements BankOrCreditUnionInterface, FinancialServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use BankOrCreditUnionTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BankOrCreditUnion';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BankOrCreditUnion';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Bank or credit union.';
