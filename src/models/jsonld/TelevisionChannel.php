...
class TelevisionChannel extends BroadcastChannel
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'TelevisionChannel';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/TelevisionChannel';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A unique instance of a television BroadcastService on a CableOrSatelliteService lineup.';
