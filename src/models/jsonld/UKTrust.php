 ...
 */
class UKTrust extends MetaJsonLd implements UKTrustInterface, UKNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'UKTrust';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/UKTrust';
