...
class ComputerLanguage extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ComputerLanguage';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ComputerLanguage';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'This type covers computer programming languages such as Scheme and Lisp, as well as other language-like computer representations. Natural languages are best represented with the Language type.';
