 ...
 */
class MusicRelease extends MetaJsonLd implements MusicReleaseInterface, MusicPlaylistInterface, CreativeWorkInterface, ThingInterface
{
    use MusicReleaseTrait;
    use MusicPlaylistTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusicRelease';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusicRelease';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A MusicRelease is a specific release of a music album.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'creditedTo' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'musicReleaseFormat' => ['array', 'MusicReleaseFormatType', 'MusicReleaseFormatType[]'],
            'name' => ['array', 'Text', 'Text[]'],
            'numTracks' => ['array', 'Integer', 'Integer[]'],
            ...
            'recordLabel' => ['array', 'Organization', 'Organization[]'],
            'recordedAt' => ['array', 'Event', 'Event[]'],
            'releaseOf' => ['array', 'MusicAlbum', 'MusicAlbum[]'],
