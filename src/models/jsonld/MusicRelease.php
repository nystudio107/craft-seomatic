...
class MusicRelease extends MetaJsonLd implements MusicReleaseInterface, MusicPlaylistInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MusicRelease';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MusicRelease';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MusicPlaylist';
