...
class MusicRelease extends MetaJsonLd implements MusicReleaseInterface, MusicPlaylistInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MusicRelease';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MusicRelease';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A MusicRelease is a specific release of a music album.';
