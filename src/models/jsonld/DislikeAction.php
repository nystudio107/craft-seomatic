...
/**
 * DislikeAction - The act of expressing a negative sentiment about the
 * object. An agent dislikes an object (a proposition, topic or theme) with
 * participants.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DislikeAction extends ReactAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DislikeAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DislikeAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of expressing a negative sentiment about the object. An agent dislikes an object (a proposition, topic or theme) with participants.';
