 ...
 */
class EducationalOrganization extends MetaJsonLd implements EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use EducationalOrganizationTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'EducationalOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/EducationalOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An educational organization.';
