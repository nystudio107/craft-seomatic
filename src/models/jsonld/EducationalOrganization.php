...
class EducationalOrganization extends MetaJsonLd implements EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'EducationalOrganization';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/EducationalOrganization';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An educational organization.';
