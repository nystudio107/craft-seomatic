...
/**
 * LibrarySystem - A LibrarySystem is a collaborative system amongst several
 * libraries.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/LibrarySystem
 */
class LibrarySystem extends Organization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'LibrarySystem';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A LibrarySystem is a collaborative system amongst several libraries.';
