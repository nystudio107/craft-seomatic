...
class StrikethroughPrice extends MetaJsonLd implements StrikethroughPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'StrikethroughPrice';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/StrikethroughPrice';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Represents the strikethrough price (the previous advertised price) of an offered product.';
