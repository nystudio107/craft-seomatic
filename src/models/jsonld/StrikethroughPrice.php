 ...
 * StrikethroughPrice - Represents the strikethrough price (the previous advertised price) of an
 * offered product.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class StrikethroughPrice extends MetaJsonLd implements StrikethroughPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use StrikethroughPriceTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'StrikethroughPrice';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/StrikethroughPrice';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Represents the strikethrough price (the previous advertised price) of an offered product.';
