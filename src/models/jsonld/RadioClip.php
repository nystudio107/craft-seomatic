...
class RadioClip extends Clip
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RadioClip';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RadioClip';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A short radio program or a segment/part of a radio program.';
