 ...
 */
class RadioClip extends MetaJsonLd implements RadioClipInterface, ClipInterface, CreativeWorkInterface, ThingInterface
{
    use RadioClipTrait;
    use ClipTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RadioClip';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RadioClip';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A short radio program or a segment/part of a radio program.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'clipNumber' => ['array', 'Integer', 'Integer[]', 'array', 'Text', 'Text[]'],
            ...
            'endOffset' => ['array', 'HyperTocEntry', 'HyperTocEntry[]', 'array', 'Number', 'Number[]'],
            ...
            'partOfEpisode' => ['array', 'Episode', 'Episode[]'],
            ...
            'startOffset' => ['array', 'HyperTocEntry', 'HyperTocEntry[]', 'array', 'Number', 'Number[]'],
