 ...
 * MediaReviewItem - Represents an item or group of closely related items treated as a unit for
 ...
 */
class MediaReviewItem extends MetaJsonLd implements MediaReviewItemInterface, CreativeWorkInterface, ThingInterface
{
    use MediaReviewItemTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MediaReviewItem';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MediaReviewItem';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Represents an item or group of closely related items treated as a unit for the sake of evaluation in a [[MediaReview]]. Authorship etc. apply to the items rather than to the curation/grouping or reviewing party.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'mediaItemAppearance' => ['array', 'MediaObject', 'MediaObject[]'],
