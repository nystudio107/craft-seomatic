...
/**
 * HowToItem - An item used as either a tool or supply when performing the
...
class HowToItem extends ListItem
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HowToItem';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/HowToItem';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An item used as either a tool or supply when performing the instructions for how to to achieve a result.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['requiredQuantity'], 'validateJsonSchema'],
