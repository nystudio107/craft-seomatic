 ...
 */
class MusicComposition extends MetaJsonLd implements MusicCompositionInterface, CreativeWorkInterface, ThingInterface
{
    use MusicCompositionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusicComposition';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusicComposition';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A musical composition.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'firstPerformance' => ['array', 'Event', 'Event[]'],
            ...
            'includedComposition' => ['array', 'MusicComposition', 'MusicComposition[]'],
            ...
            'lyricist' => ['array', 'Person', 'Person[]'],
            'lyrics' => ['array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'musicArrangement' => ['array', 'MusicComposition', 'MusicComposition[]'],
            'musicCompositionForm' => ['array', 'Text', 'Text[]'],
            'musicalKey' => ['array', 'Text', 'Text[]'],
            ...
            'recordedAs' => ['array', 'MusicRecording', 'MusicRecording[]'],
