...
class MusicComposition extends MetaJsonLd implements MusicCompositionInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MusicComposition';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MusicComposition';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A musical composition.';
