 ...
 * Chapter - One of the sections into which a book is divided. A chapter usually has a
 ...
 */
class Chapter extends MetaJsonLd implements ChapterInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Chapter';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Chapter';
