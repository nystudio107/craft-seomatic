 ...
 */
class Store extends MetaJsonLd implements StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Store';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Store';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A retail good store.';
