 ...
 * MoneyTransfer - The act of transferring money from one place to another place. This may
 ...
 */
class MoneyTransfer extends MetaJsonLd implements MoneyTransferInterface, TransferActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MoneyTransfer';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MoneyTransfer';
