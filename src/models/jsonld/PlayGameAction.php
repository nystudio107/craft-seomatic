 ...
 */
class PlayGameAction extends MetaJsonLd implements PlayGameActionInterface, ConsumeActionInterface, ActionInterface, ThingInterface
{
    use PlayGameActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PlayGameAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PlayGameAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of playing a video game.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'gameAvailabilityType' => ['array', 'GameAvailabilityEnumeration', 'GameAvailabilityEnumeration[]', 'array', 'Text', 'Text[]'],
