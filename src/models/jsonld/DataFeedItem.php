...
class DataFeedItem extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DataFeedItem';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DataFeedItem';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A single item within a larger data feed.';
