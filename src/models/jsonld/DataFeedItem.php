 ...
 */
class DataFeedItem extends MetaJsonLd implements DataFeedItemInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DataFeedItem';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DataFeedItem';
