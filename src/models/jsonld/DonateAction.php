 ...
 * DonateAction - The act of providing goods, services, or money without compensation, often
 ...
 */
class DonateAction extends MetaJsonLd implements DonateActionInterface, TransferActionInterface, ActionInterface, ThingInterface
{
    use DonateActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DonateAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DonateAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of providing goods, services, or money without compensation, often for philanthropic reasons.';
