...
class WPSideBar extends MetaJsonLd implements WPSideBarInterface, WebPageElementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'WPSideBar';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/WPSideBar';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A sidebar section of the page.';
