 ...
 */
class WPSideBar extends MetaJsonLd implements WPSideBarInterface, WebPageElementInterface, CreativeWorkInterface, ThingInterface
{
    use WPSideBarTrait;
    use WebPageElementTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WPSideBar';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WPSideBar';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A sidebar section of the page.';
