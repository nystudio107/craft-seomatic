...
class VideoObjectSnapshot extends MetaJsonLd implements VideoObjectSnapshotInterface, VideoObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'VideoObjectSnapshot';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/VideoObjectSnapshot';
	 ...
	 * @var string
	 */
	public static $schemaTypeExtends = 'VideoObject';
