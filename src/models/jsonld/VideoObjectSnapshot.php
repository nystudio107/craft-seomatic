 ...
 * VideoObjectSnapshot - A specific and exact (byte-for-byte) version of a [[VideoObject]]. Two
 ...
 */
class VideoObjectSnapshot extends MetaJsonLd implements VideoObjectSnapshotInterface, VideoObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
    use VideoObjectSnapshotTrait;
    use VideoObjectTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'VideoObjectSnapshot';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/VideoObjectSnapshot';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'VideoObject';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A specific and exact (byte-for-byte) version of a [[VideoObject]]. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren\'t represented in their actual content, do not affect this notion of identity.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'caption' => ['array', 'MediaObject', 'MediaObject[]', 'array', 'Text', 'Text[]'],
            ...
            'embeddedTextCaption' => ['array', 'Text', 'Text[]'],
            ...
            'videoFrameSize' => ['array', 'Text', 'Text[]'],
            'videoQuality' => ['array', 'Text', 'Text[]'],
