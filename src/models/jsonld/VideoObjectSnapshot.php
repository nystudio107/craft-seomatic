...
class VideoObjectSnapshot extends MetaJsonLd implements VideoObjectSnapshotInterface, VideoObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VideoObjectSnapshot';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/VideoObjectSnapshot';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'VideoObject';
