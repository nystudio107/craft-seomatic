...
/**
 * HobbyShop - A store that sells materials useful or necessary for various
 * hobbies.
 * Extends: Store
...
class HobbyShop extends Store
{
     ...
     * @var string
     */
    static $schemaTypeName = 'HobbyShop';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/HobbyShop';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A store that sells materials useful or necessary for various hobbies.';
