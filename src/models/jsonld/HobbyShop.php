 ...
 */
class HobbyShop extends MetaJsonLd implements HobbyShopInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use HobbyShopTrait;
	use StoreTrait;
