 ...
 * ConfirmAction - The act of notifying someone that a future event/action is going to happen
 * as expected.  Related actions:  * [[CancelAction]]: The antonym of
 * ConfirmAction.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ConfirmAction extends MetaJsonLd implements ConfirmActionInterface, InformActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ConfirmAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ConfirmAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of notifying someone that a future event/action is going to happen as expected.\n\nRelated actions:\n\n* [[CancelAction]]: The antonym of ConfirmAction.';
