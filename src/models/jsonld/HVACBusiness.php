 ...
 * HVACBusiness - A business that provides Heating, Ventilation and Air Conditioning
 * services.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class HVACBusiness extends MetaJsonLd implements HVACBusinessInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use HVACBusinessTrait;
