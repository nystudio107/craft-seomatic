...
/**
 * HVACBusiness - A business that provide Heating, Ventilation and Air
...
class HVACBusiness extends HomeAndConstructionBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'HVACBusiness';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/HVACBusiness';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A business that provide Heating, Ventilation and Air Conditioning services.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'HomeAndConstructionBusiness';
