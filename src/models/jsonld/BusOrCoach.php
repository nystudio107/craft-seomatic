...
class BusOrCoach extends MetaJsonLd implements BusOrCoachInterface, VehicleInterface, ProductInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bus (also omnibus or autobus) is a road vehicle designed to carry passengers. Coaches are luxury buses, usually in service for long distance travel.';
