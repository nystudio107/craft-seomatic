...
/**
 * BusOrCoach - A bus (also omnibus or autobus) is a road vehicle designed to
 * carry passengers. Coaches are luxury busses, usually in service for long
 * distance travel.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class BusOrCoach extends Vehicle
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BusOrCoach';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BusOrCoach';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A bus (also omnibus or autobus) is a road vehicle designed to carry passengers. Coaches are luxury busses, usually in service for long distance travel.';
