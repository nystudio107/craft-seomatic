 ...
 */
class AutoWash extends MetaJsonLd implements AutoWashInterface, AutomotiveBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use AutoWashTrait;
