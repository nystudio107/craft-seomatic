 ...
 */
class AutoWash extends MetaJsonLd implements AutoWashInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use AutoWashTrait;
