...
class ShippingService extends MetaJsonLd implements ShippingServiceInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ShippingService';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ShippingService';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'ShippingService represents the criteria used to determine if and how an offer could be shipped to a customer.';
