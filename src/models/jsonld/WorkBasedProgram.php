...
class WorkBasedProgram extends MetaJsonLd implements WorkBasedProgramInterface, EducationalOccupationalProgramInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WorkBasedProgram';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WorkBasedProgram';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'EducationalOccupationalProgram';
