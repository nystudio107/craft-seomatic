 ...
 */
class Sculpture extends MetaJsonLd implements SculptureInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Sculpture';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Sculpture';
