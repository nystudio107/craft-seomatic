...
class Clip extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Clip';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Clip';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A short TV or radio program or a segment/part of a program.';
