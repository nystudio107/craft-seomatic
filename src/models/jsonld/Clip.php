...
class Clip extends CreativeWork
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Clip';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Clip';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A short TV or radio program or a segment/part of a program.';
