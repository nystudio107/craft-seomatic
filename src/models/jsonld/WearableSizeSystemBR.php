...
class WearableSizeSystemBR extends MetaJsonLd implements WearableSizeSystemBRInterface, WearableSizeSystemEnumerationInterface, SizeSystemEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WearableSizeSystemBR';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WearableSizeSystemBR';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Brazilian size system for wearables.';
