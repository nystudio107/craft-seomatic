 ...
 */
class PhysiciansOffice extends MetaJsonLd implements PhysiciansOfficeInterface, PhysicianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
    use PhysiciansOfficeTrait;
    use PhysicianTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PhysiciansOffice';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PhysiciansOffice';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A doctor\'s office or clinic.';
