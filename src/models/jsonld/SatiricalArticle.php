...
/**
 * SatiricalArticle - An Article whose content is primarily [satirical] in
 * nature, i.e. unlikely to be literally true. A satirical article is
 * sometimes but not necessarily also a NewsArticle. ScholarlyArticles are
 * also sometimes satirized.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/SatiricalArticle
 */
class SatiricalArticle extends Article
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SatiricalArticle';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/SatiricalArticle';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An Article whose content is primarily [satirical] in nature, i.e. unlikely to be literally true. A satirical article is sometimes but not necessarily also a NewsArticle. ScholarlyArticles are also sometimes satirized.';
