 ...
 * ArchiveComponent - An intangible type to be applied to any archive content, carrying with it a
 ...
 */
class ArchiveComponent extends MetaJsonLd implements ArchiveComponentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ArchiveComponent';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ArchiveComponent';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'itemLocation' => ['Place', 'Text', 'PostalAddress'],
