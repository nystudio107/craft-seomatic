 ...
 */
class BroadcastEvent extends MetaJsonLd implements BroadcastEventInterface, PublicationEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BroadcastEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BroadcastEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An over the air or online broadcast event.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'broadcastOfEvent' => ['array', 'Event', 'Event[]'],
		    ...
		    'isLiveBroadcast' => ['array', 'Boolean', 'Boolean[]'],
		    ...
		    'subtitleLanguage' => ['array', 'Language', 'Language[]', 'array', 'Text', 'Text[]'],
