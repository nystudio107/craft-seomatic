...
class BroadcastEvent extends MetaJsonLd implements BroadcastEventInterface, PublicationEventInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'BroadcastEvent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/BroadcastEvent';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An over the air or online broadcast event.';
