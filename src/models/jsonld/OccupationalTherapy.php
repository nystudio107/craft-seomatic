 ...
 * OccupationalTherapy - A treatment of people with physical, emotional, or social problems, using
 ...
 */
class OccupationalTherapy extends MetaJsonLd implements OccupationalTherapyInterface, MedicalTherapyInterface, TherapeuticProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OccupationalTherapy';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OccupationalTherapy';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalTherapy';
