...
/**
 * OccupationalTherapy - A treatment of people with physical, emotional, or
 * social problems, using purposeful activity to help them overcome or learn
...
class OccupationalTherapy extends MedicalTherapy
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'OccupationalTherapy';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/OccupationalTherapy';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A treatment of people with physical, emotional, or social problems, using purposeful activity to help them overcome or learn to deal with their problems.';
