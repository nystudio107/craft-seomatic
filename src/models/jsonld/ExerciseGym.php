 ...
 */
class ExerciseGym extends MetaJsonLd implements ExerciseGymInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ExerciseGymTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ExerciseGym';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ExerciseGym';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A gym.';
