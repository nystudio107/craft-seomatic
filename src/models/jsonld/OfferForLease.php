...
/**
 * OfferForLease - An OfferForLease in Schema.org represents an Offer to lease
 * out something, i.e. an Offer whose businessFunction is lease out. See Good
 * Relations for background on the underlying concepts.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/OfferForLease
 */
class OfferForLease extends Offer
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'OfferForLease';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An OfferForLease in Schema.org represents an Offer to lease out something, i.e. an Offer whose businessFunction is lease out. See Good Relations for background on the underlying concepts.';
