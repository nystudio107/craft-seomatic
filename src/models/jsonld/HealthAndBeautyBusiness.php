 ...
 */
class HealthAndBeautyBusiness extends MetaJsonLd implements HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use HealthAndBeautyBusinessTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'HealthAndBeautyBusiness';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/HealthAndBeautyBusiness';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Health and beauty.';
