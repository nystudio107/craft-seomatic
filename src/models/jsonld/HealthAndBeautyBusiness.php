...
class HealthAndBeautyBusiness extends MetaJsonLd implements HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'HealthAndBeautyBusiness';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/HealthAndBeautyBusiness';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Health and beauty.';
