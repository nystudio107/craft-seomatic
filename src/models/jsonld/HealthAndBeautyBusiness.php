...
class HealthAndBeautyBusiness extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'HealthAndBeautyBusiness';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/HealthAndBeautyBusiness';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Health and beauty.';
