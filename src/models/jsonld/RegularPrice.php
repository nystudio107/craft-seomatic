 ...
 * RegularPrice - Represents the regular price of an offered product. This is usually the
 ...
 */
class RegularPrice extends MetaJsonLd implements RegularPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	use RegularPriceTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'RegularPrice';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/RegularPrice';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Represents the regular price of an offered product. This is usually the advertised price before a temporary sale. Once the sale period ends the advertised price will go back to the regular price.';
