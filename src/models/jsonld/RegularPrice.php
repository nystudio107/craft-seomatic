...
class RegularPrice extends MetaJsonLd implements RegularPriceInterface, PriceTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'RegularPrice';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/RegularPrice';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Represents the regular price of an offered product. This is usually the advertised price before a temporary sale. Once the sale period ends the advertised price will go back to the regular price.';
