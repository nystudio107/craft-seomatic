...
/**
 * FundingScheme - A FundingScheme combines organizational, project and policy
 * aspects of grant-based funding that sets guidelines, principles and
 * mechanisms to support other kinds of projects and activities. Funding is
 * typically organized via Grant funding. Examples of funding schemes: Swiss
 ...
 * awards is often handled by other, dedicated, organizations - FundingAgencys
 * such as ERC, REA, ...
 *
 * @author    nystudio107
 * @package   Seomatic
...
class FundingScheme extends Organization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'FundingScheme';
