...
/**
 * MedicalGuideline - Any recommendation made by a standard society (e.g.
 * ACC/AHA) or consensus statement that denotes how to diagnose and treat a
 ...
 * larger scholarly article, use MedicalScholarlyArticle to tag the overall
 * article, not this type. Note also: the organization making the
 * recommendation should be captured in the recognizingAuthority base property
 * of MedicalEntity.
 *
 * @author    nystudio107
 * @package   Seomatic
