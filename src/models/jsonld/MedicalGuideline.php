...
class MedicalGuideline extends MetaJsonLd implements MedicalGuidelineInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MedicalGuideline';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MedicalGuideline';
