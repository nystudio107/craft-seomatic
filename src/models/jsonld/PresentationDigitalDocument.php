 ...
 */
class PresentationDigitalDocument extends MetaJsonLd implements PresentationDigitalDocumentInterface, DigitalDocumentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PresentationDigitalDocument';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PresentationDigitalDocument';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'DigitalDocument';
...
SCHEMADESC;
    ...
    use PresentationDigitalDocumentTrait;
