...
class PresentationDigitalDocument extends DigitalDocument
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PresentationDigitalDocument';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PresentationDigitalDocument';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A file containing slides or used for a presentation.';
