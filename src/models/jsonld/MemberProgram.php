 ...
 * MemberProgram - A MemberProgram defines a loyalty (or membership) program that provides its
 ...
 */
class MemberProgram extends MetaJsonLd implements MemberProgramInterface, IntangibleInterface, ThingInterface
{
	use MemberProgramTrait;
	use IntangibleTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'MemberProgram';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/MemberProgram';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'hasTiers' => ['array', 'MemberProgramTier', 'MemberProgramTier[]'],
