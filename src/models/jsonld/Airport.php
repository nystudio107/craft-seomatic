 ...
 */
class Airport extends MetaJsonLd implements AirportInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use AirportTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Airport';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Airport';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An airport.';
