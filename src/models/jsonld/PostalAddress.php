...
class PostalAddress extends MetaJsonLd implements PostalAddressInterface, ContactPointInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PostalAddress';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PostalAddress';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'ContactPoint';
