...
class PostalAddress extends ContactPoint
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PostalAddress';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PostalAddress';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The mailing address.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'ContactPoint';
