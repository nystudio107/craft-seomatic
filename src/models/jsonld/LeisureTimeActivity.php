 ...
 * LeisureTimeActivity - Any physical activity engaged in for recreational purposes. Examples may
...
class LeisureTimeActivity extends MetaJsonLd implements LeisureTimeActivityInterface, PhysicalActivityCategoryInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LeisureTimeActivity';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LeisureTimeActivity';
