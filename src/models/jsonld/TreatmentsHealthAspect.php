 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/TreatmentsHealthAspect
 */
class TreatmentsHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Treatments or related therapies for a Topic.';
