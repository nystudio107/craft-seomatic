 ...
 */
class PalliativeProcedure extends MetaJsonLd implements PalliativeProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalTherapyInterface, TherapeuticProcedureInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'PalliativeProcedure';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/PalliativeProcedure';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition.';
