...
class PalliativeProcedure extends MetaJsonLd implements PalliativeProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalTherapyInterface, TherapeuticProcedureInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'PalliativeProcedure';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/PalliativeProcedure';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition.';
