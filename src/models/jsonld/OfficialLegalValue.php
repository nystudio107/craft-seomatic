 ...
 */
class OfficialLegalValue extends MetaJsonLd implements OfficialLegalValueInterface, LegalValueLevelInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use OfficialLegalValueTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'OfficialLegalValue';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/OfficialLegalValue';
