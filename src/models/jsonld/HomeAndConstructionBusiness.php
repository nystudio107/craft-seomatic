...
/**
 * HomeAndConstructionBusiness - A construction business. A
 * HomeAndConstructionBusiness is a LocalBusiness that provides services
 * around homes and buildings. As a LocalBusiness it can be described as a
...
class HomeAndConstructionBusiness extends LocalBusiness
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HomeAndConstructionBusiness';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/HomeAndConstructionBusiness';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A construction business. A HomeAndConstructionBusiness is a LocalBusiness that provides services around homes and buildings. As a LocalBusiness it can be described as a provider of one or more Service(s).';
