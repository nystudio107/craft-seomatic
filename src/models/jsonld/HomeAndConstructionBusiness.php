...
class HomeAndConstructionBusiness extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'HomeAndConstructionBusiness';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/HomeAndConstructionBusiness';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A construction business. A HomeAndConstructionBusiness is a LocalBusiness that provides services around homes and buildings. As a LocalBusiness it can be described as a provider of one or more Service(s).';
