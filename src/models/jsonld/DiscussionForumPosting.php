...
class DiscussionForumPosting extends MetaJsonLd implements DiscussionForumPostingInterface, SocialMediaPostingInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DiscussionForumPosting';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DiscussionForumPosting';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'SocialMediaPosting';
