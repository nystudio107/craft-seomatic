...
class TechArticle extends MetaJsonLd implements TechArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'TechArticle';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/TechArticle';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A technical article - Example: How-to (task) topics, step-by-step, procedural troubleshooting, specifications, etc.';
