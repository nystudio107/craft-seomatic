 ...
 * TechArticle - A technical article - Example: How-to (task) topics, step-by-step,
 ...
 */
class TechArticle extends MetaJsonLd implements TechArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TechArticle';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TechArticle';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A technical article - Example: How-to (task) topics, step-by-step, procedural troubleshooting, specifications, etc.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'proficiencyLevel' => ['array', 'Text', 'Text[]'],
