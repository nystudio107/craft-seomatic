...
class SeaBodyOfWater extends BodyOfWater
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SeaBodyOfWater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SeaBodyOfWater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A sea (for example, the Caspian sea).';
