 ...
 */
class SeaBodyOfWater extends MetaJsonLd implements SeaBodyOfWaterInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	use SeaBodyOfWaterTrait;
