...
class MotorizedBicycle extends MetaJsonLd implements MotorizedBicycleInterface, VehicleInterface, ProductInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MotorizedBicycle';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MotorizedBicycle';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling.';
