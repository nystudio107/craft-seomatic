 ...
 * MotorizedBicycle - A motorized bicycle is a bicycle with an attached motor used to power the
 ...
 */
class MotorizedBicycle extends MetaJsonLd implements MotorizedBicycleInterface, VehicleInterface, ProductInterface, ThingInterface
{
    use MotorizedBicycleTrait;
    use VehicleTrait;
    use ProductTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MotorizedBicycle';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MotorizedBicycle';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'fuelType' => ['array', 'QualitativeValue', 'QualitativeValue[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            ...
            'meetsEmissionStandard' => ['array', 'QualitativeValue', 'QualitativeValue[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            ...
            'nsn' => ['array', 'Text', 'Text[]'],
            'numberOfAirbags' => ['array', 'Number', 'Number[]', 'array', 'Text', 'Text[]'],
            'numberOfAxles' => ['array', 'Number', 'Number[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
            ...
            'seatingCapacity' => ['array', 'Number', 'Number[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
            ...
            'vehicleTransmission' => ['array', 'QualitativeValue', 'QualitativeValue[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
