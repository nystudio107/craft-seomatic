...
class MotorizedBicycle extends MetaJsonLd implements MotorizedBicycleInterface, VehicleInterface, ProductInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MotorizedBicycle';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MotorizedBicycle';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'vehicleTransmission' => ['Text', 'QualitativeValue', 'URL'],
