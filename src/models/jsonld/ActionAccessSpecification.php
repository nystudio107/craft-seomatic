 ...
 * ActionAccessSpecification - A set of requirements that a must be fulfilled in order to perform an
 * Action.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ActionAccessSpecification extends MetaJsonLd implements ActionAccessSpecificationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ActionAccessSpecification';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ActionAccessSpecification';
