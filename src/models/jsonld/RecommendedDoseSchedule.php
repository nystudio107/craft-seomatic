...
/**
 * RecommendedDoseSchedule - A recommended dosing schedule for a drug or
 * supplement as prescribed or recommended by an authority or by the
 * drug/supplement's manufacturer. Capture the recommending authority in the
...
class RecommendedDoseSchedule extends DoseSchedule
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'RecommendedDoseSchedule';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/RecommendedDoseSchedule';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A recommended dosing schedule for a drug or supplement as prescribed or recommended by an authority or by the drug/supplement\'s manufacturer. Capture the recommending authority in the recognizingAuthority property of MedicalEntity.';
