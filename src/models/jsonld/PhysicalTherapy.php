 ...
 * PhysicalTherapy - A process of progressive physical care and rehabilitation aimed at
 ...
 */
class PhysicalTherapy extends MetaJsonLd implements PhysicalTherapyInterface, MedicalTherapyInterface, TherapeuticProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PhysicalTherapy';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PhysicalTherapy';
