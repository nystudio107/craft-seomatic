 ...
 * MedicalEntity - The most generic type of entity related to health and the practice of
 * medicine.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class MedicalEntity extends MetaJsonLd implements MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalEntity';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalEntity';
