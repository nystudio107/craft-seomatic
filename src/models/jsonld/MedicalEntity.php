...
/**
 * MedicalEntity - The most generic type of entity related to health and the
...
class MedicalEntity extends Thing
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalEntity';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The most generic type of entity related to health and the practice of medicine.';
