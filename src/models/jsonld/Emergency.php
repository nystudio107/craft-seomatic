 ...
 * Emergency - A specific branch of medical science that deals with the evaluation and
 ...
 */
class Emergency extends MetaJsonLd implements EmergencyInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use EmergencyTrait;
