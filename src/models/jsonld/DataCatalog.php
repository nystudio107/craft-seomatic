 ...
 */
class DataCatalog extends MetaJsonLd implements DataCatalogInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DataCatalog';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DataCatalog';
