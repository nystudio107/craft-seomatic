...
class EntryPoint extends MetaJsonLd implements EntryPointInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'EntryPoint';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/EntryPoint';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An entry point, within some Web-based protocol.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'actionPlatform' => ['array', 'DigitalPlatformEnumeration', 'DigitalPlatformEnumeration[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
