 ...
 * Thesis - A thesis or dissertation document submitted in support of candidature for
 ...
 */
class Thesis extends MetaJsonLd implements ThesisInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Thesis';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Thesis';
