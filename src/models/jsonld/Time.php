...
class Time extends DataType
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Time';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Time';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A point in time recurring on multiple days in the form hh:mm:ss[Z|(+|-)hh:mm] (see XML schema for details).';
