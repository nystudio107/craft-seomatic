 ...
 */
class EffectivenessHealthAspect extends MetaJsonLd implements EffectivenessHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'EffectivenessHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/EffectivenessHealthAspect';
...
SCHEMADESC;
    ...
    use EffectivenessHealthAspectTrait;
