 ...
 */
class MusicStore extends MetaJsonLd implements MusicStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MusicStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusicStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusicStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A music store.';
