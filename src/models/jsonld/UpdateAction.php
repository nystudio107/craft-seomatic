 ...
 */
class UpdateAction extends MetaJsonLd implements UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UpdateAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UpdateAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of managing by changing/editing the state of the object.';
