...
class UpdateAction extends MetaJsonLd implements UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'UpdateAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/UpdateAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of managing by changing/editing the state of the object.';
