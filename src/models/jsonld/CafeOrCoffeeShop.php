 ...
 */
class CafeOrCoffeeShop extends MetaJsonLd implements CafeOrCoffeeShopInterface, FoodEstablishmentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	...
	{
		return [
		    'acceptsReservations' => ['URL', 'Text', 'Boolean'],
