...
class CafeOrCoffeeShop extends MetaJsonLd implements CafeOrCoffeeShopInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'CafeOrCoffeeShop';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/CafeOrCoffeeShop';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A cafe or coffee shop.';
