 ...
 */
class CafeOrCoffeeShop extends MetaJsonLd implements CafeOrCoffeeShopInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use CafeOrCoffeeShopTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CafeOrCoffeeShop';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CafeOrCoffeeShop';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A cafe or coffee shop.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'acceptsReservations' => ['array', 'Boolean', 'Boolean[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            ...
            'hasMenu' => ['array', 'Menu', 'Menu[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            ...
            'menu' => ['array', 'Menu', 'Menu[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
