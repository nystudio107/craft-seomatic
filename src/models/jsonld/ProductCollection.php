 ...
 */
class ProductCollection extends MetaJsonLd implements ProductCollectionInterface, ProductInterface, ThingInterface, CollectionInterface, CreativeWorkInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ProductCollection';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ProductCollection';
