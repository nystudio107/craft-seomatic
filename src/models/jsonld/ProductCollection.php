 ...
 * ProductCollection - A set of products (either [[ProductGroup]]s or specific variants) that are
 ...
 */
class ProductCollection extends MetaJsonLd implements ProductCollectionInterface, CollectionInterface, CreativeWorkInterface, ThingInterface, ProductInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'collectionSize' => ['array', 'Integer', 'Integer[]'],
