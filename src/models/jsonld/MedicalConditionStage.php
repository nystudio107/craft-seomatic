 ...
 */
class MedicalConditionStage extends MetaJsonLd implements MedicalConditionStageInterface, MedicalIntangibleInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalConditionStage';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalConditionStage';
...
SCHEMADESC;
    ...
    use MedicalConditionStageTrait;
