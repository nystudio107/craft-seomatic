...
/**
 * MedicalConditionStage - A stage of a medical condition, such as 'Stage
 * IIIa'.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MedicalConditionStage extends MedicalIntangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalConditionStage';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A stage of a medical condition, such as \'Stage IIIa\'.';
