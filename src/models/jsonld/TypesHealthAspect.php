 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/TypesHealthAspect
 */
class TypesHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Categorization and other types related to a topic.';
