...
class VideoGameClip extends MetaJsonLd implements VideoGameClipInterface, ClipInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VideoGameClip';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/VideoGameClip';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Clip';
