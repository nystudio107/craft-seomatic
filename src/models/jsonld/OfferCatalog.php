 ...
 * OfferCatalog - An OfferCatalog is an ItemList that contains related Offers and/or further
 ...
 */
class OfferCatalog extends MetaJsonLd implements OfferCatalogInterface, ItemListInterface, IntangibleInterface, ThingInterface
{
    use OfferCatalogTrait;
    use ItemListTrait;
    use IntangibleTrait;
    use ThingTrait;
