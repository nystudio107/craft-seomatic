 ...
 */
class Preschool extends MetaJsonLd implements PreschoolInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use PreschoolTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Preschool';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Preschool';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A preschool.';
