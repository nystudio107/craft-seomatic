 ...
 */
class Preschool extends MetaJsonLd implements PreschoolInterface, EducationalOrganizationInterface, OrganizationInterface, ThingInterface, CivicStructureInterface, PlaceInterface
{
    use PreschoolTrait;
