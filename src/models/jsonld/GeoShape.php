...
class GeoShape extends MetaJsonLd implements GeoShapeInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'GeoShape';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/GeoShape';
