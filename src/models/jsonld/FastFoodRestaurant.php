 ...
 */
class FastFoodRestaurant extends MetaJsonLd implements FastFoodRestaurantInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use FastFoodRestaurantTrait;
