...
class FastFoodRestaurant extends MetaJsonLd implements FastFoodRestaurantInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'FastFoodRestaurant';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/FastFoodRestaurant';
...
SCHEMADESC;
    ...
    {
        return [
            'acceptsReservations' => ['Text', 'Boolean', 'URL'],
