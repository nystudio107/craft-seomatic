...
use nystudio107\seomatic\models\jsonld\LegalService;
...
class Attorney extends LegalService
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Attorney';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Attorney';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Professional service: Attorney. This type is deprecated - LegalService is more inclusive and less ambiguous.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'LegalService';
