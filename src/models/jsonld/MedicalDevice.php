 ...
 * MedicalDevice - Any object used in a medical capacity, such as to diagnose or treat a
 * patient.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class MedicalDevice extends MetaJsonLd implements MedicalDeviceInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalDevice';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalDevice';
