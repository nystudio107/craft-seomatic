 ...
 * MadeToOrder - Indicates that the item is made to order (custom made).
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/MadeToOrder
 */
class MadeToOrder extends MetaJsonLd implements MadeToOrderInterface, ItemAvailabilityInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use MadeToOrderTrait;
    use ItemAvailabilityTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MadeToOrder';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MadeToOrder';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Indicates that the item is made to order (custom made).';
