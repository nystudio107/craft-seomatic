...
class MadeToOrder extends MetaJsonLd implements MadeToOrderInterface, ItemAvailabilityInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MadeToOrder';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MadeToOrder';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Indicates that the item is made to order (custom made).';
