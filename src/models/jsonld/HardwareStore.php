 ...
 */
class HardwareStore extends MetaJsonLd implements HardwareStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use HardwareStoreTrait;
    use StoreTrait;
