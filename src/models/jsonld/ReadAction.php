 ...
 */
class ReadAction extends MetaJsonLd implements ReadActionInterface, ConsumeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ReadAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ReadAction';
