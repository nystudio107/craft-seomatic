 ...
 */
class MedicalWebPage extends MetaJsonLd implements MedicalWebPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	use MedicalWebPageTrait;
	use WebPageTrait;
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'medicalAudience' => ['array', 'MedicalAudience', 'MedicalAudience[]', 'array', 'MedicalAudienceType', 'MedicalAudienceType[]'],
