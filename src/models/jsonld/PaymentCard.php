...
class PaymentCard extends FinancialProduct
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PaymentCard';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PaymentCard';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A payment method using a credit, debit, store or other card to associate the payment with an account.';
