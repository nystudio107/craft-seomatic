...
class SportsActivityLocation extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SportsActivityLocation';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SportsActivityLocation';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A sports location, such as a playing field.';
