 ...
 * ArchiveOrganization - An organization with archival holdings. An organization which keeps and
 ...
 */
class ArchiveOrganization extends MetaJsonLd implements ArchiveOrganizationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ArchiveOrganizationTrait;
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'archiveHeld' => ['array', 'ArchiveComponent', 'ArchiveComponent[]'],
