 ...
 */
class Appearance extends MetaJsonLd implements AppearanceInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
    use AppearanceTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Appearance';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Appearance';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Appearance assessment with clinical examination.';
