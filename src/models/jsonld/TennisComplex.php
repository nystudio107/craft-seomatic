 ...
 */
class TennisComplex extends MetaJsonLd implements TennisComplexInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use TennisComplexTrait;
