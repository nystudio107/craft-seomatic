...
/**
 * PrognosisHealthAspect - Typical progression and happenings of life course
 * of the topic.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/PrognosisHealthAspect
 */
class PrognosisHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PrognosisHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Typical progression and happenings of life course of the topic.';
