 ...
 * PercutaneousProcedure - A type of medical procedure that involves percutaneous techniques, where
...
class PercutaneousProcedure extends MetaJsonLd implements PercutaneousProcedureInterface, MedicalProcedureTypeInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PercutaneousProcedure';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PercutaneousProcedure';
