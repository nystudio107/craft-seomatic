 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/StagesHealthAspect
 */
class StagesHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Stages that can be observed from a topic.';
