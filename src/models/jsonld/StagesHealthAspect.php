 ...
 */
class StagesHealthAspect extends MetaJsonLd implements StagesHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'StagesHealthAspect';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/StagesHealthAspect';
