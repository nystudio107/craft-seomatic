...
class BoardingPolicyType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BoardingPolicyType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BoardingPolicyType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A type of boarding policy used by an airline.';
