 ...
 * MedicalRiskEstimator - Any rule set or interactive tool for estimating the risk of developing a
 ...
 */
class MedicalRiskEstimator extends MetaJsonLd implements MedicalRiskEstimatorInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalRiskEstimator';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalRiskEstimator';
