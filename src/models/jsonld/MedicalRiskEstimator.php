...
/**
 * MedicalRiskEstimator - Any rule set or interactive tool for estimating the
 * risk of developing a complication or condition.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MedicalRiskEstimator extends MedicalEntity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalRiskEstimator';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MedicalRiskEstimator';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Any rule set or interactive tool for estimating the risk of developing a complication or condition.';
