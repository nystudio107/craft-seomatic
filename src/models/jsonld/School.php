 ...
 */
class School extends MetaJsonLd implements SchoolInterface, EducationalOrganizationInterface, OrganizationInterface, ThingInterface, CivicStructureInterface, PlaceInterface
{
    use SchoolTrait;
