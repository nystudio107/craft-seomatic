 ...
 */
class School extends MetaJsonLd implements SchoolInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use SchoolTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'School';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/School';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A school.';
