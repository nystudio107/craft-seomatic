...
class WearableSizeGroupBoys extends MetaJsonLd implements WearableSizeGroupBoysInterface, WearableSizeGroupEnumerationInterface, SizeGroupEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WearableSizeGroupBoys';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WearableSizeGroupBoys';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Size group "Boys" for wearables.';
