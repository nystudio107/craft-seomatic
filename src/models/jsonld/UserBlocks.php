 ...
 * UserBlocks - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserBlocks extends MetaJsonLd implements UserBlocksInterface, UserInteractionInterface, EventInterface, ThingInterface
{
    use UserBlocksTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UserBlocks';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UserBlocks';
