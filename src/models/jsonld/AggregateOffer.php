 ...
 * AggregateOffer - When a single product is associated with multiple offers (for example, the
 * same pair of shoes is offered by different merchants), then AggregateOffer
 * can be used.  Note: AggregateOffers are normally expected to associate
...
class AggregateOffer extends MetaJsonLd implements AggregateOfferInterface, OfferInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'AggregateOffer';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/AggregateOffer';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Offer';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'When a single product is associated with multiple offers (for example, the same pair of shoes is offered by different merchants), then AggregateOffer can be used.\n\nNote: AggregateOffers are normally expected to associate multiple offers that all share the same defined [[businessFunction]] value, or default to http://purl.org/goodrelations/v1#Sell if businessFunction is not explicitly defined.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'availabilityEnds' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]', 'array', 'Time', 'Time[]'],
		    ...
		    'eligibleRegion' => ['array', 'GeoShape', 'GeoShape[]', 'array', 'Place', 'Place[]', 'array', 'Text', 'Text[]'],
		    ...
		    'highPrice' => ['array', 'Number', 'Number[]', 'array', 'Text', 'Text[]'],
		    ...
		    'itemOffered' => ['array', 'AggregateOffer', 'AggregateOffer[]', 'array', 'CreativeWork', 'CreativeWork[]', 'array', 'Event', 'Event[]', 'array', 'MenuItem', 'MenuItem[]', 'array', 'Product', 'Product[]', 'array', 'Service', 'Service[]', 'array', 'Trip', 'Trip[]'],
		    'leaseLength' => ['array', 'Duration', 'Duration[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
		    'lowPrice' => ['array', 'Number', 'Number[]', 'array', 'Text', 'Text[]'],
		    'mainEntityOfPage' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
		    'mobileUrl' => ['array', 'Text', 'Text[]'],
		    'mpn' => ['array', 'Text', 'Text[]'],
		    'name' => ['array', 'Text', 'Text[]'],
		    'offerCount' => ['array', 'Integer', 'Integer[]'],
		    'offeredBy' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'offers' => ['array', 'Demand', 'Demand[]', 'array', 'Offer', 'Offer[]'],
		    'owner' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'potentialAction' => ['array', 'Action', 'Action[]'],
		    'price' => ['array', 'Number', 'Number[]', 'array', 'Text', 'Text[]'],
