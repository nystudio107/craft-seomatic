 ...
 */
class OfficeEquipmentStore extends MetaJsonLd implements OfficeEquipmentStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
