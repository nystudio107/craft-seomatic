 ...
 */
class OfficeEquipmentStore extends MetaJsonLd implements OfficeEquipmentStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use OfficeEquipmentStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'OfficeEquipmentStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/OfficeEquipmentStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An office equipment store.';
