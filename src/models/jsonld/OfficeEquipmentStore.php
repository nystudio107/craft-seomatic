...
class OfficeEquipmentStore extends MetaJsonLd implements OfficeEquipmentStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'OfficeEquipmentStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/OfficeEquipmentStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An office equipment store.';
