...
class OfficeEquipmentStore extends Store
{
     ...
     * @var string
     */
    static $schemaTypeName = 'OfficeEquipmentStore';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/OfficeEquipmentStore';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An office equipment store.';
