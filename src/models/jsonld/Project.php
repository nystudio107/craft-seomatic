 ...
 * Project - An enterprise (potentially individual but typically collaborative), planned
 ...
 */
class Project extends MetaJsonLd implements ProjectInterface, OrganizationInterface, ThingInterface
{
	use ProjectTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Project';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Project';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = "An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim.\nUse properties from [[Organization]], [[subOrganization]]/[[parentOrganization]] to indicate project sub-structures. \n   ";
