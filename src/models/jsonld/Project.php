...
class Project extends MetaJsonLd implements ProjectInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Project';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Project';
     ...
     * @var string
     */
    public static $schemaTypeDescription = "An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim.\nUse properties from [[Organization]], [[subOrganization]]/[[parentOrganization]] to indicate project sub-structures. \n   ";
