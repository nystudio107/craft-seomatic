 ...
 * Organization, subOrganization/parentOrganization to indicate project
 * sub-structures.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Project extends Organization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Project';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An enterprise (potentially individual but typically collaborative), planned to achieve a particular aim. Use properties from Organization, subOrganization/parentOrganization to indicate project sub-structures.';
