...
/**
 * MaximumDoseSchedule - The maximum dosing schedule considered safe for a
 * drug or supplement as recommended by an authority or by the
...
class MaximumDoseSchedule extends DoseSchedule
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MaximumDoseSchedule';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MaximumDoseSchedule';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The maximum dosing schedule considered safe for a drug or supplement as recommended by an authority or by the drug/supplement\'s manufacturer. Capture the recommending authority in the recognizingAuthority property of MedicalEntity.';
