 ...
 * FDAcategoryC - A designation by the US FDA signifying that animal reproduction studies
 ...
 */
class FDAcategoryC extends MetaJsonLd implements FDAcategoryCInterface, DrugPregnancyCategoryInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use FDAcategoryCTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FDAcategoryC';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FDAcategoryC';
