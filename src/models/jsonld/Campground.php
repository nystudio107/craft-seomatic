 ...
 */
class Campground extends MetaJsonLd implements CampgroundInterface, LodgingBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, CivicStructureInterface
{
	use CampgroundTrait;
