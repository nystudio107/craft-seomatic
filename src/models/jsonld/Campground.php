 ...
 */
class Campground extends MetaJsonLd implements CampgroundInterface, LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, CivicStructureInterface
{
    use CampgroundTrait;
