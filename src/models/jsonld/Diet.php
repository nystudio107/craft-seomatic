 ...
 */
class Diet extends MetaJsonLd implements DietInterface, CreativeWorkInterface, ThingInterface, LifestyleModificationInterface, MedicalEntityInterface
{
    use DietTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'endorsers' => ['array', 'Person', 'Person[]', 'array', 'Organization', 'Organization[]'],
            'exampleOfWork' => ['array', 'CreativeWork', 'CreativeWork[]'],
            'expertConsiderations' => ['array', 'Text', 'Text[]'],
            ...
            'physiologicalBenefits' => ['array', 'Text', 'Text[]'],
