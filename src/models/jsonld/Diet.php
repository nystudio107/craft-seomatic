 ...
 */
class Diet extends MetaJsonLd implements DietInterface, LifestyleModificationInterface, MedicalEntityInterface, ThingInterface, CreativeWorkInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Diet';
