...
class JobPosting extends MetaJsonLd implements JobPostingInterface, IntangibleInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'industry' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]'],
            'jobBenefits' => ['array', 'Text', 'Text[]'],
            'jobDuration' => ['array', 'Duration', 'Duration[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
            ...
            'sensoryRequirement' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
    ...
    public function getSchemaPropertyDescriptions(): array
    {
        return [
            ...
            'jobDuration' => 'The expected duration of an employment offer as advertised by the employer. Relevant for job postings that have a clearly defined period in mind such as seasonal work, substitutes for maternal leave or any other temporary employment.',
