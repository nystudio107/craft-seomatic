 ...
 * ComicStory - The term "story" is any indivisible, re-printable     	unit of a comic,
 * including the interior stories, covers, and backmatter. Most     	comics
 ...
 */
class ComicStory extends MetaJsonLd implements ComicStoryInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ComicStory';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ComicStory';
