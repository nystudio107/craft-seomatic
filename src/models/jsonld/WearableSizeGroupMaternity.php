...
class WearableSizeGroupMaternity extends MetaJsonLd implements WearableSizeGroupMaternityInterface, WearableSizeGroupEnumerationInterface, SizeGroupEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WearableSizeGroupMaternity';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WearableSizeGroupMaternity';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Size group "Maternity" for wearables.';
