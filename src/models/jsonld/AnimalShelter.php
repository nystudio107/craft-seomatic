 ...
 */
class AnimalShelter extends MetaJsonLd implements AnimalShelterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use AnimalShelterTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AnimalShelter';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AnimalShelter';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Animal shelter.';
