...
class AnimalShelter extends MetaJsonLd implements AnimalShelterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AnimalShelter';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AnimalShelter';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Animal shelter.';
