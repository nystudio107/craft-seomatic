 ...
 */
class Painting extends MetaJsonLd implements PaintingInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Painting';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Painting';
