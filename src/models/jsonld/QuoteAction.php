 ...
 * QuoteAction - An agent quotes/estimates/appraises an object/product/service with a price
 * at a location/store.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class QuoteAction extends MetaJsonLd implements QuoteActionInterface, TradeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'QuoteAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/QuoteAction';
