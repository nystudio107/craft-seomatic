...
class Collection extends MetaJsonLd implements CollectionInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Collection';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Collection';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A collection of items, e.g. creative works or products.';
