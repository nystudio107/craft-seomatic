 ...
 */
class Collection extends MetaJsonLd implements CollectionInterface, CreativeWorkInterface, ThingInterface
{
    use CollectionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Collection';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Collection';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A collection of items, e.g. creative works or products.';
