 ...
 */
class MedicalTestPanel extends MetaJsonLd implements MedicalTestPanelInterface, MedicalTestInterface, MedicalEntityInterface, ThingInterface
{
    use MedicalTestPanelTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'subTest' => ['array', 'MedicalTest', 'MedicalTest[]'],
