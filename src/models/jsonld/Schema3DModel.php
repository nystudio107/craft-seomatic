 ...
 * 3DModel - A 3D model represents some kind of 3D content, which may have [[encoding]]s
 ...
 * gaming, engineering and scientific content can all be represented using
 * [[3DModel]].
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Schema3DModel extends MetaJsonLd implements Schema3DModelInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
    use Schema3DModelTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = '3DModel';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/3DModel';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'isResizable' => ['array', 'Boolean', 'Boolean[]'],
