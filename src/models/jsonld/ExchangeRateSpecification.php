...
class ExchangeRateSpecification extends MetaJsonLd implements ExchangeRateSpecificationInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ExchangeRateSpecification';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ExchangeRateSpecification';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A structured value representing exchange rate.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'currentExchangeRate' => ['array', 'UnitPriceSpecification', 'UnitPriceSpecification[]'],
            'description' => ['array', 'TextObject', 'TextObject[]', 'array', 'Text', 'Text[]'],
            'disambiguatingDescription' => ['array', 'Text', 'Text[]'],
            'exchangeRateSpread' => ['array', 'MonetaryAmount', 'MonetaryAmount[]', 'array', 'Number', 'Number[]'],
