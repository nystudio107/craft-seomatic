...
class WearableSizeGroupMisses extends MetaJsonLd implements WearableSizeGroupMissesInterface, WearableSizeGroupEnumerationInterface, SizeGroupEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WearableSizeGroupMisses';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WearableSizeGroupMisses';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Size group "Misses" (also known as "Missy") for wearables.';
