...
class TierBenefitEnumeration extends MetaJsonLd implements TierBenefitEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'TierBenefitEnumeration';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/TierBenefitEnumeration';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'An enumeration of possible benefits as part of a loyalty (members) program.';
