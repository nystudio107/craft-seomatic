...
class MedicalSign extends MetaJsonLd implements MedicalSignInterface, MedicalSignOrSymptomInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MedicalSign';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MedicalSign';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Any physical manifestation of a person\'s medical condition discoverable by objective diagnostic tests or physical examination.';
