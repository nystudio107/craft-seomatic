...
class MedicalSign extends MetaJsonLd implements MedicalSignInterface, MedicalSignOrSymptomInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MedicalSign';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MedicalSign';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Any physical manifestation of a person\'s medical condition discoverable by objective diagnostic tests or physical examination.';
