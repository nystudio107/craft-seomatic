...
class BusinessEvent extends MetaJsonLd implements BusinessEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'BusinessEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/BusinessEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Event type: Business event.';
