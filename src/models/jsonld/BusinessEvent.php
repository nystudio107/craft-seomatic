 ...
 */
class BusinessEvent extends MetaJsonLd implements BusinessEventInterface, EventInterface, ThingInterface
{
	use BusinessEventTrait;
	use EventTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BusinessEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BusinessEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Event type: Business event.';
