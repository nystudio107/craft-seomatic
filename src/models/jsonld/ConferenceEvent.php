...
class ConferenceEvent extends MetaJsonLd implements ConferenceEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ConferenceEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ConferenceEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Event type: Conference event.';
