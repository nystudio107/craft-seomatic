 ...
 * ConferenceEvent - Event type: Conference event.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/ConferenceEvent
 */
class ConferenceEvent extends MetaJsonLd implements ConferenceEventInterface, EventInterface, ThingInterface
{
    use ConferenceEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ConferenceEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ConferenceEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Conference event.';
