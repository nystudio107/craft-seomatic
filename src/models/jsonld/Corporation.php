...
class Corporation extends MetaJsonLd implements CorporationInterface, OrganizationInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Corporation';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Corporation';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Organization: A business corporation.';
