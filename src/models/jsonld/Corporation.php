 ...
 */
class Corporation extends MetaJsonLd implements CorporationInterface, OrganizationInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Corporation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Corporation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Organization: A business corporation.';
