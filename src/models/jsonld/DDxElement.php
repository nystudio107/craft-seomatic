...
use nystudio107\seomatic\models\jsonld\MedicalIntangible;

/**
 * DDxElement - An alternative, closely-related condition typically considered
 * later in the differential diagnosis process along with the signs that are
...
class DDxElement extends MedicalIntangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DDxElement';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DDxElement';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An alternative, closely-related condition typically considered later in the differential diagnosis process along with the signs that are used to distinguish it.';
