 ...
 * DDxElement - An alternative, closely-related condition typically considered later in the
 ...
 */
class DDxElement extends MetaJsonLd implements DDxElementInterface, MedicalIntangibleInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DDxElement';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DDxElement';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalIntangible';
