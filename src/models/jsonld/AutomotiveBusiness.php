...
class AutomotiveBusiness extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AutomotiveBusiness';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AutomotiveBusiness';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Car repair, sales, or parts.';
