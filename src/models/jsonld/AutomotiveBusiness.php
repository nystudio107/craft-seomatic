...
class AutomotiveBusiness extends MetaJsonLd implements AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'AutomotiveBusiness';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/AutomotiveBusiness';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Car repair, sales, or parts.';
