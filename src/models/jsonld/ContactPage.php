 ...
 */
class ContactPage extends MetaJsonLd implements ContactPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
    use ContactPageTrait;
    use WebPageTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ContactPage';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ContactPage';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Web page type: Contact page.';
