 ...
 * FourWheelDriveConfiguration - Four-wheel drive is a transmission layout where the engine primarily drives
 ...
 */
class FourWheelDriveConfiguration extends MetaJsonLd implements FourWheelDriveConfigurationInterface, DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'FourWheelDriveConfiguration';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/FourWheelDriveConfiguration';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'DriveWheelConfigurationValue';
...
SCHEMADESC;
    ...
    use FourWheelDriveConfigurationTrait;
