 ...
 */
class ImagingTest extends MetaJsonLd implements ImagingTestInterface, MedicalTestInterface, MedicalEntityInterface, ThingInterface
{
    use ImagingTestTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'imagingTechnique' => ['array', 'MedicalImagingTechnique', 'MedicalImagingTechnique[]'],
