...
/**
 * ImagingTest - Any medical imaging modality typically used for diagnostic
 * purposes.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ImagingTest extends MedicalTest
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ImagingTest';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ImagingTest';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Any medical imaging modality typically used for diagnostic purposes.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['imagingTechnique'], 'validateJsonSchema'],
