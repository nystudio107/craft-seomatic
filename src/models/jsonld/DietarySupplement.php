 ...
 */
class DietarySupplement extends MetaJsonLd implements DietarySupplementInterface, SubstanceInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DietarySupplement';
