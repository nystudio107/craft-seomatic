 ...
 */
class Dermatology extends MetaJsonLd implements DermatologyInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Dermatology';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Dermatology';
