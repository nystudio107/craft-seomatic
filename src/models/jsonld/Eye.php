 ...
 * Eye - Eye or ophthalmological function assessment with clinical examination.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/Eye
 */
class Eye extends MetaJsonLd implements EyeInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
	use EyeTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Eye';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Eye';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Eye or ophthalmological function assessment with clinical examination.';
