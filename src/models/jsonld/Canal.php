 ...
 */
class Canal extends MetaJsonLd implements CanalInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	use CanalTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Canal';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Canal';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A canal, like the Panama Canal.';
