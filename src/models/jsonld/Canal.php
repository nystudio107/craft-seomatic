...
class Canal extends MetaJsonLd implements CanalInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Canal';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Canal';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A canal, like the Panama Canal.';
