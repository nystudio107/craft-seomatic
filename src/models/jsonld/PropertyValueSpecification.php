...
class PropertyValueSpecification extends MetaJsonLd implements PropertyValueSpecificationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'PropertyValueSpecification';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/PropertyValueSpecification';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A Property value specification.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'defaultValue' => ['array', 'Text', 'Text[]', 'array', 'Thing', 'Thing[]'],
