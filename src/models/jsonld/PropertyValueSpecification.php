...
class PropertyValueSpecification extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PropertyValueSpecification';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PropertyValueSpecification';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A Property value specification.';
