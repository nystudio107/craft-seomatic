 ...
 * UserDownloads - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserDownloads extends MetaJsonLd implements UserDownloadsInterface, UserInteractionInterface, EventInterface, ThingInterface
{
    use UserDownloadsTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UserDownloads';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UserDownloads';
