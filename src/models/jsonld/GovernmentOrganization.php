...
class GovernmentOrganization extends Organization
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GovernmentOrganization';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GovernmentOrganization';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A governmental organization or agency.';
