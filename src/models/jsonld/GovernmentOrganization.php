...
class GovernmentOrganization extends MetaJsonLd implements GovernmentOrganizationInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'GovernmentOrganization';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/GovernmentOrganization';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A governmental organization or agency.';
