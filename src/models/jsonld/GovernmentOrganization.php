 ...
 */
class GovernmentOrganization extends MetaJsonLd implements GovernmentOrganizationInterface, OrganizationInterface, ThingInterface
{
	use GovernmentOrganizationTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'GovernmentOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/GovernmentOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A governmental organization or agency.';
