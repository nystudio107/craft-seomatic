...
class HealthTopicContent extends MetaJsonLd implements HealthTopicContentInterface, WebContentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HealthTopicContent';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/HealthTopicContent';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'WebContent';
