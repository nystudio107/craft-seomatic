...
class HealthTopicContent extends MetaJsonLd implements HealthTopicContentInterface, WebContentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'HealthTopicContent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/HealthTopicContent';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'WebContent';
