...
/**
 * LivingWithHealthAspect - Information about coping or life related to the
 * topic.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/LivingWithHealthAspect
 */
class LivingWithHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'LivingWithHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Information about coping or life related to the topic.';
