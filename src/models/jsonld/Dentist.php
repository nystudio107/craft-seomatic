 ...
 */
class Dentist extends MetaJsonLd implements DentistInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, MedicalOrganizationInterface, MedicalBusinessInterface
{
	use DentistTrait;
