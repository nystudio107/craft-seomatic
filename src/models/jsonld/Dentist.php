 ...
 */
class Dentist extends MetaJsonLd implements DentistInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Dentist';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Dentist';
