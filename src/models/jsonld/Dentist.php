 ...
 */
class Dentist extends MetaJsonLd implements DentistInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalBusinessInterface, MedicalOrganizationInterface
{
    use DentistTrait;
