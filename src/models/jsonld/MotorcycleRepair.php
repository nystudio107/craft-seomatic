 ...
 */
class MotorcycleRepair extends MetaJsonLd implements MotorcycleRepairInterface, AutomotiveBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
