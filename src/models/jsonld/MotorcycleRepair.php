...
class MotorcycleRepair extends AutomotiveBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MotorcycleRepair';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MotorcycleRepair';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A motorcycle repair shop.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'AutomotiveBusiness';
