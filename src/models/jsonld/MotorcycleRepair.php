 ...
 */
class MotorcycleRepair extends MetaJsonLd implements MotorcycleRepairInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MotorcycleRepairTrait;
