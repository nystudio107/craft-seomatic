 ...
 */
class HowToSection extends MetaJsonLd implements HowToSectionInterface, CreativeWorkInterface, ThingInterface, ListItemInterface, IntangibleInterface, ItemListInterface
{
