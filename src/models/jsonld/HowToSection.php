 ...
 */
class HowToSection extends MetaJsonLd implements HowToSectionInterface, ItemListInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface, ListItemInterface
{
