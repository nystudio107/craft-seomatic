 ...
 * HowToSection - A sub-grouping of steps in the instructions for how to achieve a result
 ...
 */
class HowToSection extends MetaJsonLd implements HowToSectionInterface, CreativeWorkInterface, ThingInterface, ItemListInterface, IntangibleInterface, ListItemInterface
{
	use HowToSectionTrait;
