 ...
 */
class HowToSection extends MetaJsonLd implements HowToSectionInterface, ListItemInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface, ItemListInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HowToSection';
