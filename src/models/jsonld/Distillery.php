 ...
 */
class Distillery extends MetaJsonLd implements DistilleryInterface, FoodEstablishmentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use DistilleryTrait;
