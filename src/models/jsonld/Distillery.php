 ...
 */
class Distillery extends MetaJsonLd implements DistilleryInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use DistilleryTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Distillery';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Distillery';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A distillery.';
