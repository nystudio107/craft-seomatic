...
use nystudio107\seomatic\models\jsonld\SportsActivityLocation;
...
class PublicSwimmingPool extends SportsActivityLocation
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PublicSwimmingPool';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PublicSwimmingPool';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A public swimming pool.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'SportsActivityLocation';
