 ...
 */
class PublicSwimmingPool extends MetaJsonLd implements PublicSwimmingPoolInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use PublicSwimmingPoolTrait;
