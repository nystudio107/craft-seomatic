 ...
 * FDAcategoryD - A designation by the US FDA signifying that there is positive evidence of
 ...
 */
class FDAcategoryD extends MetaJsonLd implements FDAcategoryDInterface, DrugPregnancyCategoryInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use FDAcategoryDTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FDAcategoryD';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FDAcategoryD';
