...
class ReactAction extends AssessAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ReactAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ReactAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of responding instinctively and emotionally to an object, expressing a sentiment.';
