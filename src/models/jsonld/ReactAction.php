...
/**
 * ReactAction - The act of responding instinctively and emotionally to an
...
class ReactAction extends AssessAction
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of responding instinctively and emotionally to an object, expressing a sentiment.';
