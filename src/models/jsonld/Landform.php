...
/**
 * Landform - A landform or physical feature. Landform elements include
 * mountains, plains, lakes, rivers, seascape and oceanic waterbody interface
 * features such as bays, peninsulas, seas and so forth, including sub-aqueous
...
class Landform extends Place
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Landform';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Landform';
