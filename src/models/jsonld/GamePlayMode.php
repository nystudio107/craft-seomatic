...
class GamePlayMode extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GamePlayMode';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GamePlayMode';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Indicates whether this game is multi-player, co-op or single-player.';
