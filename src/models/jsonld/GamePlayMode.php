...
/**
 * GamePlayMode - Indicates whether this game is multi-player, co-op or
 * single-player.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class GamePlayMode extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'GamePlayMode';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/GamePlayMode';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Indicates whether this game is multi-player, co-op or single-player.';
