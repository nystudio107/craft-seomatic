...
class MerchantReturnPolicySeasonalOverride extends MetaJsonLd implements MerchantReturnPolicySeasonalOverrideInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MerchantReturnPolicySeasonalOverride';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MerchantReturnPolicySeasonalOverride';
