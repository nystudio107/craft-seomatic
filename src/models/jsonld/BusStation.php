 ...
 */
class BusStation extends MetaJsonLd implements BusStationInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use BusStationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BusStation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BusStation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A bus station.';
