...
class Review extends MetaJsonLd implements ReviewInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Review';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Review';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A review of an item - for example, of a restaurant, movie, or store.';
