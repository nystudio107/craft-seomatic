 ...
 * DrugPrescriptionStatus - Indicates whether this drug is available by prescription or
 * over-the-counter.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DrugPrescriptionStatus extends MetaJsonLd implements DrugPrescriptionStatusInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DrugPrescriptionStatus';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DrugPrescriptionStatus';
