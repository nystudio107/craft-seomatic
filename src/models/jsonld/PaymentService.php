 ...
 */
class PaymentService extends MetaJsonLd implements PaymentServiceInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface, PaymentMethodInterface
{
