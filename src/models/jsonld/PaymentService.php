 ...
 */
class PaymentService extends MetaJsonLd implements PaymentServiceInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PaymentService';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PaymentService';
