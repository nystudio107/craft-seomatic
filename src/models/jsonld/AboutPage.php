 ...
 */
class AboutPage extends MetaJsonLd implements AboutPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
    use AboutPageTrait;
    use WebPageTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AboutPage';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AboutPage';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Web page type: About page.';
