...
class Diagnostic extends MetaJsonLd implements DiagnosticInterface, MedicalDevicePurposeInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Diagnostic';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Diagnostic';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A medical device used for diagnostic purposes.';
