...
class DiscoverAction extends FindAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DiscoverAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DiscoverAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of discovering/finding an object.';
