 ...
 */
class DiscoverAction extends MetaJsonLd implements DiscoverActionInterface, FindActionInterface, ActionInterface, ThingInterface
{
    use DiscoverActionTrait;
    use FindActionTrait;
    use ActionTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DiscoverAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DiscoverAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of discovering/finding an object.';
