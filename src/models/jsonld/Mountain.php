...
class Mountain extends Landform
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Mountain';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Mountain';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A mountain, like Mount Whitney or Mount Everest.';
