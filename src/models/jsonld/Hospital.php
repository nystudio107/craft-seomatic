 ...
 */
class Hospital extends MetaJsonLd implements HospitalInterface, EmergencyServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, CivicStructureInterface, MedicalOrganizationInterface
{
    use HospitalTrait;
