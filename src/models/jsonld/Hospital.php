 ...
 */
class Hospital extends MetaJsonLd implements HospitalInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, EmergencyServiceInterface, LocalBusinessInterface, PlaceInterface, CivicStructureInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Hospital';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Hospital';
