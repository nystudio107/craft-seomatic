 ...
 */
class Hospital extends MetaJsonLd implements HospitalInterface, CivicStructureInterface, PlaceInterface, ThingInterface, EmergencyServiceInterface, LocalBusinessInterface, OrganizationInterface, MedicalOrganizationInterface
{
    use HospitalTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'healthcareReportingData' => ['array', 'CDCPMDRecord', 'CDCPMDRecord[]', 'array', 'Dataset', 'Dataset[]'],
