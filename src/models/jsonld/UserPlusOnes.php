 ...
 * UserPlusOnes - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserPlusOnes extends MetaJsonLd implements UserPlusOnesInterface, UserInteractionInterface, EventInterface, ThingInterface
{
    use UserPlusOnesTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UserPlusOnes';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UserPlusOnes';
