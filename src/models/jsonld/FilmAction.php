...
/**
 * FilmAction - The act of capturing sound and moving images on film, video,
 * or digitally.
...
class FilmAction extends CreateAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'FilmAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/FilmAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of capturing sound and moving images on film, video, or digitally.';
