...
class Vehicle extends Product
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Vehicle';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Vehicle';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A vehicle is a device that is designed or used to transport people or cargo over land, water, air, or through space.';
