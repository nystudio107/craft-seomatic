...
class MedicalScholarlyArticle extends MetaJsonLd implements MedicalScholarlyArticleInterface, ScholarlyArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MedicalScholarlyArticle';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MedicalScholarlyArticle';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'ScholarlyArticle';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A scholarly article in the medical domain.';
