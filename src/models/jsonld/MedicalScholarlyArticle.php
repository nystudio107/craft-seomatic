 ...
 */
class MedicalScholarlyArticle extends MetaJsonLd implements MedicalScholarlyArticleInterface, ScholarlyArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
    use MedicalScholarlyArticleTrait;
    use ScholarlyArticleTrait;
    use ArticleTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MedicalScholarlyArticle';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MedicalScholarlyArticle';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'ScholarlyArticle';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A scholarly article in the medical domain.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'publicationType' => ['array', 'Text', 'Text[]'],
