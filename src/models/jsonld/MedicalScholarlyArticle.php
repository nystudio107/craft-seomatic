...
class MedicalScholarlyArticle extends MetaJsonLd implements MedicalScholarlyArticleInterface, ScholarlyArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalScholarlyArticle';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MedicalScholarlyArticle';
     ...
     * @var string
     */
    static public $schemaTypeExtends = 'ScholarlyArticle';
