...
use nystudio107\seomatic\models\jsonld\ScholarlyArticle;
...
class MedicalScholarlyArticle extends ScholarlyArticle
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A scholarly article in the medical domain.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['publicationType'], 'validateJsonSchema'],
