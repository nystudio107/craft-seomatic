 ...
 */
class Pharmacy extends MetaJsonLd implements PharmacyInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
	use PharmacyTrait;
