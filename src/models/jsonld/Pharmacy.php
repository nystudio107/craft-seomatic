 ...
 */
class Pharmacy extends MetaJsonLd implements PharmacyInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface
{
    use PharmacyTrait;
