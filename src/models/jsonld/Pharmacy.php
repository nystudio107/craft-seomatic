 ...
 */
class Pharmacy extends MetaJsonLd implements PharmacyInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, MedicalOrganizationInterface
{
    use PharmacyTrait;
