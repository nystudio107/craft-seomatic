...
class Pharmacy extends MedicalOrganization
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Pharmacy';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Pharmacy';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A pharmacy or drugstore.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'MedicalOrganization';
