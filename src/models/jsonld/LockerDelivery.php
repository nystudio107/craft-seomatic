...
/**
 * LockerDelivery - A DeliveryMethod in which an item is made available via
 * locker.
...
class LockerDelivery extends DeliveryMethod
{
     ...
     * @var string
     */
    static $schemaTypeName = 'LockerDelivery';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/LockerDelivery';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A DeliveryMethod in which an item is made available via locker.';
