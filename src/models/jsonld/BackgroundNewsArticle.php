 ...
 * BackgroundNewsArticle - A [[NewsArticle]] providing historical context, definition and detail on a
 ...
 */
class BackgroundNewsArticle extends MetaJsonLd implements BackgroundNewsArticleInterface, NewsArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
    use BackgroundNewsArticleTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BackgroundNewsArticle';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BackgroundNewsArticle';
