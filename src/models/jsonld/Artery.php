 ...
 */
class Artery extends MetaJsonLd implements ArteryInterface, VesselInterface, AnatomicalStructureInterface, MedicalEntityInterface, ThingInterface
{
    use ArteryTrait;
    use VesselTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Artery';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Artery';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A type of blood vessel that specifically carries blood away from the heart.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'arterialBranch' => ['array', 'AnatomicalStructure', 'AnatomicalStructure[]'],
            ...
            'supplyTo' => ['array', 'AnatomicalStructure', 'AnatomicalStructure[]'],
            'url' => ['array', 'URL', 'URL[]'],
        ];
    }
