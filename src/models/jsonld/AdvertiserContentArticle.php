 ...
 * AdvertiserContentArticle - An [[Article]] that an external entity has paid to place or to produce to
 ...
 */
class AdvertiserContentArticle extends MetaJsonLd implements AdvertiserContentArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'AdvertiserContentArticle';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/AdvertiserContentArticle';
...
SCHEMADESC;
    ...
    use AdvertiserContentArticleTrait;
    use ArticleTrait;
