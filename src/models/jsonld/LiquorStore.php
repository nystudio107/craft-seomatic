 ...
 * LiquorStore - A shop that sells alcoholic drinks such as wine, beer, whisky and other
 * spirits.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class LiquorStore extends MetaJsonLd implements LiquorStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use LiquorStoreTrait;
	use StoreTrait;
