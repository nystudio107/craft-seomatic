...
/**
 * LiquorStore - A shop that sells alcoholic drinks such as wine, beer, whisky
 * and other spirits.
 * Extends: Store
...
class LiquorStore extends Store
{
     ...
     * @var string
     */
    static $schemaTypeName = 'LiquorStore';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/LiquorStore';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits.';
