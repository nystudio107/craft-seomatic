...
class FinancialIncentive extends MetaJsonLd implements FinancialIncentiveInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'FinancialIncentive';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/FinancialIncentive';
