...
class MedicalOrganization extends Organization
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MedicalOrganization';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MedicalOrganization';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A medical organization (physical or not), such as hospital, institution or clinic.';
