 ...
 */
class MusicRecording extends MetaJsonLd implements MusicRecordingInterface, CreativeWorkInterface, ThingInterface
{
    use MusicRecordingTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'inAlbum' => ['array', 'MusicAlbum', 'MusicAlbum[]'],
            'inLanguage' => ['array', 'Text', 'Text[]', 'array', 'Language', 'Language[]'],
            'inPlaylist' => ['array', 'MusicPlaylist', 'MusicPlaylist[]'],
            ...
            'recordingOf' => ['array', 'MusicComposition', 'MusicComposition[]'],
