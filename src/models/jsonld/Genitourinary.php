...
class Genitourinary extends MetaJsonLd implements GenitourinaryInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Genitourinary';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Genitourinary';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Genitourinary system function assessment with clinical examination.';
