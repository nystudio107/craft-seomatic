 ...
 */
class Genitourinary extends MetaJsonLd implements GenitourinaryInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
    use GenitourinaryTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Genitourinary';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Genitourinary';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Genitourinary system function assessment with clinical examination.';
