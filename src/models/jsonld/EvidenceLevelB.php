...
class EvidenceLevelB extends MetaJsonLd implements EvidenceLevelBInterface, MedicalEvidenceLevelInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EvidenceLevelB';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EvidenceLevelB';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Data derived from a single randomized trial, or nonrandomized studies.';
