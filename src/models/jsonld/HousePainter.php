 ...
 */
class HousePainter extends MetaJsonLd implements HousePainterInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use HousePainterTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'HousePainter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/HousePainter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A house painting service.';
