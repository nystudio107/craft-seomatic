...
class HousePainter extends MetaJsonLd implements HousePainterInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'HousePainter';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/HousePainter';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A house painting service.';
