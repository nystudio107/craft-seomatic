 ...
 */
class HousePainter extends MetaJsonLd implements HousePainterInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
