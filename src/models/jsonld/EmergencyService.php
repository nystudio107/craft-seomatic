...
class EmergencyService extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'EmergencyService';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/EmergencyService';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An emergency service, such as a fire station or ER.';
