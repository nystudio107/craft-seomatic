 ...
 */
class EmergencyService extends MetaJsonLd implements EmergencyServiceInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
