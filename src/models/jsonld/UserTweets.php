 ...
 * UserTweets - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserTweets extends MetaJsonLd implements UserTweetsInterface, UserInteractionInterface, EventInterface, ThingInterface
{
	use UserTweetsTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'UserTweets';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/UserTweets';
