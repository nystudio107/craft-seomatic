 ...
 * SelfCareHealthAspect - Self care actions or measures that can be taken to sooth, health or avoid a
 ...
 */
class SelfCareHealthAspect extends MetaJsonLd implements SelfCareHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SelfCareHealthAspect';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SelfCareHealthAspect';
