...
class RoofingContractor extends MetaJsonLd implements RoofingContractorInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'RoofingContractor';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/RoofingContractor';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A roofing contractor.';
