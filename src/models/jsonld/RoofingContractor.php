 ...
 */
class RoofingContractor extends MetaJsonLd implements RoofingContractorInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use RoofingContractorTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'RoofingContractor';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/RoofingContractor';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A roofing contractor.';
