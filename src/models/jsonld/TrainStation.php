...
class TrainStation extends MetaJsonLd implements TrainStationInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TrainStation';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TrainStation';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A train station.';
