 ...
 */
class TrainStation extends MetaJsonLd implements TrainStationInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use TrainStationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'TrainStation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/TrainStation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A train station.';
