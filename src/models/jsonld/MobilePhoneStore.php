...
class MobilePhoneStore extends Store
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MobilePhoneStore';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MobilePhoneStore';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A store that sells mobile phones and related accessories.';
