 ...
 */
class MobilePhoneStore extends MetaJsonLd implements MobilePhoneStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MobilePhoneStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MobilePhoneStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MobilePhoneStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A store that sells mobile phones and related accessories.';
