...
/**
 * MobilePhoneStore - A store that sells mobile phones and related
 * accessories.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MobilePhoneStore extends Store
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A store that sells mobile phones and related accessories.';
