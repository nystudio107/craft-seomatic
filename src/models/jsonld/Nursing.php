 ...
 * Nursing - A health profession of a person formally educated and trained in the care
 ...
 */
class Nursing extends MetaJsonLd implements NursingInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use NursingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Nursing';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Nursing';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A health profession of a person formally educated and trained in the care of the sick or infirm person.';
