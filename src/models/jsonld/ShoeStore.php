 ...
 */
class ShoeStore extends MetaJsonLd implements ShoeStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use ShoeStoreTrait;
	use StoreTrait;
