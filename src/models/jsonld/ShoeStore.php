 ...
 */
class ShoeStore extends MetaJsonLd implements ShoeStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ShoeStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ShoeStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ShoeStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A shoe store.';
