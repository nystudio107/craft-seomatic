 ...
 */
class Notary extends MetaJsonLd implements NotaryInterface, LegalServiceInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use NotaryTrait;
