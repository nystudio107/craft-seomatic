 ...
 */
class Notary extends MetaJsonLd implements NotaryInterface, LegalServiceInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use NotaryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Notary';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Notary';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A notary.';
