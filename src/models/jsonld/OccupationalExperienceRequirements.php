 ...
 * OccupationalExperienceRequirements - Indicates employment-related experience requirements, e.g.
 * [[monthsOfExperience]].
 *
 * @author    nystudio107
 * @package   Seomatic
...
class OccupationalExperienceRequirements extends MetaJsonLd implements OccupationalExperienceRequirementsInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OccupationalExperienceRequirements';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OccupationalExperienceRequirements';
