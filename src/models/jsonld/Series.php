...
/**
 * Series - A Series in schema.org is a group of related items, typically but
 * not necessarily of the same kind. See also CreativeWorkSeries, EventSeries.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class Series extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Series';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Series';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A Series in schema.org is a group of related items, typically but not necessarily of the same kind. See also CreativeWorkSeries, EventSeries.';
