...
class WebAPI extends Service
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'WebAPI';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An application programming interface accessible over Web/Internet technologies.';
    ...
    public function rules(): array
    {
        ...
        $rules = array_merge($rules, [
            [['documentation'], 'validateJsonSchema'],
