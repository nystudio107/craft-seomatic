 ...
 */
class WebAPI extends MetaJsonLd implements WebAPIInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WebAPI';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WebAPI';
