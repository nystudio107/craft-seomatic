 ...
 * LeftHandDriving - The steering position is on the left side of the vehicle (viewed from the
...
class LeftHandDriving extends MetaJsonLd implements LeftHandDrivingInterface, SteeringPositionValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'LeftHandDriving';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/LeftHandDriving';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The steering position is on the left side of the vehicle (viewed from the main direction of driving).';
