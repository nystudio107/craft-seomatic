 ...
 */
class Neuro extends MetaJsonLd implements NeuroInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
    use NeuroTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Neuro';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Neuro';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Neurological system clinical examination.';
