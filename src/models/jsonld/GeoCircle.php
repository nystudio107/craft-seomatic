...
class GeoCircle extends MetaJsonLd implements GeoCircleInterface, GeoShapeInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'GeoCircle';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/GeoCircle';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'GeoShape';
