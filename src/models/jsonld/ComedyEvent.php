 ...
 */
class ComedyEvent extends MetaJsonLd implements ComedyEventInterface, EventInterface, ThingInterface
{
    use ComedyEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ComedyEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ComedyEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Comedy event.';
