...
class ComedyEvent extends MetaJsonLd implements ComedyEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ComedyEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ComedyEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Event type: Comedy event.';
