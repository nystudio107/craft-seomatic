...
class Neck extends MetaJsonLd implements NeckInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Neck';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Neck';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Neck assessment with clinical examination.';
