 ...
 */
class Neck extends MetaJsonLd implements NeckInterface, PhysicalExamInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface
{
    use NeckTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Neck';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Neck';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Neck assessment with clinical examination.';
