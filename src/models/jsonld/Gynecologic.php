 ...
 * Gynecologic - A specific branch of medical science that pertains to the health care of
 ...
 */
class Gynecologic extends MetaJsonLd implements GynecologicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use GynecologicTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Gynecologic';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Gynecologic';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A specific branch of medical science that pertains to the health care of women, particularly in the diagnosis and treatment of disorders affecting the female reproductive system.';
