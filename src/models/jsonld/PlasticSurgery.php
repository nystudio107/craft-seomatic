 ...
 * PlasticSurgery - A specific branch of medical science that pertains to therapeutic or
 ...
 */
class PlasticSurgery extends MetaJsonLd implements PlasticSurgeryInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use PlasticSurgeryTrait;
