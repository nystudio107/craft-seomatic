...
use nystudio107\seomatic\models\jsonld\Landform;
...
class Volcano extends Landform
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Volcano';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Volcano';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A volcano, like Fuji san.';
    ...
    static protected $_schemaPropertyDescriptions = [
        ...
        'faxNumber' => 'The fax number. The fax number.',
        ...
        'globalLocationNumber' => 'The Global Location Number (GLN, sometimes also referred to as International Location Number or ILN) of the respective organization, person, or place. The GLN is a 13-digit number used to identify parties and physical locations. The Global Location Number (GLN, sometimes also referred to as International Location Number or ILN) of the respective organization, person, or place. The GLN is a 13-digit number used to identify parties and physical locations.',
     ...
     * physical locations. The Global Location Number (GLN, sometimes also
