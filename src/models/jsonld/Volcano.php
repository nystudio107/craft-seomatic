 ...
 */
class Volcano extends MetaJsonLd implements VolcanoInterface, LandformInterface, PlaceInterface, ThingInterface
{
    use VolcanoTrait;
    use LandformTrait;
    use PlaceTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Volcano';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Volcano';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A volcano, like Fujisan.';
