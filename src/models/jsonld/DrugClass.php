 ...
 * DrugClass - A class of medical drugs, e.g., statins. Classes can represent general
 ...
 */
class DrugClass extends MetaJsonLd implements DrugClassInterface, MedicalEntityInterface, ThingInterface
{
