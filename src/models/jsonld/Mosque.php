 ...
 */
class Mosque extends MetaJsonLd implements MosqueInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use MosqueTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Mosque';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Mosque';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A mosque.';
