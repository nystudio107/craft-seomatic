...
/**
 * LegislativeBuilding - A legislative building—for example, the state
 * capitol.
...
class LegislativeBuilding extends GovernmentBuilding
{
     ...
     * @var string
     */
    static $schemaTypeName = 'LegislativeBuilding';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/LegislativeBuilding';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A legislative building—for example, the state capitol.';
