 ...
 */
class LegislativeBuilding extends MetaJsonLd implements LegislativeBuildingInterface, GovernmentBuildingInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use LegislativeBuildingTrait;
