 ...
 */
class WearableSizeSystemEN13402 extends MetaJsonLd implements WearableSizeSystemEN13402Interface, WearableSizeSystemEnumerationInterface, SizeSystemEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WearableSizeSystemEN13402';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WearableSizeSystemEN13402';
...
SCHEMADESC;
    ...
    use WearableSizeSystemEN13402Trait;
