...
class ClothingStore extends MetaJsonLd implements ClothingStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ClothingStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ClothingStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A clothing store.';
