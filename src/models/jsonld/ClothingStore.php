 ...
 */
class ClothingStore extends MetaJsonLd implements ClothingStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ClothingStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ClothingStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ClothingStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A clothing store.';
