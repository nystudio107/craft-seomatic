 ...
 */
class SportsClub extends MetaJsonLd implements SportsClubInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use SportsClubTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SportsClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SportsClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A sports club.';
