...
class Recipe extends MetaJsonLd implements RecipeInterface, HowToInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Recipe';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'recipeInstructions' => ['Text', 'CreativeWork', 'ItemList'],
            'recipeYield' => ['Text', 'QuantitativeValue'],
            'recordedAt' => ['Event'],
            ...
            'step' => ['HowToStep', 'HowToSection', 'Text', 'CreativeWork'],
