...
class Recipe extends MetaJsonLd implements RecipeInterface, HowToInterface, CreativeWorkInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'recipeIngredient' => ['array', 'Text', 'Text[]'],
            'recipeInstructions' => ['array', 'ItemList', 'ItemList[]', 'array', 'Text', 'Text[]', 'array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'step' => ['array', 'Text', 'Text[]', 'array', 'HowToSection', 'HowToSection[]', 'array', 'HowToStep', 'HowToStep[]', 'array', 'CreativeWork', 'CreativeWork[]'],
            'steps' => ['array', 'Text', 'Text[]', 'array', 'CreativeWork', 'CreativeWork[]', 'array', 'ItemList', 'ItemList[]'],
            'subjectOf' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'Event', 'Event[]'],
            'suitableForDiet' => ['array', 'RestrictedDiet', 'RestrictedDiet[]'],
            'supply' => ['array', 'Text', 'Text[]', 'array', 'HowToSupply', 'HowToSupply[]'],
            ...
            'yield' => ['array', 'Text', 'Text[]', 'array', 'QuantitativeValue', 'QuantitativeValue[]'],
        ];
    }
