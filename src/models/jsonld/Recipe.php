 ...
 * Recipe - A recipe. For dietary restrictions covered by the recipe, a few common
 ...
 */
class Recipe extends MetaJsonLd implements RecipeInterface, HowToInterface, CreativeWorkInterface, ThingInterface
{
    use RecipeTrait;
    use HowToTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Recipe';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Recipe';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'HowTo';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A recipe. For dietary restrictions covered by the recipe, a few common restrictions are enumerated via [[suitableForDiet]]. The [[keywords]] property can also be used to add more detail.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'cookTime' => ['array', 'Duration', 'Duration[]'],
            'cookingMethod' => ['array', 'Text', 'Text[]'],
            ...
            'estimatedCost' => ['array', 'MonetaryAmount', 'MonetaryAmount[]', 'array', 'Text', 'Text[]'],
            ...
            'nutrition' => ['array', 'NutritionInformation', 'NutritionInformation[]'],
            ...
            'performTime' => ['array', 'Duration', 'Duration[]'],
            'position' => ['array', 'Integer', 'Integer[]', 'array', 'Text', 'Text[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'prepTime' => ['array', 'Duration', 'Duration[]'],
            ...
            'recipeCategory' => ['array', 'Text', 'Text[]'],
            'recipeCuisine' => ['array', 'Text', 'Text[]'],
            'recipeIngredient' => ['array', 'ItemList', 'ItemList[]', 'array', 'PropertyValue', 'PropertyValue[]', 'array', 'Text', 'Text[]'],
            'recipeInstructions' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'ItemList', 'ItemList[]', 'array', 'Text', 'Text[]'],
            'recipeYield' => ['array', 'QuantitativeValue', 'QuantitativeValue[]', 'array', 'Text', 'Text[]'],
            ...
            'step' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'HowToSection', 'HowToSection[]', 'array', 'HowToStep', 'HowToStep[]', 'array', 'Text', 'Text[]'],
            'steps' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'ItemList', 'ItemList[]', 'array', 'Text', 'Text[]'],
            'subjectOf' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'Event', 'Event[]'],
            'suitableForDiet' => ['array', 'Diet', 'Diet[]', 'array', 'RestrictedDiet', 'RestrictedDiet[]'],
            'supply' => ['array', 'HowToSupply', 'HowToSupply[]', 'array', 'Text', 'Text[]'],
            ...
            'tool' => ['array', 'HowToTool', 'HowToTool[]', 'array', 'Text', 'Text[]'],
            'totalTime' => ['array', 'Duration', 'Duration[]'],
            ...
            'yield' => ['array', 'QuantitativeValue', 'QuantitativeValue[]', 'array', 'Text', 'Text[]'],
        ];
    }
