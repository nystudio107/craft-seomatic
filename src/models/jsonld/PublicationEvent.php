 ...
 * PublicationEvent - A PublicationEvent corresponds indifferently to the event of publication
 ...
 */
class PublicationEvent extends MetaJsonLd implements PublicationEventInterface, EventInterface, ThingInterface
{
	use PublicationEventTrait;
	use EventTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'PublicationEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/PublicationEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A PublicationEvent corresponds indifferently to the event of publication for a CreativeWork of any type, e.g. a broadcast event, an on-demand event, a book/journal publication via a variety of delivery media.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'publishedBy' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'publishedOn' => ['array', 'BroadcastService', 'BroadcastService[]'],
