...
class FoodService extends Service
{
     ...
     * @var string
     */
    static $schemaTypeName = 'FoodService';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/FoodService';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A food service, like breakfast, lunch, or dinner.';
