 ...
 */
class FoodService extends MetaJsonLd implements FoodServiceInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
    use FoodServiceTrait;
    use ServiceTrait;
    use IntangibleTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FoodService';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FoodService';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A food service, like breakfast, lunch, or dinner.';
