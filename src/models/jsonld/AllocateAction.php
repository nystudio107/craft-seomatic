...
/**
 * AllocateAction - The act of organizing tasks/objects/events by associating
 * resources to it.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class AllocateAction extends OrganizeAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AllocateAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/AllocateAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of organizing tasks/objects/events by associating resources to it.';
