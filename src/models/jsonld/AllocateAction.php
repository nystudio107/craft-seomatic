...
class AllocateAction extends OrganizeAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AllocateAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AllocateAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of organizing tasks/objects/events by associating resources to it.';
