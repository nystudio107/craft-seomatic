...
class IgnoreAction extends MetaJsonLd implements IgnoreActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'IgnoreAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/IgnoreAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of intentionally disregarding the object. An agent ignores an object.';
