...
class IgnoreAction extends AssessAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'IgnoreAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/IgnoreAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of intentionally disregarding the object. An agent ignores an object.';
