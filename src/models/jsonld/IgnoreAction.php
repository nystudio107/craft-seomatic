 ...
 * IgnoreAction - The act of intentionally disregarding the object. An agent ignores an
 * object.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class IgnoreAction extends MetaJsonLd implements IgnoreActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
    use IgnoreActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'IgnoreAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/IgnoreAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of intentionally disregarding the object. An agent ignores an object.';
