...
class MapCategoryType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MapCategoryType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MapCategoryType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An enumeration of several kinds of Map.';
