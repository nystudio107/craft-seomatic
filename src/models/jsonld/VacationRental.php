 ...
 * VacationRental - A kind of lodging business that focuses on renting single properties for
 * limited time.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class VacationRental extends MetaJsonLd implements VacationRentalInterface, LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use VacationRentalTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'VacationRental';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/VacationRental';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A kind of lodging business that focuses on renting single properties for limited time.';
