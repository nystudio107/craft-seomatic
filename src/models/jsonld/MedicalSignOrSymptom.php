 ...
 * MedicalSignOrSymptom - Any feature associated or not with a medical condition. In medicine a
 ...
 */
class MedicalSignOrSymptom extends MetaJsonLd implements MedicalSignOrSymptomInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalSignOrSymptom';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalSignOrSymptom';
