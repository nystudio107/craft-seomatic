...
class PostOffice extends GovernmentOffice
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PostOffice';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PostOffice';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A post office.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'GovernmentOffice';
