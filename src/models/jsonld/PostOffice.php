...
class PostOffice extends MetaJsonLd implements PostOfficeInterface, GovernmentOfficeInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PostOffice';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PostOffice';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'GovernmentOffice';
