 ...
 */
class BoatTerminal extends MetaJsonLd implements BoatTerminalInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use BoatTerminalTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BoatTerminal';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BoatTerminal';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A terminal for boats, ships, and other water vessels.';
