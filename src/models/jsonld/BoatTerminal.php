...
class BoatTerminal extends MetaJsonLd implements BoatTerminalInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'BoatTerminal';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/BoatTerminal';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A terminal for boats, ships, and other water vessels.';
