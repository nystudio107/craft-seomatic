 ...
 * SeekToAction - This is the [[Action]] of navigating to a specific [[startOffset]]
 ...
 */
class SeekToAction extends MetaJsonLd implements SeekToActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SeekToAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SeekToAction';
