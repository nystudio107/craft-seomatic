 ...
 * TransferAction - The act of transferring/moving (abstract or concrete) animate or inanimate
 ...
 */
class TransferAction extends MetaJsonLd implements TransferActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TransferAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TransferAction';
