...
/**
 * TransferAction - The act of transferring/moving (abstract or concrete)
...
class TransferAction extends Action
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TransferAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TransferAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of transferring/moving (abstract or concrete) animate or inanimate objects from one place to another.';
