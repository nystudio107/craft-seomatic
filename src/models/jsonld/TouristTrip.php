...
/**
 * TouristTrip - A tourist trip. A created itinerary of visits to one or more
 * places of interest (TouristAttraction/TouristDestination) often linked by a
 * similar theme, geographic area, or interest to a particular touristType.
 * The UNWTO defines tourism trip as the Trip taken by visitors. (See examples
 * below).
 *
 * @author    nystudio107
 * @package   Seomatic
...
class TouristTrip extends Trip
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'TouristTrip';
    ...
    public function rules(): array
    {
        ...
        $rules = array_merge($rules, [
            [['touristType'], 'validateJsonSchema'],
