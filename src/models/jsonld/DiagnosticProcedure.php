 ...
 * DiagnosticProcedure - A medical procedure intended primarily for diagnostic, as opposed to
 ...
 */
class DiagnosticProcedure extends MetaJsonLd implements DiagnosticProcedureInterface, MedicalProcedureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DiagnosticProcedure';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DiagnosticProcedure';
