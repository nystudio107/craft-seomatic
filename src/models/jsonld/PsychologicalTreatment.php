...
use nystudio107\seomatic\models\jsonld\TherapeuticProcedure;

/**
 * PsychologicalTreatment - A process of care relying upon counseling,
 * dialogue and communication aimed at improving a mental health condition
...
class PsychologicalTreatment extends TherapeuticProcedure
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PsychologicalTreatment';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PsychologicalTreatment';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A process of care relying upon counseling, dialogue and communication aimed at improving a mental health condition without use of drugs.';
