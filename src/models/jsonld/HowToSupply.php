...
class HowToSupply extends MetaJsonLd implements HowToSupplyInterface, HowToItemInterface, ListItemInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HowToSupply';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/HowToSupply';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'HowToItem';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'requiredQuantity' => ['QuantitativeValue', 'Number', 'Text'],
            'sameAs' => ['URL'],
