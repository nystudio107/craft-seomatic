...
class HowToSupply extends MetaJsonLd implements HowToSupplyInterface, HowToItemInterface, ListItemInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'HowToSupply';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/HowToSupply';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A supply consumed when performing the instructions for how to achieve a result.';
