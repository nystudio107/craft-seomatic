 ...
 * Resort - A resort is a place used for relaxation or recreation, attracting visitors
 ...
 */
class Resort extends MetaJsonLd implements ResortInterface, LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ResortTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Resort';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Resort';
