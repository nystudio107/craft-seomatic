 ...
 */
class Resort extends MetaJsonLd implements ResortInterface, LodgingBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use ResortTrait;
