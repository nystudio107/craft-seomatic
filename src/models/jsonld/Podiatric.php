 ...
 * Podiatric - Podiatry is the care of the human foot, especially the diagnosis and
 ...
 */
class Podiatric extends MetaJsonLd implements PodiatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use PodiatricTrait;
