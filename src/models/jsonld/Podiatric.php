 ...
 */
class Podiatric extends MetaJsonLd implements PodiatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Podiatric';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Podiatric';
