...
class EventSeries extends MetaJsonLd implements EventSeriesInterface, SeriesInterface, IntangibleInterface, ThingInterface, EventInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'EventSeries';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/EventSeries';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Series';
