 ...
 * MobileWebPlatform - Represents the broad notion of 'mobile' browsers as a Web Platform.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MobileWebPlatform extends MetaJsonLd implements MobileWebPlatformInterface, DigitalPlatformEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MobileWebPlatform';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MobileWebPlatform';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Represents the broad notion of \'mobile\' browsers as a Web Platform.';
