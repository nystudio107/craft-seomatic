 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/MayTreatHealthAspect
 */
class MayTreatHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Related topics may be treated by a Topic.';
