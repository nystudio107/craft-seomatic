 ...
 */
class DryCleaningOrLaundry extends MetaJsonLd implements DryCleaningOrLaundryInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use DryCleaningOrLaundryTrait;
