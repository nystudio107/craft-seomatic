...
class DryCleaningOrLaundry extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DryCleaningOrLaundry';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DryCleaningOrLaundry';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A dry-cleaning business.';
