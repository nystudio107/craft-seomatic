...
/**
 * XPathType - Text representing an XPath (typically but not necessarily
 * version 1.0).
 *
 * @author    nystudio107
 * @package   Seomatic
...
class XPathType extends Text
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Text representing an XPath (typically but not necessarily version 1.0).';
