 ...
 */
class RadioSeason extends MetaJsonLd implements RadioSeasonInterface, CreativeWorkSeasonInterface, CreativeWorkInterface, ThingInterface
{
    use RadioSeasonTrait;
