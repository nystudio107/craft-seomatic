...
class RadioSeason extends CreativeWorkSeason
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RadioSeason';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RadioSeason';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Season dedicated to radio broadcast and associated online delivery.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'CreativeWorkSeason';
