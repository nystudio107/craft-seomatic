 ...
 * DietNutrition - Dietetics and nutrition as a medical specialty.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/DietNutrition
 */
class DietNutrition extends MetaJsonLd implements DietNutritionInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
