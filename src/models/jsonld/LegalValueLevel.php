...
/**
 * LegalValueLevel - A list of possible levels for the legal validity of a
 * legislation.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class LegalValueLevel extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'LegalValueLevel';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A list of possible levels for the legal validity of a legislation.';
