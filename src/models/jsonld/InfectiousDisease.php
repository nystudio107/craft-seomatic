...
class InfectiousDisease extends MetaJsonLd implements InfectiousDiseaseInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'InfectiousDisease';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/InfectiousDisease';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalCondition';
