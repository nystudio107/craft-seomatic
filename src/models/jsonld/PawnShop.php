...
/**
 * PawnShop - A shop that will buy, or lend money against the security of,
...
class PawnShop extends Store
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PawnShop';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PawnShop';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A shop that will buy, or lend money against the security of, personal possessions.';
