...
class PawnShop extends Store
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PawnShop';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A shop that will buy, or lend money against the security of, personal possessions.';
