...
class ItemListOrderDescending extends MetaJsonLd implements ItemListOrderDescendingInterface, ItemListOrderTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ItemListOrderDescending';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ItemListOrderDescending';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An ItemList ordered with higher values listed first.';
