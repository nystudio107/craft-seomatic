 ...
 * based on factual reporting, incorporates the expertise of the
 * author/producer, offering interpretations and conclusions.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/AnalysisNewsArticle
 */
class AnalysisNewsArticle extends NewsArticle
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AnalysisNewsArticle';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/AnalysisNewsArticle';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An AnalysisNewsArticle is a NewsArticle that, while based on factual reporting, incorporates the expertise of the author/producer, offering interpretations and conclusions.';
