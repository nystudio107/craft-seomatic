 ...
 * AnalysisNewsArticle - An AnalysisNewsArticle is a [[NewsArticle]] that, while based on factual
 ...
 */
class AnalysisNewsArticle extends MetaJsonLd implements AnalysisNewsArticleInterface, NewsArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
    use AnalysisNewsArticleTrait;
