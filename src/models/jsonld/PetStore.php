 ...
 */
class PetStore extends MetaJsonLd implements PetStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use PetStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'PetStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/PetStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A pet store.';
