 ...
 */
class ResearchProject extends MetaJsonLd implements ResearchProjectInterface, ProjectInterface, OrganizationInterface, ThingInterface
{
	use ResearchProjectTrait;
	use ProjectTrait;
