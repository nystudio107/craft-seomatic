 ...
 * LikeAction - The act of expressing a positive sentiment about the object. An agent likes
 ...
 */
class LikeAction extends MetaJsonLd implements LikeActionInterface, ReactActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LikeAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LikeAction';
