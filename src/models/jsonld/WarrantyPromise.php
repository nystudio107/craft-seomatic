 ...
 * WarrantyPromise - A structured value representing the duration and scope of services that
...
class WarrantyPromise extends MetaJsonLd implements WarrantyPromiseInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WarrantyPromise';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WarrantyPromise';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A structured value representing the duration and scope of services that will be provided to a customer free of charge in case of a defect or malfunction of a product.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'durationOfWarranty' => ['array', 'QuantitativeValue', 'QuantitativeValue[]'],
            ...
            'url' => ['array', 'URL', 'URL[]'],
            'warrantyScope' => ['array', 'WarrantyScope', 'WarrantyScope[]'],
        ];
    }
