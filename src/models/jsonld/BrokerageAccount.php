 ...
 * BrokerageAccount - An account that allows an investor to deposit funds and place investment
 ...
 */
class BrokerageAccount extends MetaJsonLd implements BrokerageAccountInterface, InvestmentOrDepositInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BrokerageAccount';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BrokerageAccount';
