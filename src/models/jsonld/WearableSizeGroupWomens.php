...
class WearableSizeGroupWomens extends MetaJsonLd implements WearableSizeGroupWomensInterface, WearableSizeGroupEnumerationInterface, SizeGroupEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'WearableSizeGroupWomens';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/WearableSizeGroupWomens';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Size group "Womens" for wearables.';
