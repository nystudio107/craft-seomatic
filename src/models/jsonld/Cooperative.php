 ...
 * Cooperative - An organization that is a joint project of multiple organizations or
 * persons.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/Cooperative
 */
class Cooperative extends MetaJsonLd implements CooperativeInterface, OrganizationInterface, ThingInterface
{
    use CooperativeTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Cooperative';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Cooperative';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An organization that is a joint project of multiple organizations or persons.';
