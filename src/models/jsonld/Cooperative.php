...
class Cooperative extends MetaJsonLd implements CooperativeInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Cooperative';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Cooperative';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An organization that is a joint project of multiple organizations or persons.';
