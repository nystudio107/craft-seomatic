 ...
 * Quotation - A quotation. Often but not necessarily from some written work, attributable
 ...
 */
class Quotation extends MetaJsonLd implements QuotationInterface, CreativeWorkInterface, ThingInterface
{
    use QuotationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Quotation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Quotation';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'spokenByCharacter' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
