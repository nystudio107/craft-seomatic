...
class DENonprofitType extends MetaJsonLd implements DENonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'DENonprofitType';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/DENonprofitType';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'DENonprofitType: Non-profit organization type originating from Germany in accordance with article 52 of the German fiscal code (Abgabenverordnung or AO).';
