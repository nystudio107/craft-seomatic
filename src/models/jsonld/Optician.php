 ...
 * Optician - A store that sells reading glasses and similar devices for improving
 * vision.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Optician extends MetaJsonLd implements OpticianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use OpticianTrait;
