...
/**
 * Optician - A store that sells reading glasses and similar devices for
 * improving vision.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Optician extends MedicalBusiness
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A store that sells reading glasses and similar devices for improving vision.';
