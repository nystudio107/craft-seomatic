 ...
 */
class NailSalon extends MetaJsonLd implements NailSalonInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use NailSalonTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'NailSalon';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/NailSalon';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A nail salon.';
