 ...
 */
class NailSalon extends MetaJsonLd implements NailSalonInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use NailSalonTrait;
