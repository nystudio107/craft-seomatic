...
/**
 * BusinessFunction - The business function specifies the type of activity or
 * access (i.e., the bundle of rights) offered by the organization or business
 * person through the offer. Typical are sell, rental or lease, maintenance or
 ...
 * are also instances of this class. Commonly used
 * values:http://purl.org/goodrelations/v1#ConstructionInstallation
...
class BusinessFunction extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BusinessFunction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BusinessFunction';
