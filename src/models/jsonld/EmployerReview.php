 ...
 * EmployerReview - An [[EmployerReview]] is a review of an [[Organization]] regarding its role
 ...
 */
class EmployerReview extends MetaJsonLd implements EmployerReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
	use EmployerReviewTrait;
	use ReviewTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'EmployerReview';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/EmployerReview';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An [[EmployerReview]] is a review of an [[Organization]] regarding its role as an employer, written by a current or former employee of that organization.';
