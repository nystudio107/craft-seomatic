...
class EmployerReview extends MetaJsonLd implements EmployerReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'EmployerReview';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/EmployerReview';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An [[EmployerReview]] is a review of an [[Organization]] regarding its role as an employer, written by a current or former employee of that organization.';
