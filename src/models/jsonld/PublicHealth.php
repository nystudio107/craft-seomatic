 ...
 */
class PublicHealth extends MetaJsonLd implements PublicHealthInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PublicHealth';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PublicHealth';
