 ...
 * PublicHealth - Branch of medicine that pertains to the health services to improve and
 ...
 */
class PublicHealth extends MetaJsonLd implements PublicHealthInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use PublicHealthTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PublicHealth';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PublicHealth';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Branch of medicine that pertains to the health services to improve and protect community health, especially epidemiology, sanitation, immunization, and preventive medicine.';
