 ...
 * EditedOrCroppedContent - Content coded 'edited or cropped content' in a [[MediaReview]], considered
 * in the context of how it was published or shared.  For a [[VideoObject]] to
 * be 'edited or cropped content': The video has been edited or rearranged.
 * This category applies to time edits, including editing multiple videos
 * together to alter the story being told or editing out large portions from a
 * video.  For an [[ImageObject]] to be 'edited or cropped content':
 ...
 * content': Presenting a part of an image from a larger whole to mislead the
 * viewer.  For an [[AudioObject]] to be 'edited or cropped content': The
 * audio has been edited or rearranged. This category applies to time edits,
 * including editing multiple audio clips together to alter the story being
 ...
 */
class EditedOrCroppedContent extends MetaJsonLd implements EditedOrCroppedContentInterface, MediaManipulationRatingEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use EditedOrCroppedContentTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EditedOrCroppedContent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EditedOrCroppedContent';
