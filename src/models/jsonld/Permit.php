...
class Permit extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Permit';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Permit';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A permit issued by an organization, e.g. a parking pass.';
