...
class Permit extends MetaJsonLd implements PermitInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Permit';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Permit';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A permit issued by an organization, e.g. a parking pass.';
