...
class BodyOfWater extends Landform
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BodyOfWater';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BodyOfWater';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A body of water, such as a sea, ocean, or lake.';
