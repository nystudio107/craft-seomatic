...
class BodyOfWater extends Landform
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BodyOfWater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BodyOfWater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A body of water, such as a sea, ocean, or lake.';
