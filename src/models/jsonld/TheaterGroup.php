 ...
 * TheaterGroup - A theater group or company, for example, the Royal Shakespeare Company or
 * Druid Theatre.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class TheaterGroup extends MetaJsonLd implements TheaterGroupInterface, PerformingGroupInterface, OrganizationInterface, ThingInterface
{
	use TheaterGroupTrait;
