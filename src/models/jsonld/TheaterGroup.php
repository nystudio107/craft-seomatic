...
/**
 * TheaterGroup - A theater group or company, for example, the Royal
...
class TheaterGroup extends PerformingGroup
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TheaterGroup';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TheaterGroup';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A theater group or company, for example, the Royal Shakespeare Company or Druid Theatre.';
