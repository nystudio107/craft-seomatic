 ...
 * MedicalRiskFactor - A risk factor is anything that increases a person's likelihood of
 ...
 */
class MedicalRiskFactor extends MetaJsonLd implements MedicalRiskFactorInterface, MedicalEntityInterface, ThingInterface
{
    use MedicalRiskFactorTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MedicalRiskFactor';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MedicalRiskFactor';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A risk factor is anything that increases a person\'s likelihood of developing or contracting a disease, medical condition, or complication.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'increasesRiskOf' => ['array', 'MedicalEntity', 'MedicalEntity[]'],
