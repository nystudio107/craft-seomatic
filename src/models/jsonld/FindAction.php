...
/**
 * FindAction - TThe act of finding an object. Related actions: SearchAction:
...
class FindAction extends Action
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'FindAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/FindAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'TThe act of finding an object. Related actions: SearchAction: FindAction is generally lead by a SearchAction, but not necessarily.';
