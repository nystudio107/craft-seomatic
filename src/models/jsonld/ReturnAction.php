 ...
 * ReturnAction - The act of returning to the origin that which was previously received
 ...
 */
class ReturnAction extends MetaJsonLd implements ReturnActionInterface, TransferActionInterface, ActionInterface, ThingInterface
{
    use ReturnActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ReturnAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ReturnAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of returning to the origin that which was previously received (concrete objects) or taken (ownership).';
