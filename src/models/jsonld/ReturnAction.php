...
class ReturnAction extends MetaJsonLd implements ReturnActionInterface, TransferActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'ReturnAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/ReturnAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of returning to the origin that which was previously received (concrete objects) or taken (ownership).';
