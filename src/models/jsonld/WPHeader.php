 ...
 */
class WPHeader extends MetaJsonLd implements WPHeaderInterface, WebPageElementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WPHeader';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WPHeader';
