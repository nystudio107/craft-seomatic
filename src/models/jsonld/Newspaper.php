 ...
 */
class Newspaper extends MetaJsonLd implements NewspaperInterface, PeriodicalInterface, CreativeWorkSeriesInterface, SeriesInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
    use NewspaperTrait;
    use PeriodicalTrait;
