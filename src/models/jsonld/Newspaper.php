 ...
 * Newspaper - A publication containing information about varied topics that are pertinent
 ...
 */
class Newspaper extends MetaJsonLd implements NewspaperInterface, PeriodicalInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Newspaper';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Newspaper';
