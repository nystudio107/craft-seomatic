 ...
 * HyperTocEntry - A HyperToEntry is an item within a [[HyperToc]], which represents a
 ...
 */
class HyperTocEntry extends MetaJsonLd implements HyperTocEntryInterface, CreativeWorkInterface, ThingInterface
{
    use HyperTocEntryTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'HyperTocEntry';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/HyperTocEntry';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'tocContinuation' => ['array', 'HyperTocEntry', 'HyperTocEntry[]'],
