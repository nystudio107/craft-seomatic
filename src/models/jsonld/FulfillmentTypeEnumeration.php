...
class FulfillmentTypeEnumeration extends MetaJsonLd implements FulfillmentTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'FulfillmentTypeEnumeration';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/FulfillmentTypeEnumeration';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A type of product fulfillment.';
