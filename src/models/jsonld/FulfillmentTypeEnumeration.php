 ...
 * FulfillmentTypeEnumeration - A type of product fulfillment.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/FulfillmentTypeEnumeration
 */
class FulfillmentTypeEnumeration extends MetaJsonLd implements FulfillmentTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FulfillmentTypeEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FulfillmentTypeEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A type of product fulfillment.';
