...
class SearchResultsPage extends WebPage
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SearchResultsPage';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SearchResultsPage';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Web page type: Search results page.';
