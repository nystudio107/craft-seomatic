 ...
 */
class SearchResultsPage extends MetaJsonLd implements SearchResultsPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
    use SearchResultsPageTrait;
    use WebPageTrait;
