...
class PerformAction extends MetaJsonLd implements PerformActionInterface, PlayActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PerformAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PerformAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PlayAction';
