 ...
 */
class PerformAction extends MetaJsonLd implements PerformActionInterface, PlayActionInterface, ActionInterface, ThingInterface
{
    use PerformActionTrait;
    use PlayActionTrait;
    use ActionTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static $schemaTypeName = 'PerformAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/PerformAction';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'PlayAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of participating in performance arts.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'entertainmentBusiness' => ['array', 'EntertainmentBusiness', 'EntertainmentBusiness[]'],
