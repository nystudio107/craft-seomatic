...
class Map extends MetaJsonLd implements MapInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Map';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Map';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A map.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'mapType' => ['array', 'MapCategoryType', 'MapCategoryType[]'],
