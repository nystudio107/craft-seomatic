...
class ImageObjectSnapshot extends MetaJsonLd implements ImageObjectSnapshotInterface, ImageObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ImageObjectSnapshot';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ImageObjectSnapshot';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'ImageObject';
