 ...
 * ImageObjectSnapshot - A specific and exact (byte-for-byte) version of an [[ImageObject]]. Two
 ...
 * files will differ. Different external facts about the files, e.g. creator
 * or dateCreated that aren't represented in their actual content, do not
 ...
 */
class ImageObjectSnapshot extends MetaJsonLd implements ImageObjectSnapshotInterface, ImageObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
	use ImageObjectSnapshotTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ImageObjectSnapshot';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ImageObjectSnapshot';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A specific and exact (byte-for-byte) version of an [[ImageObject]]. Two byte-for-byte identical files, for the purposes of this type, considered identical. If they have different embedded metadata (e.g. XMP, EXIF) the files will differ. Different external facts about the files, e.g. creator or dateCreated that aren\'t represented in their actual content, do not affect this notion of identity.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'exifData' => ['array', 'PropertyValue', 'PropertyValue[]', 'array', 'Text', 'Text[]'],
		    ...
		    'representativeOfPage' => ['array', 'Boolean', 'Boolean[]'],
