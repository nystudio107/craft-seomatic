 ...
 */
class Festival extends MetaJsonLd implements FestivalInterface, EventInterface, ThingInterface
{
	use FestivalTrait;
	use EventTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Festival';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Festival';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Event type: Festival.';
