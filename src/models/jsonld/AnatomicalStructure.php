 ...
 */
class AnatomicalStructure extends MetaJsonLd implements AnatomicalStructureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'AnatomicalStructure';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/AnatomicalStructure';
