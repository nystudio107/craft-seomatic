 ...
 * Credential - A credential is a certificate that is used to verify the identity of a
 * person or entity.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Credential extends MetaJsonLd implements CredentialInterface, CreativeWorkInterface, ThingInterface
{
	use CredentialTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Credential';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Credential';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A credential is a certificate that is used to verify the identity of a person or entity.';
