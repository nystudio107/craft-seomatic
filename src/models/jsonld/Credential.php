...
class Credential extends MetaJsonLd implements CredentialInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Credential';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Credential';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A credential is a certificate that is used to verify the identity of a person or entity.';
