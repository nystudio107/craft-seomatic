...
class PET extends MetaJsonLd implements PETInterface, MedicalImagingTechniqueInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PET';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PET';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Positron emission tomography imaging.';
