 ...
 */
class WearAction extends MetaJsonLd implements WearActionInterface, UseActionInterface, ConsumeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WearAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WearAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'UseAction';
