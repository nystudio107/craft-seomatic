...
use nystudio107\seomatic\models\jsonld\UseAction;
...
class WearAction extends UseAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'WearAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/WearAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of dressing oneself in clothing.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'UseAction';
