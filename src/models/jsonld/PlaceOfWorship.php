...
class PlaceOfWorship extends CivicStructure
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PlaceOfWorship';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PlaceOfWorship';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Place of worship, such as a church, synagogue, or mosque.';
