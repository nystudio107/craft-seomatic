 ...
 * TravelAction - The act of traveling from an fromLocation to a destination by a specified
 ...
 */
class TravelAction extends MetaJsonLd implements TravelActionInterface, MoveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TravelAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TravelAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MoveAction';
