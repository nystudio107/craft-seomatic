 ...
 * WesternConventional - The conventional Western system of medicine, that aims to apply the best
 ...
 */
class WesternConventional extends MetaJsonLd implements WesternConventionalInterface, MedicineSystemInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WesternConventional';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WesternConventional';
