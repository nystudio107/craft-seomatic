...
use nystudio107\seomatic\models\jsonld\CriticReview;

/**
 * ReviewNewsArticle - A NewsArticle and CriticReview providing a professional
 * critic's assessment of a service, product, performance, or artistic or
 * literary work.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/ReviewNewsArticle
 */
class ReviewNewsArticle extends CriticReview
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A NewsArticle and CriticReview providing a professional critic\'s assessment of a service, product, performance, or artistic or literary work.';
