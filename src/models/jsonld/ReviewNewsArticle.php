 ...
 */
class ReviewNewsArticle extends MetaJsonLd implements ReviewNewsArticleInterface, CriticReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface, NewsArticleInterface, ArticleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ReviewNewsArticle';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ReviewNewsArticle';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'CriticReview';
