 ...
 * BodyMeasurementHand - Maximum hand girth (measured over the knuckles of the open right hand
 ...
 */
class BodyMeasurementHand extends MetaJsonLd implements BodyMeasurementHandInterface, BodyMeasurementTypeEnumerationInterface, MeasurementTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BodyMeasurementHand';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BodyMeasurementHand';
