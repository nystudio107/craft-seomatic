 ...
 * PlanAction - The act of planning the execution of an event/task/action/reservation/plan
 * to a future date.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class PlanAction extends MetaJsonLd implements PlanActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PlanAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PlanAction';
