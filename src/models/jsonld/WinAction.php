 ...
 */
class WinAction extends MetaJsonLd implements WinActionInterface, AchieveActionInterface, ActionInterface, ThingInterface
{
    use WinActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WinAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WinAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of achieving victory in a competitive activity.';
