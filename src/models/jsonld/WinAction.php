...
class WinAction extends MetaJsonLd implements WinActionInterface, AchieveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'WinAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/WinAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of achieving victory in a competitive activity.';
