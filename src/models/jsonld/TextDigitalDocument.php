 ...
 */
class TextDigitalDocument extends MetaJsonLd implements TextDigitalDocumentInterface, DigitalDocumentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TextDigitalDocument';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TextDigitalDocument';
