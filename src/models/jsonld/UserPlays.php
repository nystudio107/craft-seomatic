 ...
 * UserPlays - UserInteraction and its subtypes is an old way of talking about users
...
class UserPlays extends MetaJsonLd implements UserPlaysInterface, UserInteractionInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UserPlays';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UserPlays';
