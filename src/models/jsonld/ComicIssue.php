 ...
 * ComicIssue - Individual comic issues are serially published as     	part of a larger
 ...
 */
class ComicIssue extends MetaJsonLd implements ComicIssueInterface, PublicationIssueInterface, CreativeWorkInterface, ThingInterface
{
    use ComicIssueTrait;
