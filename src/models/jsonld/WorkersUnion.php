...
/**
 * WorkersUnion - A Workers Union (also known as a Labor Union, Labour Union,
 * or Trade Union) is an organization that promotes the interests of its
 * worker members by collectively bargaining with management, organizing, and
 * political lobbying.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class WorkersUnion extends Organization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'WorkersUnion';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A Workers Union (also known as a Labor Union, Labour Union, or Trade Union) is an organization that promotes the interests of its worker members by collectively bargaining with management, organizing, and political lobbying.';
