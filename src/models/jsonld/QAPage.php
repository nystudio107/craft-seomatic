...
class QAPage extends WebPage
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'QAPage';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/QAPage';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A QAPage is a WebPage focussed on a specific Question and its Answer(s), e.g. in a question answering site or documenting Frequently Asked Questions (FAQs).';
