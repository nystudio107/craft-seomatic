 ...
 */
class HinduTemple extends MetaJsonLd implements HinduTempleInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use HinduTempleTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'HinduTemple';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/HinduTemple';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A Hindu temple.';
