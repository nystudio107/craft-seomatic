 ...
 */
class HowToStep extends MetaJsonLd implements HowToStepInterface, ListItemInterface, IntangibleInterface, ThingInterface, ItemListInterface, CreativeWorkInterface
{
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'item' => ['Thing'],
            'itemListElement' => ['Thing', 'ListItem', 'Text'],
