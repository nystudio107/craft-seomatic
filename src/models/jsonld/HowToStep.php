...
/**
 * HowToStep - A step in the instructions for how to achieve a result. It is
 * an ordered list with HowToDirection and/or HowToTip items.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class HowToStep extends ItemList
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HowToStep';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/HowToStep';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A step in the instructions for how to achieve a result. It is an ordered list with HowToDirection and/or HowToTip items.';
