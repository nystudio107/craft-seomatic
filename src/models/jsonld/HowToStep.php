 ...
 * HowToStep - A step in the instructions for how to achieve a result. It is an ordered
 ...
 */
class HowToStep extends MetaJsonLd implements HowToStepInterface, CreativeWorkInterface, ThingInterface, ItemListInterface, IntangibleInterface, ListItemInterface
{
	use HowToStepTrait;
