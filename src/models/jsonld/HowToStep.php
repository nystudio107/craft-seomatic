 ...
 */
class HowToStep extends MetaJsonLd implements HowToStepInterface, ItemListInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface, ListItemInterface
{
	use HowToStepTrait;
	use ItemListTrait;
	use IntangibleTrait;
