 ...
 */
class HowToStep extends MetaJsonLd implements HowToStepInterface, CreativeWorkInterface, ThingInterface, ListItemInterface, IntangibleInterface, ItemListInterface
{
    use HowToStepTrait;
