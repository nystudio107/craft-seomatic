 ...
 */
class BuddhistTemple extends MetaJsonLd implements BuddhistTempleInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use BuddhistTempleTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BuddhistTemple';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BuddhistTemple';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A Buddhist temple.';
