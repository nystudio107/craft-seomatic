...
class BuddhistTemple extends MetaJsonLd implements BuddhistTempleInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'BuddhistTemple';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/BuddhistTemple';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A Buddhist temple.';
