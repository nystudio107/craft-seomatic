 ...
 * UserInteraction - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserInteraction extends MetaJsonLd implements UserInteractionInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'UserInteraction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/UserInteraction';
