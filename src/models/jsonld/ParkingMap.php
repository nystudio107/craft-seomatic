...
class ParkingMap extends MetaJsonLd implements ParkingMapInterface, MapCategoryTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ParkingMap';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ParkingMap';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A parking map.';
