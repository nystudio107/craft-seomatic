 ...
 * OrganizeAction - The act of manipulating/administering/supervising/controlling one or more
 * objects.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class OrganizeAction extends MetaJsonLd implements OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'OrganizeAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/OrganizeAction';
