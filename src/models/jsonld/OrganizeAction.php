...
class OrganizeAction extends Action
{
     ...
     * @var string
     */
    static $schemaTypeName = 'OrganizeAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/OrganizeAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of manipulating/administering/supervising/controlling one or more objects.';
