...
class GameServer extends MetaJsonLd implements GameServerInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'GameServer';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/GameServer';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Server that provides game interaction in a multiplayer game.';
