 ...
 */
class GroceryStore extends MetaJsonLd implements GroceryStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use GroceryStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'GroceryStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/GroceryStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A grocery store.';
