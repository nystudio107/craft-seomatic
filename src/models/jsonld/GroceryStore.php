...
class GroceryStore extends MetaJsonLd implements GroceryStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'GroceryStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/GroceryStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A grocery store.';
