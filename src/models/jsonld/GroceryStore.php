 ...
 */
class GroceryStore extends MetaJsonLd implements GroceryStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
