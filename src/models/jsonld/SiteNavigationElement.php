 ...
 */
class SiteNavigationElement extends MetaJsonLd implements SiteNavigationElementInterface, WebPageElementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SiteNavigationElement';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SiteNavigationElement';
...
SCHEMADESC;
    ...
    use SiteNavigationElementTrait;
