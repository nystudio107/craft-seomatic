...
class SiteNavigationElement extends WebPageElement
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SiteNavigationElement';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SiteNavigationElement';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A navigation element of the page.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'WebPageElement';
