 ...
 */
class BodyMeasurementWeight extends MetaJsonLd implements BodyMeasurementWeightInterface, BodyMeasurementTypeEnumerationInterface, MeasurementTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BodyMeasurementWeight';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BodyMeasurementWeight';
...
SCHEMADESC;
    ...
    use BodyMeasurementWeightTrait;
