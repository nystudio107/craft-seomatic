 ...
 * AssignAction - The act of allocating an action/event/task to some destination (someone or
 * something).
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class AssignAction extends MetaJsonLd implements AssignActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AssignAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/AssignAction';
