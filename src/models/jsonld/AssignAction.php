...
class AssignAction extends AllocateAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AssignAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AssignAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of allocating an action/event/task to some destination (someone or something).';
