...
/**
 * AssignAction - The act of allocating an action/event/task to some
 * destination (someone or something).
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class AssignAction extends AllocateAction
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of allocating an action/event/task to some destination (someone or something).';
