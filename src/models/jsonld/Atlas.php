 ...
 * Atlas - A collection or bound volume of maps, charts, plates or tables, physical or
 ...
 */
class Atlas extends MetaJsonLd implements AtlasInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Atlas';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Atlas';
