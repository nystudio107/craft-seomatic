...
/**
 * Atlas - A collection or bound volume of maps, charts, plates or tables,
 * physical or in media form illustrating any subject.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/Atlas
 */
class Atlas extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Atlas';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Atlas';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A collection or bound volume of maps, charts, plates or tables, physical or in media form illustrating any subject.';
