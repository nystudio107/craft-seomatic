 ...
 */
class Courthouse extends MetaJsonLd implements CourthouseInterface, GovernmentBuildingInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use CourthouseTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Courthouse';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Courthouse';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A courthouse.';
