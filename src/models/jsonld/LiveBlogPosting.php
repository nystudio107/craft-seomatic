 ...
 * LiveBlogPosting - A [[LiveBlogPosting]] is a [[BlogPosting]] intended to provide a rolling
 ...
 */
class LiveBlogPosting extends MetaJsonLd implements LiveBlogPostingInterface, BlogPostingInterface, SocialMediaPostingInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'coverageEndTime' => ['array', 'DateTime', 'DateTime[]'],
		    'coverageStartTime' => ['array', 'DateTime', 'DateTime[]'],
		    ...
		    'liveBlogUpdate' => ['array', 'BlogPosting', 'BlogPosting[]'],
	...
	{
		return ['coverageEndTime', 'coverageStartTime', 'dateModified', 'image', 'mainEntityOfPage', 'url'];
	}
