...
class LiveBlogPosting extends MetaJsonLd implements LiveBlogPostingInterface, BlogPostingInterface, SocialMediaPostingInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LiveBlogPosting';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LiveBlogPosting';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'BlogPosting';
