...
/**
 * DiagnosticLab - A medical laboratory that offers on-site or off-site
 * diagnostic services.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class DiagnosticLab extends MedicalOrganization
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DiagnosticLab';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DiagnosticLab';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A medical laboratory that offers on-site or off-site diagnostic services.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['availableTest'], 'validateJsonSchema'],
