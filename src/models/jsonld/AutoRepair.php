 ...
 */
class AutoRepair extends MetaJsonLd implements AutoRepairInterface, AutomotiveBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use AutoRepairTrait;
