 ...
 * BookSeries - A series of books. Included books can be indicated with the hasPart
 * property.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class BookSeries extends MetaJsonLd implements BookSeriesInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BookSeries';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BookSeries';
