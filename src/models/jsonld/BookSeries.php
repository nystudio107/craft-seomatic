 ...
 */
class BookSeries extends MetaJsonLd implements BookSeriesInterface, CreativeWorkSeriesInterface, SeriesInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
    use BookSeriesTrait;
