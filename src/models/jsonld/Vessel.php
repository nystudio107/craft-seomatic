...
/**
 * Vessel - A component of the human body circulatory system comprised of an
...
class Vessel extends AnatomicalStructure
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Vessel';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Vessel';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A component of the human body circulatory system comprised of an intricate network of hollow tubes that transport blood throughout the entire body.';
