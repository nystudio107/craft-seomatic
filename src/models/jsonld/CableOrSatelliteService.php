...
/**
 * CableOrSatelliteService - A service which provides access to media
 * programming like TV or radio. Access may be via cable or satellite.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class CableOrSatelliteService extends Service
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CableOrSatelliteService';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/CableOrSatelliteService';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A service which provides access to media programming like TV or radio. Access may be via cable or satellite.';
     ...
     * location, etc.).
     *
     * @var ServiceChannel [schema.org types: ServiceChannel]
     */
