 ...
 */
class CableOrSatelliteService extends MetaJsonLd implements CableOrSatelliteServiceInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CableOrSatelliteService';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CableOrSatelliteService';
...
SCHEMADESC;
    ...
    use CableOrSatelliteServiceTrait;
    use ServiceTrait;
    use IntangibleTrait;
    use ThingTrait;
