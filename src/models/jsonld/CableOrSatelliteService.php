...
class CableOrSatelliteService extends Service
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CableOrSatelliteService';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CableOrSatelliteService';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A service which provides access to media programming like TV or radio. Access may be via cable or satellite.';
