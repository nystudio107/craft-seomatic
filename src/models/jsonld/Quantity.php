...
class Quantity extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Quantity';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Quantity';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Quantities such as distance, time, mass, weight, etc. Particular instances of say Mass are entities like \'3 Kg\' or \'4 milligrams\'.';
