...
/**
 * Quantity - Quantities such as distance, time, mass, weight, etc. Particular
...
class Quantity extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Quantity';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Quantity';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Quantities such as distance, time, mass, weight, etc. Particular instances of say Mass are entities like \'3 Kg\' or \'4 milligrams\'.';
