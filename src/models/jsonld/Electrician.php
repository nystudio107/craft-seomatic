 ...
 */
class Electrician extends MetaJsonLd implements ElectricianInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ElectricianTrait;
