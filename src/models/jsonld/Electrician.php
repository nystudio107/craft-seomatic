 ...
 */
class Electrician extends MetaJsonLd implements ElectricianInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
