...
class FrontWheelDriveConfiguration extends MetaJsonLd implements FrontWheelDriveConfigurationInterface, DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'FrontWheelDriveConfiguration';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/FrontWheelDriveConfiguration';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Front-wheel drive is a transmission layout where the engine drives the front wheels.';
