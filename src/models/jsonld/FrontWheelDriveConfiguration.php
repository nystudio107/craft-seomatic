 ...
 */
class FrontWheelDriveConfiguration extends MetaJsonLd implements FrontWheelDriveConfigurationInterface, DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use FrontWheelDriveConfigurationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FrontWheelDriveConfiguration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FrontWheelDriveConfiguration';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Front-wheel drive is a transmission layout where the engine drives the front wheels.';
