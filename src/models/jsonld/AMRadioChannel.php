 ...
 */
class AMRadioChannel extends MetaJsonLd implements AMRadioChannelInterface, RadioChannelInterface, BroadcastChannelInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'AMRadioChannel';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/AMRadioChannel';
...
SCHEMADESC;
    ...
    use AMRadioChannelTrait;
    use RadioChannelTrait;
