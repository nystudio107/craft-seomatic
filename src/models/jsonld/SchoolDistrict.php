 ...
 * SchoolDistrict - A School District is an administrative area for the administration of
 * schools.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class SchoolDistrict extends MetaJsonLd implements SchoolDistrictInterface, AdministrativeAreaInterface, PlaceInterface, ThingInterface
{
	use SchoolDistrictTrait;
