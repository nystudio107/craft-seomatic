...
use nystudio107\seomatic\models\jsonld\AdministrativeArea;

/**
 * SchoolDistrict - A School District is an administrative area for the
 * administration of schools.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/SchoolDistrict
 */
class SchoolDistrict extends AdministrativeArea
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SchoolDistrict';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/SchoolDistrict';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A School District is an administrative area for the administration of schools.';
