...
class CreditCard extends MetaJsonLd implements CreditCardInterface, PaymentCardInterface, PaymentMethodInterface, EnumerationInterface, IntangibleInterface, ThingInterface, FinancialProductInterface, ServiceInterface, LoanOrCreditInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CreditCard';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CreditCard';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PaymentCard';
