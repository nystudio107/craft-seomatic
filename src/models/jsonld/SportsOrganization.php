 ...
 * SportsOrganization - Represents the collection of all sports organizations, including sports
 ...
 */
class SportsOrganization extends MetaJsonLd implements SportsOrganizationInterface, OrganizationInterface, ThingInterface
{
	use SportsOrganizationTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SportsOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SportsOrganization';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'sport' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
