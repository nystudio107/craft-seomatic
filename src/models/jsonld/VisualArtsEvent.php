...
class VisualArtsEvent extends MetaJsonLd implements VisualArtsEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'VisualArtsEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/VisualArtsEvent';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Event type: Visual arts event.';
