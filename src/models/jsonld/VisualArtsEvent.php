 ...
 */
class VisualArtsEvent extends MetaJsonLd implements VisualArtsEventInterface, EventInterface, ThingInterface
{
    use VisualArtsEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'VisualArtsEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/VisualArtsEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Visual arts event.';
