 ...
 * BodyMeasurementFoot - Foot length (measured between end of the most prominent toe and the most
...
class BodyMeasurementFoot extends MetaJsonLd implements BodyMeasurementFootInterface, BodyMeasurementTypeEnumerationInterface, MeasurementTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BodyMeasurementFoot';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BodyMeasurementFoot';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Foot length (measured between end of the most prominent toe and the most prominent part of the heel). Used, for example, to measure socks.';
