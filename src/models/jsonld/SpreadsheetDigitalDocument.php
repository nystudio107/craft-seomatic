 ...
 */
class SpreadsheetDigitalDocument extends MetaJsonLd implements SpreadsheetDigitalDocumentInterface, DigitalDocumentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SpreadsheetDigitalDocument';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SpreadsheetDigitalDocument';
...
SCHEMADESC;
    ...
    use SpreadsheetDigitalDocumentTrait;
