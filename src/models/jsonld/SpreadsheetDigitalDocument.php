...
class SpreadsheetDigitalDocument extends DigitalDocument
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SpreadsheetDigitalDocument';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SpreadsheetDigitalDocument';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A spreadsheet file.';
