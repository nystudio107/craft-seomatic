 ...
 * LoginAction - The action of logging into a device or application.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/LoginAction
 */
class LoginAction extends MetaJsonLd implements LoginActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'LoginAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/LoginAction';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The action of logging into a device or application.';
