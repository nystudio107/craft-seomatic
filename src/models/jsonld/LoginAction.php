...
class LoginAction extends MetaJsonLd implements LoginActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'LoginAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/LoginAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The action of logging into a device or application.';
