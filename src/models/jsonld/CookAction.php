 ...
 */
class CookAction extends MetaJsonLd implements CookActionInterface, CreateActionInterface, ActionInterface, ThingInterface
{
    use CookActionTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'foodEstablishment' => ['array', 'FoodEstablishment', 'FoodEstablishment[]', 'array', 'Place', 'Place[]'],
            'foodEvent' => ['array', 'FoodEvent', 'FoodEvent[]'],
