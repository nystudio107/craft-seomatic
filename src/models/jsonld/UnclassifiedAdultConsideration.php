 ...
 * UnclassifiedAdultConsideration - The item is suitable only for adults, without indicating why. Due to
 ...
 */
class UnclassifiedAdultConsideration extends MetaJsonLd implements UnclassifiedAdultConsiderationInterface, AdultOrientedEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'UnclassifiedAdultConsideration';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/UnclassifiedAdultConsideration';
...
SCHEMADESC;
    ...
    use UnclassifiedAdultConsiderationTrait;
