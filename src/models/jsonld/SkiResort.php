 ...
 */
class SkiResort extends MetaJsonLd implements SkiResortInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, ResortInterface, LodgingBusinessInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SkiResort';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SkiResort';
