 ...
 */
class SkiResort extends MetaJsonLd implements SkiResortInterface, ResortInterface, LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, SportsActivityLocationInterface
{
	use SkiResortTrait;
	use ResortTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Resort';
