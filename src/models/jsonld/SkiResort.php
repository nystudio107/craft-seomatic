 ...
 */
class SkiResort extends MetaJsonLd implements SkiResortInterface, SportsActivityLocationInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, ResortInterface, LodgingBusinessInterface
{
	use SkiResortTrait;
