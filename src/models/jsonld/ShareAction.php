 ...
 * ShareAction - The act of distributing content to people for their amusement or
 * edification.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class ShareAction extends MetaJsonLd implements ShareActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ShareAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ShareAction';
