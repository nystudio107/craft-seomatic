...
class MonetaryGrant extends MetaJsonLd implements MonetaryGrantInterface, GrantInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MonetaryGrant';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MonetaryGrant';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Grant';
