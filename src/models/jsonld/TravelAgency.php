...
class TravelAgency extends MetaJsonLd implements TravelAgencyInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TravelAgency';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TravelAgency';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A travel agency.';
