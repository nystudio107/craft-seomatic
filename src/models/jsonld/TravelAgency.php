 ...
 */
class TravelAgency extends MetaJsonLd implements TravelAgencyInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use TravelAgencyTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'TravelAgency';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/TravelAgency';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A travel agency.';
