...
class InteractionCounter extends StructuredValue
{
     ...
     * @var string
     */
    static $schemaTypeName = 'InteractionCounter';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/InteractionCounter';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A summary of how users have interacted with this CreativeWork. In most cases, authors will use a subtype to specify the specific type of interaction.';
