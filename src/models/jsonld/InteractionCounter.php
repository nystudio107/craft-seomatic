...
class InteractionCounter extends MetaJsonLd implements InteractionCounterInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'InteractionCounter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/InteractionCounter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A summary of how users have interacted with this CreativeWork. In most cases, authors will use a subtype to specify the specific type of interaction.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'interactionService' => ['array', 'SoftwareApplication', 'SoftwareApplication[]', 'array', 'WebSite', 'WebSite[]'],
		    'interactionType' => ['array', 'Action', 'Action[]'],
		    ...
		    'url' => ['array', 'URL', 'URL[]'],
		    'userInteractionCount' => ['array', 'Integer', 'Integer[]']
		];
	}
