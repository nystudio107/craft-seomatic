 ...
 */
class FurnitureStore extends MetaJsonLd implements FurnitureStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
