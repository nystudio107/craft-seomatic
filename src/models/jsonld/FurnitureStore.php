...
class FurnitureStore extends MetaJsonLd implements FurnitureStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'FurnitureStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/FurnitureStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A furniture store.';
