 ...
 */
class FurnitureStore extends MetaJsonLd implements FurnitureStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use FurnitureStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FurnitureStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FurnitureStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A furniture store.';
