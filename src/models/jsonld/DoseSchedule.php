 ...
 */
class DoseSchedule extends MetaJsonLd implements DoseScheduleInterface, MedicalIntangibleInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DoseSchedule';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DoseSchedule';
