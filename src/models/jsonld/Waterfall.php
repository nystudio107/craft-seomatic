...
class Waterfall extends MetaJsonLd implements WaterfallInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Waterfall';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Waterfall';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A waterfall, like Niagara.';
