 ...
 */
class Waterfall extends MetaJsonLd implements WaterfallInterface, BodyOfWaterInterface, LandformInterface, PlaceInterface, ThingInterface
{
	use WaterfallTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Waterfall';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Waterfall';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A waterfall, like Niagara.';
