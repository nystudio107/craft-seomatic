 ...
 */
class SportingGoodsStore extends MetaJsonLd implements SportingGoodsStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
