 ...
 */
class SportingGoodsStore extends MetaJsonLd implements SportingGoodsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use SportingGoodsStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'SportingGoodsStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/SportingGoodsStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A sporting goods store.';
