...
class SportingGoodsStore extends MetaJsonLd implements SportingGoodsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'SportingGoodsStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/SportingGoodsStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A sporting goods store.';
