...
class TypeAndQuantityNode extends MetaJsonLd implements TypeAndQuantityNodeInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TypeAndQuantityNode';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TypeAndQuantityNode';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A structured value indicating the quantity, unit of measurement, and business function of goods included in a bundle offer.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'amountOfThisGood' => ['array', 'Number', 'Number[]'],
            ...
            'typeOfGood' => ['array', 'Product', 'Product[]', 'array', 'Service', 'Service[]'],
