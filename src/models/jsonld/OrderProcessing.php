 ...
 */
class OrderProcessing extends MetaJsonLd implements OrderProcessingInterface, OrderStatusInterface, StatusEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OrderProcessing';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OrderProcessing';
