...
use nystudio107\seomatic\models\jsonld\VisualArtwork;
...
class CoverArt extends VisualArtwork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CoverArt';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/CoverArt';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The artwork on the outer surface of a CreativeWork.';
     ...
     * @var string
     */
    static public $schemaTypeExtends = 'VisualArtwork';
