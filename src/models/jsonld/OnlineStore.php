...
class OnlineStore extends MetaJsonLd implements OnlineStoreInterface, OnlineBusinessInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'OnlineStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/OnlineStore';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'OnlineBusiness';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An eCommerce site.';
