 ...
 */
class OnlineStore extends MetaJsonLd implements OnlineStoreInterface, OnlineBusinessInterface, OrganizationInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'OnlineStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/OnlineStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'OnlineBusiness';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An eCommerce site.';
