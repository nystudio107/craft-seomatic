...
class OnlineStore extends MetaJsonLd implements OnlineStoreInterface, OnlineBusinessInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OnlineStore';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OnlineStore';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'OnlineBusiness';
