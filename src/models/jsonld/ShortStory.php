 ...
 * ShortStory - Short story or tale. A brief work of literature, usually written in
 * narrative prose.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class ShortStory extends MetaJsonLd implements ShortStoryInterface, CreativeWorkInterface, ThingInterface
{
    use ShortStoryTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ShortStory';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ShortStory';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Short story or tale. A brief work of literature, usually written in narrative prose.';
