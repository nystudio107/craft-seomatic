 ...
 */
class TVEpisode extends MetaJsonLd implements TVEpisodeInterface, EpisodeInterface, CreativeWorkInterface, ThingInterface
{
	use TVEpisodeTrait;
	use EpisodeTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TVEpisode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TVEpisode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A TV episode which can be part of a series or season.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'episodeNumber' => ['array', 'Integer', 'Integer[]', 'array', 'Text', 'Text[]'],
		    ...
		    'partOfSeason' => ['array', 'CreativeWorkSeason', 'CreativeWorkSeason[]'],
		    'partOfSeries' => ['array', 'CreativeWorkSeries', 'CreativeWorkSeries[]'],
		    'partOfTVSeries' => ['array', 'TVSeries', 'TVSeries[]'],
