...
class TVEpisode extends Episode
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TVEpisode';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TVEpisode';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A TV episode which can be part of a series or season.';
