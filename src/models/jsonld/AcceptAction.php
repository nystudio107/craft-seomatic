...
class AcceptAction extends MetaJsonLd implements AcceptActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AcceptAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AcceptAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of committing to/adopting an object.\n\nRelated actions:\n\n* [[RejectAction]]: The antonym of AcceptAction.';
