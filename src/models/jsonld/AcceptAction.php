...
class AcceptAction extends MetaJsonLd implements AcceptActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AcceptAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AcceptAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of committing to/adopting an object.\n\nRelated actions:\n\n* [[RejectAction]]: The antonym of AcceptAction.';
