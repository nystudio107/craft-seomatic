 ...
 * ReservationPending - The status of a reservation when a request has been sent, but not
 * confirmed.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ReservationPending extends MetaJsonLd implements ReservationPendingInterface, ReservationStatusTypeInterface, StatusEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ReservationPending';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ReservationPending';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The status of a reservation when a request has been sent, but not confirmed.';
