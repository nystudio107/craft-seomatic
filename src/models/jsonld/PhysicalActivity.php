 ...
 */
class PhysicalActivity extends MetaJsonLd implements PhysicalActivityInterface, LifestyleModificationInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PhysicalActivity';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PhysicalActivity';
