 ...
 * LegislationObject - A specific object or file containing a Legislation. Note that the same
 ...
 */
class LegislationObject extends MetaJsonLd implements LegislationObjectInterface, LegislationInterface, CreativeWorkInterface, ThingInterface, MediaObjectInterface
{
	use LegislationObjectTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'LegislationObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/LegislationObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Legislation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A specific object or file containing a Legislation. Note that the same Legislation can be published in multiple files. For example, a digitally signed PDF, a plain PDF and an HTML version.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'associatedArticle' => ['array', 'NewsArticle', 'NewsArticle[]'],
		    ...
		    'contentSize' => ['array', 'Text', 'Text[]'],
		    'contentUrl' => ['array', 'URL', 'URL[]'],
		    ...
		    'embedUrl' => ['array', 'URL', 'URL[]'],
		    'encodesCreativeWork' => ['array', 'CreativeWork', 'CreativeWork[]'],
		    ...
		    'ineligibleRegion' => ['array', 'GeoShape', 'GeoShape[]', 'array', 'Place', 'Place[]', 'array', 'Text', 'Text[]'],
		    ...
		    'jurisdiction' => ['array', 'AdministrativeArea', 'AdministrativeArea[]', 'array', 'Text', 'Text[]'],
		    ...
		    'legislationAmends' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationApplies' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationChanges' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationCommences' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationConsolidates' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationCorrects' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationCountersignedBy' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'legislationDate' => ['array', 'Date', 'Date[]'],
		    'legislationDateOfApplicability' => ['array', 'Date', 'Date[]'],
		    'legislationDateVersion' => ['array', 'Date', 'Date[]'],
		    'legislationEnsuresImplementationOf' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationIdentifier' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
		    'legislationJurisdiction' => ['array', 'AdministrativeArea', 'AdministrativeArea[]', 'array', 'Text', 'Text[]'],
		    'legislationLegalForce' => ['array', 'LegalForceStatus', 'LegalForceStatus[]'],
		    'legislationLegalValue' => ['array', 'LegalValueLevel', 'LegalValueLevel[]'],
		    'legislationPassedBy' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'legislationRepeals' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationResponsible' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
		    'legislationTransposes' => ['array', 'Legislation', 'Legislation[]'],
		    'legislationType' => ['array', 'CategoryCode', 'CategoryCode[]', 'array', 'Text', 'Text[]'],
		    ...
		    'regionsAllowed' => ['array', 'Place', 'Place[]'],
		    'releasedEvent' => ['array', 'PublicationEvent', 'PublicationEvent[]'],
		    'requiresSubscription' => ['array', 'Boolean', 'Boolean[]', 'array', 'MediaSubscription', 'MediaSubscription[]'],
		    ...
		    'uploadDate' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]'],
		    'url' => ['array', 'URL', 'URL[]'],
