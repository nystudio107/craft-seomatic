 ...
 */
class ParentalSupport extends MetaJsonLd implements ParentalSupportInterface, GovernmentBenefitsTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ParentalSupport';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ParentalSupport';
