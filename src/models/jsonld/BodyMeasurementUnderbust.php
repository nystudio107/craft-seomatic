 ...
 * BodyMeasurementUnderbust - Girth of body just below the bust. Used, for example, to fit women's
 * swimwear.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class BodyMeasurementUnderbust extends MetaJsonLd implements BodyMeasurementUnderbustInterface, BodyMeasurementTypeEnumerationInterface, MeasurementTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BodyMeasurementUnderbust';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BodyMeasurementUnderbust';
