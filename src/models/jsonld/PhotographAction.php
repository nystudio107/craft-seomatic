...
class PhotographAction extends MetaJsonLd implements PhotographActionInterface, CreateActionInterface, ActionInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'PhotographAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/PhotographAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'The act of capturing still images of objects using a camera.';
