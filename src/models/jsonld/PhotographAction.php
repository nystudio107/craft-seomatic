 ...
 */
class PhotographAction extends MetaJsonLd implements PhotographActionInterface, CreateActionInterface, ActionInterface, ThingInterface
{
    use PhotographActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PhotographAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PhotographAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of capturing still images of objects using a camera.';
