...
/**
 * PhotographAction - The act of capturing still images of objects using a
 * camera.
...
class PhotographAction extends CreateAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PhotographAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PhotographAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of capturing still images of objects using a camera.';
