 ...
 */
class BlogPosting extends MetaJsonLd implements BlogPostingInterface, SocialMediaPostingInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BlogPosting';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BlogPosting';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A blog post.';
