 ...
 */
class JewelryStore extends MetaJsonLd implements JewelryStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use JewelryStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'JewelryStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/JewelryStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A jewelry store.';
