...
class JewelryStore extends MetaJsonLd implements JewelryStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'JewelryStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/JewelryStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A jewelry store.';
