 ...
 */
class Lung extends MetaJsonLd implements LungInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Lung';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Lung';
