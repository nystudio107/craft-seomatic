...
class RealEstateAgent extends MetaJsonLd implements RealEstateAgentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'RealEstateAgent';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/RealEstateAgent';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A real-estate agent.';
