 ...
 */
class RealEstateAgent extends MetaJsonLd implements RealEstateAgentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
