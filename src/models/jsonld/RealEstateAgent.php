 ...
 */
class RealEstateAgent extends MetaJsonLd implements RealEstateAgentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use RealEstateAgentTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RealEstateAgent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RealEstateAgent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A real-estate agent.';
