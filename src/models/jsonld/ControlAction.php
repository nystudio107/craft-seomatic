...
class ControlAction extends MetaJsonLd implements ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'ControlAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/ControlAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An agent controls a device or application.';
