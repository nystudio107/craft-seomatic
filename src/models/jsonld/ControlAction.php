 ...
 */
class ControlAction extends MetaJsonLd implements ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ControlAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ControlAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An agent controls a device or application.';
