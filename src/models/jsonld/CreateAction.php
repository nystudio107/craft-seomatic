 ...
 * CreateAction - The act of deliberately creating/producing/generating/building a result out
 * of the agent.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class CreateAction extends MetaJsonLd implements CreateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CreateAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CreateAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of deliberately creating/producing/generating/building a result out of the agent.';
