...
/**
 * CreateAction - The act of deliberately
...
class CreateAction extends Action
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CreateAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CreateAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of deliberately creating/producing/generating/building a result out of the agent.';
