 ...
 * HowToTip - An explanation in the instructions for how to achieve a result. It provides
 ...
 */
class HowToTip extends MetaJsonLd implements HowToTipInterface, ListItemInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
	use HowToTipTrait;
	use ListItemTrait;
	use IntangibleTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'HowToTip';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/HowToTip';
