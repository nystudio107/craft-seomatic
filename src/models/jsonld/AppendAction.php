...
class AppendAction extends MetaJsonLd implements AppendActionInterface, InsertActionInterface, AddActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AppendAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AppendAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of inserting at the end if an ordered collection.';
