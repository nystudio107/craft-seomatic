 ...
 */
class AppendAction extends MetaJsonLd implements AppendActionInterface, InsertActionInterface, AddActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
    use AppendActionTrait;
    use InsertActionTrait;
    use AddActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AppendAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AppendAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of inserting at the end if an ordered collection.';
