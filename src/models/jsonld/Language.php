 ...
 * Formal language code tags expressed in BCP 47 can be used via the
...
class Language extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Language';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Language';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Natural languages such as Spanish, Tamil, Hindi, English, etc. Formal language code tags expressed in BCP 47 can be used via the alternateName property. The Language type previously also covered programming languages such as Scheme and Lisp, which are now best represented using ComputerLanguage.';
