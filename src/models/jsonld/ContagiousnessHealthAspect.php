 ...
 * ContagiousnessHealthAspect - Content about contagion mechanisms and contagiousness information over the
 * topic.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ContagiousnessHealthAspect extends MetaJsonLd implements ContagiousnessHealthAspectInterface, HealthAspectEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ContagiousnessHealthAspect';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ContagiousnessHealthAspect';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Content about contagion mechanisms and contagiousness information over the topic.';
