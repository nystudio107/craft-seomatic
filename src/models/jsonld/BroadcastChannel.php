...
class BroadcastChannel extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BroadcastChannel';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BroadcastChannel';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A unique instance of a BroadcastService on a CableOrSatelliteService lineup.';
