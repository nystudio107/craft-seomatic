...
class BroadcastChannel extends MetaJsonLd implements BroadcastChannelInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BroadcastChannel';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BroadcastChannel';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A unique instance of a BroadcastService on a CableOrSatelliteService lineup.';
