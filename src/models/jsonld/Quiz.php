 ...
 */
class Quiz extends MetaJsonLd implements QuizInterface, LearningResourceInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Quiz';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Quiz';
     ...
     * @var string
     */
    static public $schemaTypeExtends = 'LearningResource';
