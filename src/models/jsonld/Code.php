 ...
 * Code - Computer programming source code. Example: Full (compile ready) solutions,
 ...
 */
class Code extends MetaJsonLd implements CodeInterface, CreativeWorkInterface, ThingInterface
{
    use CodeTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Code';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Code';
