...
class WebApplication extends MetaJsonLd implements WebApplicationInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'WebApplication';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/WebApplication';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Web applications.';
