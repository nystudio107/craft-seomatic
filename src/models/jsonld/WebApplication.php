 ...
 */
class WebApplication extends MetaJsonLd implements WebApplicationInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WebApplication';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WebApplication';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Web applications.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'browserRequirements' => ['array', 'Text', 'Text[]'],
