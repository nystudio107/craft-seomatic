 ...
 */
class MovieClip extends MetaJsonLd implements MovieClipInterface, ClipInterface, CreativeWorkInterface, ThingInterface
{
    use MovieClipTrait;
    use ClipTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MovieClip';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MovieClip';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A short segment/part of a movie.';
