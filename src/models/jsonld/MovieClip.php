...
class MovieClip extends MetaJsonLd implements MovieClipInterface, ClipInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MovieClip';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MovieClip';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A short segment/part of a movie.';
