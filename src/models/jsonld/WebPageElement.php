 ...
 */
class WebPageElement extends MetaJsonLd implements WebPageElementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'WebPageElement';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/WebPageElement';
