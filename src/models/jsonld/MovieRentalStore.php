...
class MovieRentalStore extends MetaJsonLd implements MovieRentalStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MovieRentalStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MovieRentalStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A movie rental store.';
