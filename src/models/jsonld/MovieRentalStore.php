 ...
 */
class MovieRentalStore extends MetaJsonLd implements MovieRentalStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
