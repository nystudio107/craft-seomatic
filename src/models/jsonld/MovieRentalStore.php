 ...
 */
class MovieRentalStore extends MetaJsonLd implements MovieRentalStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MovieRentalStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MovieRentalStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MovieRentalStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A movie rental store.';
