 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/InForce
 */
class InForce extends LegalForceStatus
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'InForce';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Indicates that a legislation is in force.';
