 ...
 */
class BikeStore extends MetaJsonLd implements BikeStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use BikeStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BikeStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BikeStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A bike store.';
