 ...
 * EUEnergyEfficiencyEnumeration - Enumerates the EU energy efficiency classes A-G as well as A+, A++, and
...
class EUEnergyEfficiencyEnumeration extends MetaJsonLd implements EUEnergyEfficiencyEnumerationInterface, EnergyEfficiencyEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EUEnergyEfficiencyEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EUEnergyEfficiencyEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Enumerates the EU energy efficiency classes A-G as well as A+, A++, and A+++ as defined in EU directive 2017/1369.';
