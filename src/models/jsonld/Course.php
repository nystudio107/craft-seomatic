 ...
 */
class Course extends MetaJsonLd implements CourseInterface, LearningResourceInterface, CreativeWorkInterface, ThingInterface
{
    use CourseTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Course';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Course';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A description of an educational course which may be offered as distinct instances which take place at different times or take place at different locations, or be offered through different media or modes of study. An educational course is a sequence of one or more educational events and/or creative works which aims to build knowledge, competence or ability of learners.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'courseCode' => ['array', 'Text', 'Text[]'],
            'coursePrerequisites' => ['array', 'Course', 'Course[]', 'array', 'AlignmentObject', 'AlignmentObject[]', 'array', 'Text', 'Text[]'],
            ...
            'hasCourseInstance' => ['array', 'CourseInstance', 'CourseInstance[]'],
            ...
            'syllabusSections' => ['array', 'Syllabus', 'Syllabus[]'],
            ...
            'totalHistoricalEnrollment' => ['array', 'Integer', 'Integer[]'],
