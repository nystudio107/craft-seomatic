 ...
 */
class Course extends MetaJsonLd implements CourseInterface, CreativeWorkInterface, ThingInterface, LearningResourceInterface
{
    use CourseTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'coursePrerequisites' => ['array', 'AlignmentObject', 'AlignmentObject[]', 'array', 'Course', 'Course[]', 'array', 'Text', 'Text[]'],
