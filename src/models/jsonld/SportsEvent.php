...
class SportsEvent extends MetaJsonLd implements SportsEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SportsEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SportsEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Event type: Sports event.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'awayTeam' => ['array', 'Person', 'Person[]', 'array', 'SportsTeam', 'SportsTeam[]'],
		    'competitor' => ['array', 'Person', 'Person[]', 'array', 'SportsTeam', 'SportsTeam[]'],
		    ...
		    'homeTeam' => ['array', 'Person', 'Person[]', 'array', 'SportsTeam', 'SportsTeam[]'],
