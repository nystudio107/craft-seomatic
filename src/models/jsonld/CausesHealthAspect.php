...
/**
 * CausesHealthAspect - Information about the causes and main actions that
 * gave rise to the topic.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/CausesHealthAspect
 */
class CausesHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CausesHealthAspect';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Information about the causes and main actions that gave rise to the topic.';
