 ...
 */
class LandmarksOrHistoricalBuildings extends MetaJsonLd implements LandmarksOrHistoricalBuildingsInterface, PlaceInterface, ThingInterface
{
    use LandmarksOrHistoricalBuildingsTrait;
    use PlaceTrait;
    use ThingTrait;
