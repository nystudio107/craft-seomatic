...
class LandmarksOrHistoricalBuildings extends Place
{
     ...
     * @var string
     */
    static $schemaTypeName = 'LandmarksOrHistoricalBuildings';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/LandmarksOrHistoricalBuildings';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An historical landmark or building.';
