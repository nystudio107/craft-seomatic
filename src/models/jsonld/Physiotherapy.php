 ...
 */
class Physiotherapy extends MetaJsonLd implements PhysiotherapyInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Physiotherapy';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Physiotherapy';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The practice of treatment of disease, injury, or deformity by physical methods such as massage, heat treatment, and exercise rather than by drugs or surgery.';
