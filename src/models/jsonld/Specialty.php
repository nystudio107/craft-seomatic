...
/**
 * Specialty - Any branch of a field in which people typically develop
 * specific expertise, usually after significant study, time, and effort.
 * Extends: Enumeration
...
class Specialty extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Specialty';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Specialty';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Any branch of a field in which people typically develop specific expertise, usually after significant study, time, and effort.';
