 ...
 */
class CovidTestingFacility extends MetaJsonLd implements CovidTestingFacilityInterface, MedicalClinicInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CovidTestingFacility';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CovidTestingFacility';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalClinic';
