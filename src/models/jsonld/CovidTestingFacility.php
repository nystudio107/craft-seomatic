 ...
 * CovidTestingFacility - A CovidTestingFacility is a [[MedicalClinic]] where testing for the
 * COVID-19 Coronavirus       disease is available. If the facility is being
 * made available from an established [[Pharmacy]], [[Hotel]], or other
 * non-medical organization, multiple types can be listed. This makes it
 * easier to re-use existing schema.org information       about that place,
 * e.g. contact info, address, opening hours. Note that in an emergency, such
 ...
 */
class CovidTestingFacility extends MetaJsonLd implements CovidTestingFacilityInterface, MedicalClinicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
    use CovidTestingFacilityTrait;
    use MedicalClinicTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CovidTestingFacility';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CovidTestingFacility';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'MedicalClinic';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "A CovidTestingFacility is a [[MedicalClinic]] where testing for the COVID-19 Coronavirus\n      disease is available. If the facility is being made available from an established [[Pharmacy]], [[Hotel]], or other\n      non-medical organization, multiple types can be listed. This makes it easier to re-use existing schema.org information\n      about that place, e.g. contact info, address, opening hours. Note that in an emergency, such information may not always be reliable.\n      ";
