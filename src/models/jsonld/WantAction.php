...
/**
 * WantAction - The act of expressing a desire about the object. An agent
 * wants an object.
 * Extends: ReactAction
...
class WantAction extends ReactAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'WantAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/WantAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of expressing a desire about the object. An agent wants an object.';
