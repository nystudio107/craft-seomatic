 ...
 * (e.g. starting a timer or turning on a flashlight).
...
class ActivateAction extends ControlAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ActivateAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ActivateAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of starting or activating a device or application (e.g. starting a timer or turning on a flashlight).';
