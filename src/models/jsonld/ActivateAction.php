 ...
 * ActivateAction - The act of starting or activating a device or application (e.g. starting a
 ...
 */
class ActivateAction extends MetaJsonLd implements ActivateActionInterface, ControlActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ActivateAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ActivateAction';
