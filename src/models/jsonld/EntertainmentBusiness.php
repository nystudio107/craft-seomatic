 ...
 */
class EntertainmentBusiness extends MetaJsonLd implements EntertainmentBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
