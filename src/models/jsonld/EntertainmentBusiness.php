...
class EntertainmentBusiness extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'EntertainmentBusiness';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/EntertainmentBusiness';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A business providing entertainment.';
