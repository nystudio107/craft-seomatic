 ...
 */
class NightClub extends MetaJsonLd implements NightClubInterface, EntertainmentBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use NightClubTrait;
