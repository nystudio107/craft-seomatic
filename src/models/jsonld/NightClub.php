...
class NightClub extends MetaJsonLd implements NightClubInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'NightClub';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/NightClub';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A nightclub or discotheque.';
