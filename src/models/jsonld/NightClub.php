 ...
 */
class NightClub extends MetaJsonLd implements NightClubInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use NightClubTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'NightClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/NightClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A nightclub or discotheque.';
