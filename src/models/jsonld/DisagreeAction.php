 ...
 * DisagreeAction - The act of expressing a difference of opinion with the object. An agent
 ...
 */
class DisagreeAction extends MetaJsonLd implements DisagreeActionInterface, ReactActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DisagreeAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DisagreeAction';
