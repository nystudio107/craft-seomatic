 ...
 * OpenTrial - A trial design in which the researcher knows the full details of the
 ...
 */
class OpenTrial extends MetaJsonLd implements OpenTrialInterface, MedicalTrialDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OpenTrial';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OpenTrial';
