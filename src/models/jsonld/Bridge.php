 ...
 */
class Bridge extends MetaJsonLd implements BridgeInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use BridgeTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Bridge';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Bridge';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bridge.';
