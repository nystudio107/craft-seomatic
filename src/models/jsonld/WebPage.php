...
/**
 * WebPage - A web page. Every web page is implicitly assumed to be declared
 * to be of type WebPage, so the various properties about that webpage, such
 * as breadcrumb may be used. We recommend explicit declaration if these
...
class WebPage extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'WebPage';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/WebPage';
