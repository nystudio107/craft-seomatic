 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/SymptomsHealthAspect
 */
class SymptomsHealthAspect extends HealthAspectEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Symptoms or related symptoms of a Topic.';
