 ...
 * HealthcareConsideration - Item is a pharmaceutical (e.g., a prescription or OTC drug) or a restricted
 * medical device.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class HealthcareConsideration extends MetaJsonLd implements HealthcareConsiderationInterface, AdultOrientedEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HealthcareConsideration';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/HealthcareConsideration';
