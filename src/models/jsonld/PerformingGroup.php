...
class PerformingGroup extends Organization
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PerformingGroup';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PerformingGroup';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A performance group, such as a band, an orchestra, or a circus.';
