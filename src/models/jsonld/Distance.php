 ...
 */
class Distance extends MetaJsonLd implements DistanceInterface, QuantityInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Distance';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Distance';
