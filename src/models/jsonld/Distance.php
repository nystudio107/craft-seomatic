...
use nystudio107\seomatic\models\jsonld\Quantity;

/**
 * Distance - Properties that take Distances as values are of the form
...
class Distance extends Quantity
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Distance';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Distance';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Properties that take Distances as values are of the form \'<Number> <Length unit of measure>\'. E.g., \'7 ft\'.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Quantity';
