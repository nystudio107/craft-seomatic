 ...
 * MeetingRoom - A meeting room, conference room, or conference hall is a room provided for
...
class MeetingRoom extends MetaJsonLd implements MeetingRoomInterface, RoomInterface, AccommodationInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MeetingRoom';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MeetingRoom';
