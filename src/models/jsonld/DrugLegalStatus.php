 ...
 */
class DrugLegalStatus extends MetaJsonLd implements DrugLegalStatusInterface, MedicalIntangibleInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DrugLegalStatus';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DrugLegalStatus';
