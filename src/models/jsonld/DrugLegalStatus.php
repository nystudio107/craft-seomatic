...
class DrugLegalStatus extends MedicalIntangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DrugLegalStatus';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The legal availability status of a medical drug.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['applicableLocation'], 'validateJsonSchema'],
