 ...
 * PerformingArtsEvent - Live performance <a class="localLink" href="http://schema.org/Event">Event
 * of the performing arts (music, theatre, dance, acrobatics, spoken word),
 * including performance art and performative sports (e.g. choreographed forms
 * of martial arts, figure skating, competitive ballroom
 * dancing).<br/><br/>Note: Use <a class="localLink"
 * href="http://schema.org/additionalType">additionalType</a> to differentiate
 * between productions / shows (PerformanceWork, EventSeries), tours
 * (EventSeries), and individual performances.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/PerformingArtsEvent
 */
class PerformingArtsEvent extends MetaJsonLd implements PerformingArtsEventInterface, EventInterface, ThingInterface
{
    use PerformingArtsEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PerformingArtsEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PerformingArtsEvent';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'attendee' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'attendees' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'audience' => ['array', 'Audience', 'Audience[]'],
            'composer' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'doorTime' => ['array', 'DateTime', 'DateTime[]', 'array', 'Time', 'Time[]'],
            ...
            'hasParticipationOffer' => ['array', 'Offer', 'Offer[]'],
            'hasSponsorshipOffer' => ['array', 'Offer', 'Offer[]'],
            ...
            'performer' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'performers' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'previousStartDate' => ['array', 'Date', 'Date[]', 'array', 'DateTime', 'DateTime[]'],
    ...
    public function getSchemaPropertyDescriptions(): array
    {
        return [
            ...
            'hasParticipationOffer' => 'An offer to participate in the event, for example, Call for Proposals, Call for Speakers, or Call for Performers.',
            'hasSponsorshipOffer' => 'An offer to sponsor the event, for example, Sponsorship Prospectus, Sponsorship Opportunities, or Sponsor Packages.',
