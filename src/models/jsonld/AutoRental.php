 ...
 */
class AutoRental extends MetaJsonLd implements AutoRentalInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use AutoRentalTrait;
