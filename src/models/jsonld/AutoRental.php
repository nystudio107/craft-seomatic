 ...
 */
class AutoRental extends MetaJsonLd implements AutoRentalInterface, AutomotiveBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use AutoRentalTrait;
