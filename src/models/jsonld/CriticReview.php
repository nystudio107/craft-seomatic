...
class CriticReview extends MetaJsonLd implements CriticReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CriticReview';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CriticReview';
