 ...
 * CriticReview - A [[CriticReview]] is a more specialized form of Review written or
 ...
 */
class CriticReview extends MetaJsonLd implements CriticReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CriticReview';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CriticReview';
