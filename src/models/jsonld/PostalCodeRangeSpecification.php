 ...
 * PostalCodeRangeSpecification - Indicates a range of postalcodes, usually defined as the set of valid codes
...
class PostalCodeRangeSpecification extends MetaJsonLd implements PostalCodeRangeSpecificationInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PostalCodeRangeSpecification';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PostalCodeRangeSpecification';
