...
class ITNonprofitType extends MetaJsonLd implements ITNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ITNonprofitType';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ITNonprofitType';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'ITNonprofitType: Non-profit organization type originating from Italy.';
