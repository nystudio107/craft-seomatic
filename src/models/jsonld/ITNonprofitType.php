 ...
 * ITNonprofitType - ITNonprofitType: Non-profit organization type originating from Italy.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/ITNonprofitType
 */
class ITNonprofitType extends MetaJsonLd implements ITNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ITNonprofitType';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ITNonprofitType';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'ITNonprofitType: Non-profit organization type originating from Italy.';
