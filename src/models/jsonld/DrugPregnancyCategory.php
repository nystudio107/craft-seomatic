...
/**
 * DrugPregnancyCategory - Categories that represent an assessment of the risk
 * of fetal injury due to a drug or pharmaceutical used as directed by the
...
class DrugPregnancyCategory extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DrugPregnancyCategory';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Categories that represent an assessment of the risk of fetal injury due to a drug or pharmaceutical used as directed by the mother during pregnancy.';
