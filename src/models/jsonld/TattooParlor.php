 ...
 */
class TattooParlor extends MetaJsonLd implements TattooParlorInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use TattooParlorTrait;
