 ...
 */
class TattooParlor extends MetaJsonLd implements TattooParlorInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
