...
class TattooParlor extends HealthAndBeautyBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TattooParlor';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TattooParlor';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A tattoo parlor.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'HealthAndBeautyBusiness';
