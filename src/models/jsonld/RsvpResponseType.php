...
/**
 * RsvpResponseType - RsvpResponseType is an enumeration type whose instances
...
class RsvpResponseType extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'RsvpResponseType is an enumeration type whose instances represent responding to an RSVP request.';
