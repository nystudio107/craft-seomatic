 ...
 * StoreCreditRefund - Specifies that the customer receives a store credit as refund when
 * returning a product
 *
 * @author    nystudio107
 * @package   Seomatic
...
class StoreCreditRefund extends MetaJsonLd implements StoreCreditRefundInterface, RefundTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'StoreCreditRefund';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/StoreCreditRefund';
