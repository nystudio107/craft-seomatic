...
class SoftwareSourceCode extends MetaJsonLd implements SoftwareSourceCodeInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'SoftwareSourceCode';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/SoftwareSourceCode';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates.';
