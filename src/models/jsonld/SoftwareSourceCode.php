 ...
 * SoftwareSourceCode - Computer programming source code. Example: Full (compile ready) solutions,
 ...
 */
class SoftwareSourceCode extends MetaJsonLd implements SoftwareSourceCodeInterface, CreativeWorkInterface, ThingInterface
{
	use SoftwareSourceCodeTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SoftwareSourceCode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SoftwareSourceCode';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'codeRepository' => ['array', 'URL', 'URL[]'],
		    'codeSampleType' => ['array', 'Text', 'Text[]'],
		    ...
		    'programmingLanguage' => ['array', 'ComputerLanguage', 'ComputerLanguage[]', 'array', 'Text', 'Text[]'],
		    ...
		    'targetProduct' => ['array', 'SoftwareApplication', 'SoftwareApplication[]'],
