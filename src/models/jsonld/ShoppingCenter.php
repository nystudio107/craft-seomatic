...
class ShoppingCenter extends MetaJsonLd implements ShoppingCenterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ShoppingCenter';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ShoppingCenter';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A shopping center or mall.';
