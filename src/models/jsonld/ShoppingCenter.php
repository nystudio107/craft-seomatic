 ...
 */
class ShoppingCenter extends MetaJsonLd implements ShoppingCenterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ShoppingCenterTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ShoppingCenter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ShoppingCenter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A shopping center or mall.';
