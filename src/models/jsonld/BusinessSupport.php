 ...
 */
class BusinessSupport extends MetaJsonLd implements BusinessSupportInterface, GovernmentBenefitsTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BusinessSupport';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BusinessSupport';
