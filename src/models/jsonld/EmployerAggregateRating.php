...
class EmployerAggregateRating extends MetaJsonLd implements EmployerAggregateRatingInterface, AggregateRatingInterface, RatingInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'EmployerAggregateRating';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/EmployerAggregateRating';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'AggregateRating';
