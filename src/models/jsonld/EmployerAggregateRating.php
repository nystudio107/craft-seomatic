...
use nystudio107\seomatic\models\jsonld\AggregateRating;

/**
 * EmployerAggregateRating - An aggregate rating of an Organization related to
...
class EmployerAggregateRating extends AggregateRating
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'EmployerAggregateRating';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An aggregate rating of an Organization related to its role as an employer.';
