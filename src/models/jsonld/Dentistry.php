 ...
 */
class Dentistry extends MetaJsonLd implements DentistryInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Dentistry';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Dentistry';
