 ...
 */
class Dentistry extends MetaJsonLd implements DentistryInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, SpecialtyInterface
{
    use DentistryTrait;
