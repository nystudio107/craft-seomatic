...
class BusinessAudience extends MetaJsonLd implements BusinessAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'BusinessAudience';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/BusinessAudience';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A set of characteristics belonging to businesses, e.g. who compose an item\'s target audience.';
