...
class BusinessAudience extends MetaJsonLd implements BusinessAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BusinessAudience';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BusinessAudience';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A set of characteristics belonging to businesses, e.g. who compose an item\'s target audience.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'url' => ['array', 'URL', 'URL[]'],
            'yearlyRevenue' => ['array', 'QuantitativeValue', 'QuantitativeValue[]'],
            'yearsInOperation' => ['array', 'QuantitativeValue', 'QuantitativeValue[]'],
        ];
    }
