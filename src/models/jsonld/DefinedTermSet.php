 ...
 * DefinedTermSet - A set of defined terms, for example a set of categories or a classification
 * scheme, a glossary, dictionary or enumeration. Use the about property to
 * specify what the term set is about.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/DefinedTermSet
 */
class DefinedTermSet extends MetaJsonLd implements DefinedTermSetInterface, CreativeWorkInterface, ThingInterface
{
	use DefinedTermSetTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'DefinedTermSet';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/DefinedTermSet';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A set of defined terms, for example a set of categories or a classification scheme, a glossary, dictionary or enumeration. Use the about property to specify what the term set is about.';
