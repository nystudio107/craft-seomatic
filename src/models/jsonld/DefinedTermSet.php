...
class DefinedTermSet extends MetaJsonLd implements DefinedTermSetInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'DefinedTermSet';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/DefinedTermSet';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A set of defined terms, for example a set of categories or a classification scheme, a glossary, dictionary or enumeration. Use the about property to specify what the term set is about.';
