 ...
 */
class HomeGoodsStore extends MetaJsonLd implements HomeGoodsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use HomeGoodsStoreTrait;
	use StoreTrait;
