 ...
 * AudiobookFormat - Book format: Audiobook. This is an enumerated value for use with the
 ...
 */
class AudiobookFormat extends MetaJsonLd implements AudiobookFormatInterface, BookFormatTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
