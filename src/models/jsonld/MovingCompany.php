 ...
 */
class MovingCompany extends MetaJsonLd implements MovingCompanyInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MovingCompanyTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MovingCompany';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MovingCompany';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A moving company.';
