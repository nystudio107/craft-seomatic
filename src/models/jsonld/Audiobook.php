 ...
 */
class Audiobook extends MetaJsonLd implements AudiobookInterface, BookInterface, CreativeWorkInterface, ThingInterface, AudioObjectInterface, MediaObjectInterface
{
    use AudiobookTrait;
    use BookTrait;
