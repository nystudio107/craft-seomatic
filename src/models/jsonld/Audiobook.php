 ...
 */
class Audiobook extends MetaJsonLd implements AudiobookInterface, AudioObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface, BookInterface
{
    use AudiobookTrait;
