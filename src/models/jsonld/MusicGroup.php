 ...
 * MusicGroup - A musical group, such as a band, an orchestra, or a choir. Can also be a
 * solo musician.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MusicGroup extends MetaJsonLd implements MusicGroupInterface, PerformingGroupInterface, OrganizationInterface, ThingInterface
{
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'album' => ['array', 'MusicAlbum', 'MusicAlbum[]'],
		    'albums' => ['array', 'MusicAlbum', 'MusicAlbum[]'],
		    ...
		    'musicGroupMember' => ['array', 'Person', 'Person[]'],
		    ...
		    'track' => ['array', 'ItemList', 'ItemList[]', 'array', 'MusicRecording', 'MusicRecording[]'],
		    'tracks' => ['array', 'MusicRecording', 'MusicRecording[]'],
