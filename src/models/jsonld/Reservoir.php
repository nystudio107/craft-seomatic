...
use nystudio107\seomatic\models\jsonld\BodyOfWater;

/**
 * Reservoir - A reservoir of water, typically an artificially created lake,
 * like the Lake Kariba reservoir.
 * Extends: BodyOfWater
...
class Reservoir extends BodyOfWater
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Reservoir';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Reservoir';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'BodyOfWater';
