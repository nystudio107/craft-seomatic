...
class Reservoir extends BodyOfWater
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Reservoir';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir.';
