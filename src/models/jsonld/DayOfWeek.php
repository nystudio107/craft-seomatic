...
/**
 * DayOfWeek - The day of the week, e.g. used to specify to which day the
 * opening hours of an OpeningHoursSpecification refer. Originally, URLs from
 * GoodRelations were used (for Monday, Tuesday, Wednesday, Thursday, Friday,
 * Saturday, Sunday plus a special entry for PublicHolidays); these have now
...
class DayOfWeek extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DayOfWeek';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DayOfWeek';
