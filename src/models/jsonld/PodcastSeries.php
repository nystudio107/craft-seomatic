...
/**
 * PodcastSeries - A podcast is an episodic series of digital audio or video
 * files which a user can download and listen to.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/PodcastSeries
 */
class PodcastSeries extends CreativeWorkSeries
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PodcastSeries';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A podcast is an episodic series of digital audio or video files which a user can download and listen to.';
