 ...
 * PodcastSeries - A podcast is an episodic series of digital audio or video files which a
 ...
 */
class PodcastSeries extends MetaJsonLd implements PodcastSeriesInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PodcastSeries';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PodcastSeries';
