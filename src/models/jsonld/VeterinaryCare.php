...
class VeterinaryCare extends MetaJsonLd implements VeterinaryCareInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'VeterinaryCare';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/VeterinaryCare';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A vet\'s office.';
