 ...
 */
class Hotel extends MetaJsonLd implements HotelInterface, LodgingBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use HotelTrait;
