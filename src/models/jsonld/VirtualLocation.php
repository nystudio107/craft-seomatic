...
/**
 * VirtualLocation - An online or virtual location for attending events. For
 * example, one may attend an online seminar or educational event. While a
 * virtual location may be used as the location of an event, virtual locations
 * should not be confused with physical locations in the real world.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/VirtualLocation
 */
class VirtualLocation extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'VirtualLocation';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/VirtualLocation';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An online or virtual location for attending events. For example, one may attend an online seminar or educational event. While a virtual location may be used as the location of an event, virtual locations should not be confused with physical locations in the real world.';
