...
class VirtualLocation extends MetaJsonLd implements VirtualLocationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'VirtualLocation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/VirtualLocation';
