 ...
 * HowTo - Instructions that explain how to achieve a result by performing a sequence
 * of steps.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class HowTo extends MetaJsonLd implements HowToInterface, CreativeWorkInterface, ThingInterface
{
    use HowToTrait;
