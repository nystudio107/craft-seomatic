...
class AdultEntertainment extends EntertainmentBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AdultEntertainment';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AdultEntertainment';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An adult entertainment establishment.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'EntertainmentBusiness';
