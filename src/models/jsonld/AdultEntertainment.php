 ...
 */
class AdultEntertainment extends MetaJsonLd implements AdultEntertainmentInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use AdultEntertainmentTrait;
