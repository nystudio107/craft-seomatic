...
class SocialEvent extends MetaJsonLd implements SocialEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SocialEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SocialEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Event type: Social event.';
