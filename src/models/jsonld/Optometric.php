 ...
 */
class Optometric extends MetaJsonLd implements OptometricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Optometric';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Optometric';
