 ...
 * Optometric - The science or practice of testing visual acuity and prescribing corrective
 * lenses.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Optometric extends MetaJsonLd implements OptometricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	use OptometricTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Optometric';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Optometric';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'The science or practice of testing visual acuity and prescribing corrective lenses.';
