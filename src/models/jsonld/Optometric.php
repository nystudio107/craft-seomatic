...
class Optometric extends MetaJsonLd implements OptometricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Optometric';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Optometric';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The science or practice of testing visual acuity and prescribing corrective lenses.';
