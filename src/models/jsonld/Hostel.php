 ...
 */
class Hostel extends MetaJsonLd implements HostelInterface, LodgingBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use HostelTrait;
