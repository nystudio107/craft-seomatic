 ...
 */
class CategoryCodeSet extends MetaJsonLd implements CategoryCodeSetInterface, DefinedTermSetInterface, CreativeWorkInterface, ThingInterface
{
    use CategoryCodeSetTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CategoryCodeSet';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CategoryCodeSet';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'DefinedTermSet';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A set of Category Code values.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'hasCategoryCode' => ['array', 'CategoryCode', 'CategoryCode[]'],
