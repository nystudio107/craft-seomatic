...
class EducationEvent extends Event
{
     ...
     * @var string
     */
    static $schemaTypeName = 'EducationEvent';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/EducationEvent';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Event type: Education event.';
    ...
    public function rules()
    {
        ...
        $rules = array_merge($rules,
            [
                [['aggregateRating','attendee','composer','contributor','endDate','funder','inLanguage','isAccessibleForFree','location','offers','organizer','performer','recordedIn','review','sponsor','translator','typicalAgeRange','workFeatured','workPerformed',], 'validateJsonSchema'],
            ]);
        return $rules;
    } /* -- rules */
