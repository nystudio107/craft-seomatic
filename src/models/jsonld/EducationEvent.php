...
class EducationEvent extends MetaJsonLd implements EducationEventInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'EducationEvent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/EducationEvent';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Event type: Education event.';
