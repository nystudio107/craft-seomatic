 ...
 */
class EducationEvent extends MetaJsonLd implements EducationEventInterface, EventInterface, ThingInterface
{
    use EducationEventTrait;
    use EventTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EducationEvent';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EducationEvent';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Event type: Education event.';
