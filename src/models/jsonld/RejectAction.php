 ...
 */
class RejectAction extends MetaJsonLd implements RejectActionInterface, AllocateActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'RejectAction';
