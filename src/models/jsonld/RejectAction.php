...
class RejectAction extends AllocateAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RejectAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RejectAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of rejecting to/adopting an object. Related actions: AcceptAction: The antonym of RejectAction.';
