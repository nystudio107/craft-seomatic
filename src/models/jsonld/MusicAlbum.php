 ...
 */
class MusicAlbum extends MetaJsonLd implements MusicAlbumInterface, MusicPlaylistInterface, CreativeWorkInterface, ThingInterface
{
    use MusicAlbumTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'albumProductionType' => ['array', 'MusicAlbumProductionType', 'MusicAlbumProductionType[]'],
            'albumRelease' => ['array', 'MusicRelease', 'MusicRelease[]'],
            'albumReleaseType' => ['array', 'MusicAlbumReleaseType', 'MusicAlbumReleaseType[]'],
            ...
            'byArtist' => ['array', 'Person', 'Person[]', 'array', 'MusicGroup', 'MusicGroup[]'],
