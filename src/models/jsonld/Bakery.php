 ...
 */
class Bakery extends MetaJsonLd implements BakeryInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use BakeryTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Bakery';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Bakery';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A bakery.';
