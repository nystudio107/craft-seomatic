 ...
 */
class Bakery extends MetaJsonLd implements BakeryInterface, FoodEstablishmentInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use BakeryTrait;
