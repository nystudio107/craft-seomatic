 ...
 */
class CityHall extends MetaJsonLd implements CityHallInterface, GovernmentBuildingInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use CityHallTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CityHall';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CityHall';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A city hall.';
