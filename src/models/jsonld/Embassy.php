...
class Embassy extends MetaJsonLd implements EmbassyInterface, GovernmentBuildingInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Embassy';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Embassy';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An embassy.';
