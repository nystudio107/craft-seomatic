...
class RearWheelDriveConfiguration extends MetaJsonLd implements RearWheelDriveConfigurationInterface, DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'RearWheelDriveConfiguration';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/RearWheelDriveConfiguration';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Real-wheel drive is a transmission layout where the engine drives the rear wheels.';
