 ...
 * RearWheelDriveConfiguration - Real-wheel drive is a transmission layout where the engine drives the rear
 * wheels.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class RearWheelDriveConfiguration extends MetaJsonLd implements RearWheelDriveConfigurationInterface, DriveWheelConfigurationValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
    use RearWheelDriveConfigurationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RearWheelDriveConfiguration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RearWheelDriveConfiguration';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Real-wheel drive is a transmission layout where the engine drives the rear wheels.';
