 ...
 * Hardcover - A durable, archival-quality book featuring a rigid protective shell made of
 * heavy board wrapped in cloth or paper, designed to withstand heavy use and
 * preservation on a shelf.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/Hardcover
 */
class Hardcover extends MetaJsonLd implements HardcoverInterface, BookFormatTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
	use HardcoverTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A durable, archival-quality book featuring a rigid protective shell made of heavy board wrapped in cloth or paper, designed to withstand heavy use and preservation on a shelf.';
