 ...
 * ProductModel - A datasheet or vendor specification of a product (in the sense of a
 ...
 */
class ProductModel extends MetaJsonLd implements ProductModelInterface, ProductInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'ProductModel';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/ProductModel';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A datasheet or vendor specification of a product (in the sense of a prototypical description).';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'predecessorOf' => ['array', 'ProductModel', 'ProductModel[]'],
            ...
            'successorOf' => ['array', 'ProductModel', 'ProductModel[]'],
            'url' => ['array', 'URL', 'URL[]'],
