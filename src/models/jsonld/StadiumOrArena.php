 ...
 */
class StadiumOrArena extends MetaJsonLd implements StadiumOrArenaInterface, CivicStructureInterface, PlaceInterface, ThingInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface
{
    use StadiumOrArenaTrait;
