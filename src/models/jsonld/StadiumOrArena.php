 ...
 */
class StadiumOrArena extends MetaJsonLd implements StadiumOrArenaInterface, SportsActivityLocationInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, CivicStructureInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'StadiumOrArena';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/StadiumOrArena';
