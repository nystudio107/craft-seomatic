...
/**
 * MedicalProcedureType - An enumeration that describes different types of
 * medical procedures.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MedicalProcedureType extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalProcedureType';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MedicalProcedureType';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An enumeration that describes different types of medical procedures.';
