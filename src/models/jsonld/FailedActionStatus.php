 ...
 * FailedActionStatus - An action that failed to complete. The action's error property and the HTTP
...
class FailedActionStatus extends MetaJsonLd implements FailedActionStatusInterface, ActionStatusTypeInterface, StatusEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'FailedActionStatus';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/FailedActionStatus';
