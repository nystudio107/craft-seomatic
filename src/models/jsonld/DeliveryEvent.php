 ...
 */
class DeliveryEvent extends MetaJsonLd implements DeliveryEventInterface, EventInterface, ThingInterface
{
	use DeliveryEventTrait;
	use EventTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'DeliveryEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/DeliveryEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An event involving the delivery of an item.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'availableFrom' => ['array', 'DateTime', 'DateTime[]'],
		    'availableThrough' => ['array', 'DateTime', 'DateTime[]'],
