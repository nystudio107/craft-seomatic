 ...
 */
class HighSchool extends MetaJsonLd implements HighSchoolInterface, EducationalOrganizationInterface, OrganizationInterface, ThingInterface, CivicStructureInterface, PlaceInterface
{
    use HighSchoolTrait;
