 ...
 * Obstetric - A specific branch of medical science that specializes in the care of women
 ...
 */
class Obstetric extends MetaJsonLd implements ObstetricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use ObstetricTrait;
