 ...
 */
class ComedyClub extends MetaJsonLd implements ComedyClubInterface, EntertainmentBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use ComedyClubTrait;
