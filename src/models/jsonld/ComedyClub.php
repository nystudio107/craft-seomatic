 ...
 */
class ComedyClub extends MetaJsonLd implements ComedyClubInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ComedyClubTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ComedyClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ComedyClub';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A comedy club.';
