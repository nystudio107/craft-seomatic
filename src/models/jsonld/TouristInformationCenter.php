...
class TouristInformationCenter extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TouristInformationCenter';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TouristInformationCenter';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A tourist information center.';
