...
class TouristInformationCenter extends MetaJsonLd implements TouristInformationCenterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TouristInformationCenter';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TouristInformationCenter';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A tourist information center.';
