 ...
 */
class TouristInformationCenter extends MetaJsonLd implements TouristInformationCenterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use TouristInformationCenterTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TouristInformationCenter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TouristInformationCenter';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A tourist information center.';
