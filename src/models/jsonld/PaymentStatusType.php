 ...
 */
class PaymentStatusType extends MetaJsonLd implements PaymentStatusTypeInterface, StatusEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PaymentStatusType';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PaymentStatusType';
