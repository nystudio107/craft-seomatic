...
/**
 * PaymentStatusType - A specific payment status. For example, PaymentDue,
 * PaymentComplete, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class PaymentStatusType extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PaymentStatusType';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PaymentStatusType';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A specific payment status. For example, PaymentDue, PaymentComplete, etc.';
