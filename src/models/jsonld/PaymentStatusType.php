...
class PaymentStatusType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PaymentStatusType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PaymentStatusType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A specific payment status. For example, PaymentDue, PaymentComplete, etc.';
