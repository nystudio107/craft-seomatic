...
class SoftwareApplication extends MetaJsonLd implements SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'SoftwareApplication';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/SoftwareApplication';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A software application.';
