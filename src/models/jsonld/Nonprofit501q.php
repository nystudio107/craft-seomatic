 ...
 * Nonprofit501q - Nonprofit501q: Non-profit type referring to Credit Counseling
 * Organizations.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Nonprofit501q extends MetaJsonLd implements Nonprofit501qInterface, USNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Nonprofit501q';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Nonprofit501q';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Nonprofit501q: Non-profit type referring to Credit Counseling Organizations.';
