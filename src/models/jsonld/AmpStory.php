 ...
 * AmpStory - A creative work with a visual storytelling format intended to be viewed
 ...
 */
class AmpStory extends MetaJsonLd implements AmpStoryInterface, CreativeWorkInterface, ThingInterface, MediaObjectInterface
{
    use AmpStoryTrait;
