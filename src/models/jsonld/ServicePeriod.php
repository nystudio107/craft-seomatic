...
class ServicePeriod extends MetaJsonLd implements ServicePeriodInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'ServicePeriod';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/ServicePeriod';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'ServicePeriod represents a duration with some constraints about cutoff time and business days. This is used e.g. in shipping for handling times or transit time.';
