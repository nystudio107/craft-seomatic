 ...
 * RightHandDriving - The steering position is on the right side of the vehicle (viewed from the
 ...
 */
class RightHandDriving extends MetaJsonLd implements RightHandDrivingInterface, SteeringPositionValueInterface, QualitativeValueInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'RightHandDriving';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/RightHandDriving';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'SteeringPositionValue';
