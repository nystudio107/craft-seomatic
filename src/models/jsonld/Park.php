 ...
 */
class Park extends MetaJsonLd implements ParkInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use ParkTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Park';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Park';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A park.';
