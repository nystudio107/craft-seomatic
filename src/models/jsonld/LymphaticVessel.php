 ...
 */
class LymphaticVessel extends MetaJsonLd implements LymphaticVesselInterface, VesselInterface, AnatomicalStructureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LymphaticVessel';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LymphaticVessel';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Vessel';
