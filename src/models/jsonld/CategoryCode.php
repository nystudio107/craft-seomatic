...
class CategoryCode extends MetaJsonLd implements CategoryCodeInterface, DefinedTermInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CategoryCode';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CategoryCode';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'DefinedTerm';
