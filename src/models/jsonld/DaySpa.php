 ...
 */
class DaySpa extends MetaJsonLd implements DaySpaInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use DaySpaTrait;
