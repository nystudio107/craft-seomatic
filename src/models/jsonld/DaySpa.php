 ...
 */
class DaySpa extends MetaJsonLd implements DaySpaInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use DaySpaTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'DaySpa';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/DaySpa';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A day spa.';
