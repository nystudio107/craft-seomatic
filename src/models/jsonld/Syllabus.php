 ...
 * Syllabus - A syllabus that describes the material covered in a course, often with
 ...
 */
class Syllabus extends MetaJsonLd implements SyllabusInterface, LearningResourceInterface, CreativeWorkInterface, ThingInterface
{
    use SyllabusTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Syllabus';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Syllabus';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A syllabus that describes the material covered in a course, often with several such sections per [[Course]] so that a distinct [[timeRequired]] can be provided for that section of the [[Course]].';
