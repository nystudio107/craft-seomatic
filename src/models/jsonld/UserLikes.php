 ...
 * UserLikes - UserInteraction and its subtypes is an old way of talking about users
 ...
 */
class UserLikes extends MetaJsonLd implements UserLikesInterface, UserInteractionInterface, EventInterface, ThingInterface
{
    use UserLikesTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'UserLikes';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/UserLikes';
