 ...
 */
class ApartmentComplex extends MetaJsonLd implements ApartmentComplexInterface, ResidenceInterface, PlaceInterface, ThingInterface
{
    use ApartmentComplexTrait;
    use ResidenceTrait;
    use PlaceTrait;
    use ThingTrait;
