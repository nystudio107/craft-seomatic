...
class ApartmentComplex extends Residence
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ApartmentComplex';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ApartmentComplex';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Residence type: Apartment complex.';
