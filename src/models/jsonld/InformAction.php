 ...
 * InformAction - The act of notifying someone of information pertinent to them, with no
 ...
 */
class InformAction extends MetaJsonLd implements InformActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'InformAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/InformAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of notifying someone of information pertinent to them, with no expectation of a response.';
