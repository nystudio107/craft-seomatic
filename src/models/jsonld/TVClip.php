...
class TVClip extends Clip
{
     ...
     * @var string
     */
    static $schemaTypeName = 'TVClip';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/TVClip';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A short TV program or a segment/part of a TV program.';
