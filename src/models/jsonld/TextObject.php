 ...
 */
class TextObject extends MetaJsonLd implements TextObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
	use TextObjectTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TextObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TextObject';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A text file. The text can be unformatted or contain markup, html, etc.';
