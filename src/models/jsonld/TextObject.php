...
class TextObject extends MetaJsonLd implements TextObjectInterface, MediaObjectInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'TextObject';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/TextObject';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A text file. The text can be unformatted or contain markup, html, etc.';
