...
class HealthPlanNetwork extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'HealthPlanNetwork';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A US-style health insurance plan network.';
    ...
    public function rules(): array
    {
        ...
        $rules = array_merge($rules, [
            [['healthPlanCostSharing', 'healthPlanNetworkId', 'healthPlanNetworkTier'], 'validateJsonSchema'],
