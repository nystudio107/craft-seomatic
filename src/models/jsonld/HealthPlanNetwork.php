...
class HealthPlanNetwork extends MetaJsonLd implements HealthPlanNetworkInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'HealthPlanNetwork';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/HealthPlanNetwork';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A US-style health insurance plan network.';
