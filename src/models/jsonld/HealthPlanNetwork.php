 ...
 */
class HealthPlanNetwork extends MetaJsonLd implements HealthPlanNetworkInterface, IntangibleInterface, ThingInterface
{
	use HealthPlanNetworkTrait;
	use IntangibleTrait;
	use ThingTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'HealthPlanNetwork';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/HealthPlanNetwork';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A US-style health insurance plan network.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'healthPlanCostSharing' => ['array', 'Boolean', 'Boolean[]', 'array', 'HealthPlanCostSharingSpecification', 'HealthPlanCostSharingSpecification[]'],
		    'healthPlanNetworkId' => ['array', 'Text', 'Text[]'],
		    'healthPlanNetworkTier' => ['array', 'Text', 'Text[]'],
