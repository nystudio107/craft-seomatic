 ...
 */
class Abdomen extends MetaJsonLd implements AbdomenInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Abdomen';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Abdomen';
