...
class OfferItemCondition extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'OfferItemCondition';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/OfferItemCondition';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A list of possible conditions for the item.';
