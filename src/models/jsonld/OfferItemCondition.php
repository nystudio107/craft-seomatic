 ...
 */
class OfferItemCondition extends MetaJsonLd implements OfferItemConditionInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OfferItemCondition';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OfferItemCondition';
