...
/**
 * DrawAction - The act of producing a visual/graphical representation of an
...
class DrawAction extends CreateAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DrawAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DrawAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments.';
