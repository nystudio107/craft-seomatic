 ...
 */
class DepositAccount extends MetaJsonLd implements DepositAccountInterface, InvestmentOrDepositInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface, BankAccountInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DepositAccount';
