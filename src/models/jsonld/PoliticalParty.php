 ...
 */
class PoliticalParty extends MetaJsonLd implements PoliticalPartyInterface, OrganizationInterface, ThingInterface
{
    use PoliticalPartyTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PoliticalParty';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PoliticalParty';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Organization: Political Party.';
