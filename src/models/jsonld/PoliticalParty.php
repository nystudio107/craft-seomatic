...
class PoliticalParty extends MetaJsonLd implements PoliticalPartyInterface, OrganizationInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'PoliticalParty';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/PoliticalParty';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Organization: Political Party.';
