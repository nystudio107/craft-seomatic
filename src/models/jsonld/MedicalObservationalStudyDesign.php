...
/**
 * MedicalObservationalStudyDesign - Design models for observational medical
 * studies. Enumerated type.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MedicalObservationalStudyDesign extends MedicalEnumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalObservationalStudyDesign';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Design models for observational medical studies. Enumerated type.';
