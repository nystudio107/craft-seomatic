 ...
 */
class MedicalObservationalStudyDesign extends MetaJsonLd implements MedicalObservationalStudyDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalObservationalStudyDesign';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalObservationalStudyDesign';
