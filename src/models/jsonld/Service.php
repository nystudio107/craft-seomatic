...
/**
 * Service - A service provided by an organization, e.g. delivery service,
 * print services, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Service extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Service';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A service provided by an organization, e.g. delivery service, print services, etc.';
