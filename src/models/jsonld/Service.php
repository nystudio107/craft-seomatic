...
class Service extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Service';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Service';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A service provided by an organization, e.g. delivery service, print services, etc.';
