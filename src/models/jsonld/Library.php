 ...
 */
class Library extends MetaJsonLd implements LibraryInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use LibraryTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Library';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Library';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A library.';
