...
class WearableSizeGroupGirls extends MetaJsonLd implements WearableSizeGroupGirlsInterface, WearableSizeGroupEnumerationInterface, SizeGroupEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'WearableSizeGroupGirls';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/WearableSizeGroupGirls';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Size group "Girls" for wearables.';
