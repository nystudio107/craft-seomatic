 ...
 * USNonprofitType - USNonprofitType: Non-profit organization type originating from the United
 * States.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class USNonprofitType extends MetaJsonLd implements USNonprofitTypeInterface, NonprofitTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'USNonprofitType';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/USNonprofitType';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'USNonprofitType: Non-profit organization type originating from the United States.';
