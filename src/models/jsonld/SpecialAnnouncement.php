...
class SpecialAnnouncement extends MetaJsonLd implements SpecialAnnouncementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'SpecialAnnouncement';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/SpecialAnnouncement';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'diseasePreventionInfo' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            'diseaseSpreadStatistics' => ['array', 'Dataset', 'Dataset[]', 'array', 'Observation', 'Observation[]', 'array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            ...
            'gettingTestedInfo' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            ...
            'newsUpdatesAndGuidelines' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            ...
            'quarantineGuidelines' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            ...
            'schoolClosuresInfo' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
            ...
            'travelBans' => ['array', 'URL', 'URL[]', 'array', 'WebContent', 'WebContent[]'],
