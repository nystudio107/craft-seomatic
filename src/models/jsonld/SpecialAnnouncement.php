...
class SpecialAnnouncement extends MetaJsonLd implements SpecialAnnouncementInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SpecialAnnouncement';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SpecialAnnouncement';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'diseaseSpreadStatistics' => ['Dataset', 'Observation', 'WebContent', 'URL'],
            'editEIDR' => ['URL', 'Text'],
            'editor' => ['Person'],
