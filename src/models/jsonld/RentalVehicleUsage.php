...
class RentalVehicleUsage extends MetaJsonLd implements RentalVehicleUsageInterface, CarUsageTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RentalVehicleUsage';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RentalVehicleUsage';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Indicates the usage of the vehicle as a rental car.';
