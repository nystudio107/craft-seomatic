 ...
 * Psychiatric - A specific branch of medical science that is concerned with the study,
 ...
 */
class Psychiatric extends MetaJsonLd implements PsychiatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Psychiatric';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Psychiatric';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A specific branch of medical science that is concerned with the study, treatment, and prevention of mental illness, using both medical and psychological therapies.';
