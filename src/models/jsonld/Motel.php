...
class Motel extends LodgingBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Motel';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Motel';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A motel. See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.';
