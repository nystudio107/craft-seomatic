 ...
 * Motel - A motel.    See also the <a href="/docs/hotels.html">dedicated document on
 ...
 */
class Motel extends MetaJsonLd implements MotelInterface, LodgingBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MotelTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Motel';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Motel';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "A motel.\n<br /><br />\nSee also the <a href=\"/docs/hotels.html\">dedicated document on the use of schema.org for marking up hotels and other forms of accommodations</a>.";
