 ...
 */
class Motel extends MetaJsonLd implements MotelInterface, LodgingBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use MotelTrait;
