 ...
 * RuntimePlatform - Specialized software environment that provides the essential
 ...
 */
class RuntimePlatform extends MetaJsonLd implements RuntimePlatformInterface, SoftwareApplicationInterface, CreativeWorkInterface, ThingInterface
{
    use RuntimePlatformTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'RuntimePlatform';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/RuntimePlatform';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Specialized software environment that provides the essential infrastructure, libraries, and services required to execute a program.';
