...
class MotorcycleDealer extends MetaJsonLd implements MotorcycleDealerInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MotorcycleDealer';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MotorcycleDealer';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A motorcycle dealer.';
