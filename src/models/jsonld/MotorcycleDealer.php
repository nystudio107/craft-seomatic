 ...
 */
class MotorcycleDealer extends MetaJsonLd implements MotorcycleDealerInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MotorcycleDealerTrait;
    use AutomotiveBusinessTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MotorcycleDealer';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MotorcycleDealer';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A motorcycle dealer.';
