...
/**
 * RefundTypeEnumeration - RefundTypeEnumeration enumerates several kinds of
 * product return refund types.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class RefundTypeEnumeration extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'RefundTypeEnumeration';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/RefundTypeEnumeration';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'RefundTypeEnumeration enumerates several kinds of product return refund types.';
