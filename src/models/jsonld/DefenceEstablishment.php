...
class DefenceEstablishment extends GovernmentBuilding
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DefenceEstablishment';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DefenceEstablishment';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A defence establishment, such as an army or navy base.';
