 ...
 */
class DefenceEstablishment extends MetaJsonLd implements DefenceEstablishmentInterface, GovernmentBuildingInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use DefenceEstablishmentTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'DefenceEstablishment';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/DefenceEstablishment';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A defence establishment, such as an army or navy base.';
