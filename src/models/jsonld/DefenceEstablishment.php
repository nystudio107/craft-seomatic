...
use nystudio107\seomatic\models\jsonld\GovernmentBuilding;

/**
 * DefenceEstablishment - A defence establishment, such as an army or navy
 * base.
...
class DefenceEstablishment extends GovernmentBuilding
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DefenceEstablishment';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DefenceEstablishment';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A defence establishment, such as an army or navy base.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'GovernmentBuilding';
