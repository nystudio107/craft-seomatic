 ...
 */
class Report extends MetaJsonLd implements ReportInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
    use ReportTrait;
    use ArticleTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Report';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Report';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A Report generated by governmental or non-governmental organization.';
