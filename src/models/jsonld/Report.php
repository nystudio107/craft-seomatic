...
class Report extends MetaJsonLd implements ReportInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Report';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Report';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A Report generated by governmental or non-governmental organization.';
