...
class ServiceChannel extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ServiceChannel';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ServiceChannel';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A means for accessing a service, e.g. a government office location, web site, or phone number.';
