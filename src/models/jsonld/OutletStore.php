 ...
 */
class OutletStore extends MetaJsonLd implements OutletStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use OutletStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'OutletStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/OutletStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An outlet store.';
