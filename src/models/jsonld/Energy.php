...
class Energy extends Quantity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Energy';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Energy';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Properties that take Energy as values are of the form \'<Number> <Energy unit of measure>\'.';
