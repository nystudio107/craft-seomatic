...
/**
 * Energy - Properties that take Energy as values are of the form '<Number>
...
class Energy extends Quantity
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Energy';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Energy';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Properties that take Energy as values are of the form \'<Number> <Energy unit of measure>\'.';
