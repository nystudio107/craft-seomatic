...
/**
 * MediaSubscription - A subscription which allows a user to access media
 * including audio, video, books, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MediaSubscription extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A subscription which allows a user to access media including audio, video, books, etc.';
