...
/**
 * ExhibitionEvent - Event type: Exhibition event, e.g. at a museum, library,
 * archive, tradeshow, ...
 *
 * @author    nystudio107
 * @package   Seomatic
...
class ExhibitionEvent extends Event
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ...';
