 ...
 * ExhibitionEvent - Event type: Exhibition event, e.g. at a museum, library, archive,
 * tradeshow, ...
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class ExhibitionEvent extends MetaJsonLd implements ExhibitionEventInterface, EventInterface, ThingInterface
{
    use ExhibitionEventTrait;
    use EventTrait;
    use ThingTrait;
