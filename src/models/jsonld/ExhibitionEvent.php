...
class ExhibitionEvent extends Event
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ExhibitionEvent';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ExhibitionEvent';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ...';
