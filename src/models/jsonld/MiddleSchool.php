 ...
 * MiddleSchool - A middle school (typically for children aged around 11-14, although this
 * varies somewhat).
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class MiddleSchool extends MetaJsonLd implements MiddleSchoolInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use MiddleSchoolTrait;
