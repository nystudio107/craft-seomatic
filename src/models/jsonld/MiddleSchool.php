...
class MiddleSchool extends MetaJsonLd implements MiddleSchoolInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MiddleSchool';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MiddleSchool';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'EducationalOrganization';
