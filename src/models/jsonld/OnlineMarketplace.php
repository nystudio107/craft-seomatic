 ...
 * OnlineMarketplace - An eCommerce marketplace.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/OnlineMarketplace
 */
class OnlineMarketplace extends MetaJsonLd implements OnlineMarketplaceInterface, OnlineStoreInterface, OnlineBusinessInterface, OrganizationInterface, ThingInterface
{
	use OnlineMarketplaceTrait;
	use OnlineStoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'OnlineMarketplace';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/OnlineMarketplace';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'OnlineStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An eCommerce marketplace.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'hasStore' => ['array', 'OnlineStore', 'OnlineStore[]'],
		    ...
		    'isStoreOn' => ['array', 'OnlineMarketplace', 'OnlineMarketplace[]'],
