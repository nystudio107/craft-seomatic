...
class OnlineMarketplace extends MetaJsonLd implements OnlineMarketplaceInterface, OnlineStoreInterface, OnlineBusinessInterface, OrganizationInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'OnlineMarketplace';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/OnlineMarketplace';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'OnlineStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An eCommerce marketplace.';
