...
class IndividualPhysician extends MetaJsonLd implements IndividualPhysicianInterface, PhysicianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'IndividualPhysician';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/IndividualPhysician';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'Physician';
     ...
     * @var string
     */
    public static $schemaTypeDescription = "An individual medical practitioner. For their official address use [[address]], for affiliations to hospitals use [[hospitalAffiliation]]. \nThe [[practicesAt]] property can be used to indicate [[MedicalOrganization]] hospitals, clinics, pharmacies etc. where this physician practices.";
