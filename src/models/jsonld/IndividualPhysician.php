 ...
 * IndividualPhysician - An individual medical practitioner. For their official address use
 ...
 */
class IndividualPhysician extends MetaJsonLd implements IndividualPhysicianInterface, PhysicianInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalOrganizationInterface
{
    use IndividualPhysicianTrait;
    use PhysicianTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'IndividualPhysician';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/IndividualPhysician';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'Physician';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = "An individual medical practitioner. For their official address use [[address]], for affiliations to hospitals use [[hospitalAffiliation]]. \nThe [[practicesAt]] property can be used to indicate [[MedicalOrganization]] hospitals, clinics, pharmacies etc. where this physician practices.";
    ...
    {
        return [
            'acceptedPaymentMethod' => ['array', 'LoanOrCredit', 'LoanOrCredit[]', 'array', 'PaymentMethod', 'PaymentMethod[]', 'array', 'Text', 'Text[]'],
            ...
            'availableService' => ['array', 'MedicalProcedure', 'MedicalProcedure[]', 'array', 'MedicalTest', 'MedicalTest[]', 'array', 'MedicalTherapy', 'MedicalTherapy[]'],
            ...
            'companyRegistration' => ['array', 'Certification', 'Certification[]'],
            ...
            'correctionsPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
            ...
            'diversityPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
            ...
            'founder' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'geo' => ['array', 'GeoCoordinates', 'GeoCoordinates[]', 'array', 'GeoShape', 'GeoShape[]'],
            'geoContains' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            'geoCoveredBy' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            ...
            'geoEquals' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            'geoIntersects' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            'geoOverlaps' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            'geoTouches' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            'geoWithin' => ['array', 'GeospatialGeometry', 'GeospatialGeometry[]', 'array', 'Place', 'Place[]'],
            ...
            'hasGS1DigitalLink' => ['array', 'URL', 'URL[]'],
            'hasMap' => ['array', 'Map', 'Map[]', 'array', 'URL', 'URL[]'],
            'hasMemberProgram' => ['array', 'MemberProgram', 'MemberProgram[]'],
            ...
            'healthPlanNetworkId' => ['array', 'Text', 'Text[]'],
            'hospitalAffiliation' => ['array', 'Hospital', 'Hospital[]'],
            ...
            'isAcceptingNewPatients' => ['array', 'Boolean', 'Boolean[]'],
            ...
            'legalAddress' => ['array', 'PostalAddress', 'PostalAddress[]'],
            'legalName' => ['array', 'Text', 'Text[]'],
            'legalRepresentative' => ['array', 'Person', 'Person[]'],
            ...
            'medicalSpecialty' => ['array', 'MedicalSpecialty', 'MedicalSpecialty[]'],
            'member' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'members' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
            ...
            'ownershipFundingInfo' => ['array', 'AboutPage', 'AboutPage[]', 'array', 'CreativeWork', 'CreativeWork[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'owns' => ['array', 'Thing', 'Thing[]'],
            'parentOrganization' => ['array', 'Organization', 'Organization[]'],
            'paymentAccepted' => ['array', 'Text', 'Text[]'],
            'photo' => ['array', 'ImageObject', 'ImageObject[]', 'array', 'Photograph', 'Photograph[]'],
            'photos' => ['array', 'ImageObject', 'ImageObject[]', 'array', 'Photograph', 'Photograph[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'practicesAt' => ['array', 'MedicalOrganization', 'MedicalOrganization[]'],
            ...
            'unnamedSourcesPolicy' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'URL', 'URL[]'],
            'url' => ['array', 'URL', 'URL[]'],
            'usNPI' => ['array', 'Text', 'Text[]'],
    ...
    public function getSchemaPropertyDescriptions(): array
    {
        return [
            ...
            'companyRegistration' => 'The official registration information of a business including the organization that issued it such as Company House or Chamber of Commerce in form of a Certification.',
            ...
            'url' => 'URL of the item.',
            'usNPI' => 'A <a href="https://en.wikipedia.org/wiki/National_Provider_Identifier">National Provider Identifier</a> (NPI)      is a unique 10-digit identification number issued to health care providers in the United States by the Centers for Medicare and Medicaid Services.',
