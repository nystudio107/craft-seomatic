 ...
 */
class MensClothingStore extends MetaJsonLd implements MensClothingStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use MensClothingStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MensClothingStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MensClothingStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A men\'s clothing store.';
