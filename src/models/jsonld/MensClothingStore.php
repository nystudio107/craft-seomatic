...
class MensClothingStore extends MetaJsonLd implements MensClothingStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MensClothingStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MensClothingStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A men\'s clothing store.';
