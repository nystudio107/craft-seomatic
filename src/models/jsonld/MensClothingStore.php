 ...
 */
class MensClothingStore extends MetaJsonLd implements MensClothingStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
