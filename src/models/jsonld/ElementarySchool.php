 ...
 */
class ElementarySchool extends MetaJsonLd implements ElementarySchoolInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use ElementarySchoolTrait;
