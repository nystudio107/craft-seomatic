...
class AssessAction extends MetaJsonLd implements AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AssessAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AssessAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of forming one\'s opinion, reaction or sentiment.';
