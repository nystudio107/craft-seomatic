 ...
 */
class AssessAction extends MetaJsonLd implements AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AssessAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AssessAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of forming one\'s opinion, reaction or sentiment.';
