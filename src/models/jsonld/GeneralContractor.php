 ...
 */
class GeneralContractor extends MetaJsonLd implements GeneralContractorInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use GeneralContractorTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'GeneralContractor';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/GeneralContractor';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A general contractor.';
