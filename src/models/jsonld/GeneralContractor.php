...
class GeneralContractor extends MetaJsonLd implements GeneralContractorInterface, HomeAndConstructionBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'GeneralContractor';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/GeneralContractor';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A general contractor.';
