 ...
 */
class BroadcastService extends MetaJsonLd implements BroadcastServiceInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BroadcastService';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BroadcastService';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A delivery service through which content is provided via broadcast over the air or online.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'broadcastAffiliateOf' => ['array', 'Organization', 'Organization[]'],
            'broadcastDisplayName' => ['array', 'Text', 'Text[]'],
            'broadcastFrequency' => ['array', 'BroadcastFrequencySpecification', 'BroadcastFrequencySpecification[]', 'array', 'Text', 'Text[]'],
            'broadcastTimezone' => ['array', 'Text', 'Text[]'],
            'broadcaster' => ['array', 'Organization', 'Organization[]'],
            ...
            'hasBroadcastChannel' => ['array', 'BroadcastChannel', 'BroadcastChannel[]'],
            ...
            'parentService' => ['array', 'BroadcastService', 'BroadcastService[]'],
