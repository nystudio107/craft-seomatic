 ...
 * DepartAction - The act of  departing from a place. An agent departs from an fromLocation
 ...
 */
class DepartAction extends MetaJsonLd implements DepartActionInterface, MoveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'DepartAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/DepartAction';
