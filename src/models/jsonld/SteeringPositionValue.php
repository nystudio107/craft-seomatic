...
class SteeringPositionValue extends QualitativeValue
{
     ...
     * @var string
     */
    static $schemaTypeName = 'SteeringPositionValue';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/SteeringPositionValue';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A value indicating a steering position.';
