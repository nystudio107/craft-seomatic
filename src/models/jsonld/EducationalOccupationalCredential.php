...
class EducationalOccupationalCredential extends MetaJsonLd implements EducationalOccupationalCredentialInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'EducationalOccupationalCredential';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/EducationalOccupationalCredential';
