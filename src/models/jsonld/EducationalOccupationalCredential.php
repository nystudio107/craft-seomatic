 ...
 * EducationalOccupationalCredential - An educational or occupational credential. A diploma, academic degree,
 ...
 */
class EducationalOccupationalCredential extends MetaJsonLd implements EducationalOccupationalCredentialInterface, CredentialInterface, CreativeWorkInterface, ThingInterface
{
	use EducationalOccupationalCredentialTrait;
	use CredentialTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'EducationalOccupationalCredential';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/EducationalOccupationalCredential';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Credential';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An educational or occupational credential. A diploma, academic degree, certification, qualification, badge, etc., that may be awarded to a person or other entity that meets the requirements defined by the credentialer.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'competencyRequired' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
		    ...
		    'credentialCategory' => ['array', 'DefinedTerm', 'DefinedTerm[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
		    ...
		    'recognizedBy' => ['array', 'Organization', 'Organization[]'],
