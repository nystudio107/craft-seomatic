 ...
 */
class GovernmentService extends MetaJsonLd implements GovernmentServiceInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
    use GovernmentServiceTrait;
    use ServiceTrait;
    use IntangibleTrait;
    use ThingTrait;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'serviceOperator' => ['array', 'Organization', 'Organization[]'],
