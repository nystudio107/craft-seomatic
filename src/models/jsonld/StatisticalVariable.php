...
class StatisticalVariable extends MetaJsonLd implements StatisticalVariableInterface, ConstraintNodeInterface, IntangibleInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'StatisticalVariable';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/StatisticalVariable';
	 ...
	 * @var string
	 */
	public static $schemaTypeExtends = 'ConstraintNode';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'statType' => ['array', 'Property', 'Property[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
