...
class OnDemandEvent extends MetaJsonLd implements OnDemandEventInterface, PublicationEventInterface, EventInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'OnDemandEvent';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/OnDemandEvent';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PublicationEvent';
