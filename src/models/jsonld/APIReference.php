...
class APIReference extends MetaJsonLd implements APIReferenceInterface, TechArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'assembly' => ['array', 'Text', 'Text[]'],
            'assemblyVersion' => ['array', 'Text', 'Text[]'],
            ...
            'executableLibraryName' => ['array', 'Text', 'Text[]'],
            ...
            'programmingModel' => ['array', 'Text', 'Text[]'],
            ...
            'targetPlatform' => ['array', 'Text', 'Text[]'],
