...
class APIReference extends MetaJsonLd implements APIReferenceInterface, TechArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'APIReference';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/APIReference';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'TechArticle';
