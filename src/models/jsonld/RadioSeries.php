...
class RadioSeries extends CreativeWorkSeries
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RadioSeries';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RadioSeries';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'CreativeWorkSeries dedicated to radio broadcast and associated online delivery.';
