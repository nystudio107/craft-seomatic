 ...
 * RadioSeries - CreativeWorkSeries dedicated to radio broadcast and associated online
 * delivery.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class RadioSeries extends MetaJsonLd implements RadioSeriesInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
    use RadioSeriesTrait;
