...
class CreativeWork extends Thing
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CreativeWork';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CreativeWork';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The most generic kind of creative work, including books, movies, photographs, software programs, etc.';
