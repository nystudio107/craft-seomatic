...
/**
 * CreativeWork - The most generic kind of creative work, including books,
...
class CreativeWork extends Thing
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'CreativeWork';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/CreativeWork';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The most generic kind of creative work, including books, movies, photographs, software programs, etc.';
