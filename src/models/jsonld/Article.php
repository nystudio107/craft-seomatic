...
class Article extends MetaJsonLd implements ArticleInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Article';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Article';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'An article, such as a news article or piece of investigative report. Newspapers and magazines have articles of many different types and this is intended to cover them all.\n\nSee also [blog post](https://blog.schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/).';
