 ...
 */
class Article extends MetaJsonLd implements ArticleInterface, CreativeWorkInterface, ThingInterface
{
	use ArticleTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'Article';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/Article';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An article, such as a news article or piece of investigative report. Newspapers and magazines have articles of many different types and this is intended to cover them all.\n\nSee also [blog post](https://blog.schema.org/2014/09/02/schema-org-support-for-bibliographic-relationships-and-periodicals/).';
