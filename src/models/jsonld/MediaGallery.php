...
/**
 * MediaGallery - Web page type: Media gallery page. A mixed-media page that
 * can contains media such as images, videos, and other multimedia.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MediaGallery extends CollectionPage
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MediaGallery';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Web page type: Media gallery page. A mixed-media page that can contains media such as images, videos, and other multimedia.';
