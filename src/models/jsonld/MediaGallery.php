 ...
 * MediaGallery - Web page type: Media gallery page. A mixed-media page that can contains
...
class MediaGallery extends MetaJsonLd implements MediaGalleryInterface, CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MediaGallery';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MediaGallery';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'CollectionPage';
