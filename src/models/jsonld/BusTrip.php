...
class BusTrip extends MetaJsonLd implements BusTripInterface, TripInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'BusTrip';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/BusTrip';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A trip on a commercial bus line.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'arrivalBusStop' => ['array', 'BusStation', 'BusStation[]', 'array', 'BusStop', 'BusStop[]'],
            'arrivalTime' => ['array', 'DateTime', 'DateTime[]', 'array', 'Time', 'Time[]'],
            'busName' => ['array', 'Text', 'Text[]'],
            'busNumber' => ['array', 'Text', 'Text[]'],
            'departureBusStop' => ['array', 'BusStation', 'BusStation[]', 'array', 'BusStop', 'BusStop[]'],
