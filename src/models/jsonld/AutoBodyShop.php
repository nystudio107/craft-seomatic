...
class AutoBodyShop extends MetaJsonLd implements AutoBodyShopInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'AutoBodyShop';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/AutoBodyShop';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'Auto body shop.';
