 ...
 */
class AutoBodyShop extends MetaJsonLd implements AutoBodyShopInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use AutoBodyShopTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AutoBodyShop';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AutoBodyShop';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Auto body shop.';
