...
/**
 * SpeakableSpecification - A SpeakableSpecification indicates (typically via
 * xpath or cssSelector) sections of a document that are highlighted as
...
class SpeakableSpecification extends Intangible
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'SpeakableSpecification';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A SpeakableSpecification indicates (typically via xpath or cssSelector) sections of a document that are highlighted as particularly speakable. Instances of this type are expected to be used primarily as values of the speakable property.';
