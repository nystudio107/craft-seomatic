...
class GeoCoordinates extends StructuredValue
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GeoCoordinates';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GeoCoordinates';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The geographic coordinates of a place or event.';
