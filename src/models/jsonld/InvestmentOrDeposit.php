 ...
 * InvestmentOrDeposit - A type of financial product that typically requires the client to transfer
 ...
 */
class InvestmentOrDeposit extends MetaJsonLd implements InvestmentOrDepositInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'InvestmentOrDeposit';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/InvestmentOrDeposit';
