...
/**
 * MediaReview - (editorial work in progress, this definition is incomplete
 * and unreviewed) A MediaReview is a more specialized form of Review
 * dedicated to the evaluation of media content online, typically in the
 * context of fact-checking and misinformation. For more general reviews of
 * media in the broader sense, use UserReview, CriticReview or other Review
 * types.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/MediaReview
 */
class MediaReview extends Review
{
    ...
    public function rules(): array
    {
        ...
        $rules = array_merge($rules, [
            [['mediaAuthenticityCategory'], 'validateJsonSchema'],
