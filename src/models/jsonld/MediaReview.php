 ...
 * MediaReview - A [[MediaReview]] is a more specialized form of Review dedicated to the
 ...
 * the broader sense, use [[UserReview]], [[CriticReview]] or other [[Review]]
 * types. This definition is     a work in progress. While the
 * [[MediaManipulationRatingEnumeration]] list reflects significant community
 * review amongst fact-checkers and others working     to combat
 * misinformation, the specific structures for representing media objects,
 * their versions and publication context, are still evolving. Similarly, best
 * practices for the relationship between [[MediaReview]] and [[ClaimReview]]
...
class MediaReview extends MetaJsonLd implements MediaReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'MediaReview';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/MediaReview';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'mediaAuthenticityCategory' => ['array', 'MediaManipulationRatingEnumeration', 'MediaManipulationRatingEnumeration[]'],
		    ...
		    'originalMediaContextDescription' => ['array', 'Text', 'Text[]'],
		    'originalMediaLink' => ['array', 'MediaObject', 'MediaObject[]', 'array', 'URL', 'URL[]', 'array', 'WebPage', 'WebPage[]'],
