 ...
 * their versions and publication context, is still evolving. Similarly, best
...
class MediaReview extends MetaJsonLd implements MediaReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MediaReview';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MediaReview';
...
SCHEMADESC;
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'mentions' => ['Thing'],
            'name' => ['Text'],
            'negativeNotes' => ['ListItem', 'Text', 'WebContent', 'ItemList'],
            'offers' => ['Offer', 'Demand'],
            'originalMediaContextDescription' => ['Text'],
            'originalMediaLink' => ['URL', 'MediaObject', 'WebPage'],
            'pattern' => ['DefinedTerm', 'Text'],
            'position' => ['Integer', 'Text'],
            'positiveNotes' => ['WebContent', 'Text', 'ListItem', 'ItemList'],
    ...
    public function getSchemaPropertyDescriptions(): array
    {
        return [
            ...
            'negativeNotes' => 'Indicates, in the context of a [[Review]] (e.g. framed as \'pro\' vs \'con\' considerations), negative considerations - either as unstructured text, or a list.',
            ...
            'positiveNotes' => 'Indicates, in the context of a [[Review]] (e.g. framed as \'pro\' vs \'con\' considerations), positive considerations - either as unstructured text, or a list.',
