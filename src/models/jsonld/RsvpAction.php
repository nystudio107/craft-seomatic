 ...
 * RsvpAction - The act of notifying an event organizer as to whether you expect to attend
 * the event.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class RsvpAction extends MetaJsonLd implements RsvpActionInterface, InformActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'additionalNumberOfGuests' => ['array', 'Number', 'Number[]'],
            ...
            'rsvpResponse' => ['array', 'RsvpResponseType', 'RsvpResponseType[]'],
