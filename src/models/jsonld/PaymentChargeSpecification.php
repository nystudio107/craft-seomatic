 ...
 */
class PaymentChargeSpecification extends MetaJsonLd implements PaymentChargeSpecificationInterface, PriceSpecificationInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PaymentChargeSpecification';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PaymentChargeSpecification';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PriceSpecification';
...
SCHEMADESC;
    ...
    use PaymentChargeSpecificationTrait;
