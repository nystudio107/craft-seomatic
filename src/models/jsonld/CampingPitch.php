...
class CampingPitch extends Accommodation
{
     ...
     * @var string
     */
    static $schemaTypeName = 'CampingPitch';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/CampingPitch';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A camping pitch is an individual place for overnight stay in the outdoors, typically being part of a larger camping site. See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.';
