 ...
 */
class ArtGallery extends MetaJsonLd implements ArtGalleryInterface, EntertainmentBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
	use ArtGalleryTrait;
