...
class TrackAction extends MetaJsonLd implements TrackActionInterface, FindActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TrackAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TrackAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'FindAction';
