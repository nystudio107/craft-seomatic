 ...
 * Pediatric - A specific branch of medical science that specializes in the care of
 ...
 */
class Pediatric extends MetaJsonLd implements PediatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use PediatricTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Pediatric';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Pediatric';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A specific branch of medical science that specializes in the care of infants, children and adolescents.';
