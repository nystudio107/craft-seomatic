...
class Pediatric extends MetaJsonLd implements PediatricInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Pediatric';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Pediatric';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A specific branch of medical science that specializes in the care of infants, children and adolescents.';
