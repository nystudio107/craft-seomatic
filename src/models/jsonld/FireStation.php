 ...
 */
class FireStation extends MetaJsonLd implements FireStationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, EmergencyServiceInterface, LocalBusinessInterface, OrganizationInterface
{
	use FireStationTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'FireStation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/FireStation';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A fire station. With firemen.';
