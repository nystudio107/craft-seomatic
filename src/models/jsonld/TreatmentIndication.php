...
/**
 * TreatmentIndication - An indication for treating an underlying condition,
 * symptom, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class TreatmentIndication extends MedicalIndication
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An indication for treating an underlying condition, symptom, etc.';
