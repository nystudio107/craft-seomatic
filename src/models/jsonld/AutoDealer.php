 ...
 */
class AutoDealer extends MetaJsonLd implements AutoDealerInterface, AutomotiveBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use AutoDealerTrait;
