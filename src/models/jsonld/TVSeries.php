 ...
 * TVSeries - CreativeWorkSeries dedicated to TV broadcast and associated online
 * delivery.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class TVSeries extends MetaJsonLd implements TVSeriesInterface, CreativeWorkInterface, ThingInterface, CreativeWorkSeriesInterface, SeriesInterface, IntangibleInterface
{
	use TVSeriesTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'TVSeries';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/TVSeries';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'CreativeWorkSeries dedicated to TV broadcast and associated online delivery.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'titleEIDR' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
