 ...
 */
class TVSeries extends MetaJsonLd implements TVSeriesInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TVSeries';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TVSeries';
