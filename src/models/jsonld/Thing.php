...
class Thing extends JsonLd
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Thing';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Thing';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The most generic type of item.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            ...
            [['name','description'], 'required', 'on' => ['google'], 'message' => 'This property is required by Google.'],
            [['url','image'], 'required', 'on' => ['google'], 'message' => 'This property is recommended by Google.'],
        ]);
