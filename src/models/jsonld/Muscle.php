...
class Muscle extends MetaJsonLd implements MuscleInterface, AnatomicalStructureInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Muscle';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Muscle';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'antagonist' => ['array', 'Muscle', 'Muscle[]'],
            'associatedPathophysiology' => ['array', 'Text', 'Text[]'],
            'bloodSupply' => ['array', 'Vessel', 'Vessel[]'],
