 ...
 * AuthoritativeLegalValue - Indicates that the publisher gives some special status to the publication
 ...
 */
class AuthoritativeLegalValue extends MetaJsonLd implements AuthoritativeLegalValueInterface, LegalValueLevelInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
...
SCHEMADESC;
    ...
    use AuthoritativeLegalValueTrait;
