 ...
 * CrossSectional - Studies carried out on pre-existing data (usually from 'snapshot' surveys),
 ...
 */
class CrossSectional extends MetaJsonLd implements CrossSectionalInterface, MedicalObservationalStudyDesignInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CrossSectional';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CrossSectional';
