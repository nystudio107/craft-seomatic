...
/**
 * LifestyleModification - A process of care involving exercise, changes to
 * diet, fitness routines, and other lifestyle changes aimed at improving a
 * health condition.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class LifestyleModification extends MedicalEntity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'LifestyleModification';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A process of care involving exercise, changes to diet, fitness routines, and other lifestyle changes aimed at improving a health condition.';
