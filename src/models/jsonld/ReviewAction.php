 ...
 */
class ReviewAction extends MetaJsonLd implements ReviewActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ReviewAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ReviewAction';
