 ...
 */
class ElectronicsStore extends MetaJsonLd implements ElectronicsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ElectronicsStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ElectronicsStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ElectronicsStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An electronics store.';
