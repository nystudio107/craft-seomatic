...
class ElectronicsStore extends MetaJsonLd implements ElectronicsStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'ElectronicsStore';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/ElectronicsStore';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An electronics store.';
