...
/**
 * ComicSeries - A sequential publication of comic stories under a unifying
 * title, for example "The Amazing Spider-Man" or "Groo the Wanderer".
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class ComicSeries extends Periodical
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A sequential publication of comic stories under a unifying title, for example "The Amazing Spider-Man" or "Groo the Wanderer".';
