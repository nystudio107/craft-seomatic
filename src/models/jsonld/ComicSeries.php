 ...
 * ComicSeries - A sequential publication of comic stories under a     	unifying title, for
 ...
 */
class ComicSeries extends MetaJsonLd implements ComicSeriesInterface, PeriodicalInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ComicSeries';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ComicSeries';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Periodical';
