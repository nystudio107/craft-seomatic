 ...
 * WebPageElement content. It is sometimes the case that detailed distinctions
 * between Web pages, sites and their parts is not always important or
 * obvious. The WebContent type makes it easier to describe Web-addressable
 * content without requiring such distinctions to always be stated. (The
 * intent is that the existing types WebPage, WebSite and WebPageElement will
 * eventually be declared as subtypes of WebContent.)
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/WebContent
 */
class WebContent extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'WebContent';
