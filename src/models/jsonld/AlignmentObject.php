...
class AlignmentObject extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AlignmentObject';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AlignmentObject';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An intangible item that describes an alignment between a learning resource and a node in an educational framework.';
