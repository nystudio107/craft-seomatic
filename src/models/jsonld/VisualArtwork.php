 ...
 */
class VisualArtwork extends MetaJsonLd implements VisualArtworkInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VisualArtwork';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/VisualArtwork';
