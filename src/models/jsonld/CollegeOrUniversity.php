 ...
 */
class CollegeOrUniversity extends MetaJsonLd implements CollegeOrUniversityInterface, EducationalOrganizationInterface, CivicStructureInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
    use CollegeOrUniversityTrait;
