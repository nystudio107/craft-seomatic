 ...
 * MedicalIndication - A condition or factor that indicates use of a medical therapy, including
 ...
 */
class MedicalIndication extends MetaJsonLd implements MedicalIndicationInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MedicalIndication';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MedicalIndication';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc.';
