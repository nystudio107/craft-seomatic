...
class MedicalIndication extends MetaJsonLd implements MedicalIndicationInterface, MedicalEntityInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'MedicalIndication';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/MedicalIndication';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc.';
