...
/**
 * MedicalIndication - A condition or factor that indicates use of a medical
 * therapy, including signs, symptoms, risk factors, anatomical states, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class MedicalIndication extends MedicalEntity
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MedicalIndication';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/MedicalIndication';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A condition or factor that indicates use of a medical therapy, including signs, symptoms, risk factors, anatomical states, etc.';
