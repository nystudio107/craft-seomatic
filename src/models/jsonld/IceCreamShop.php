 ...
 */
class IceCreamShop extends MetaJsonLd implements IceCreamShopInterface, FoodEstablishmentInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use IceCreamShopTrait;
