...
class Game extends CreativeWork
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Game';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Game';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The Game type represents things which are games. These are typically rule-governed recreational activities, e.g. role-playing games in which players assume the role of characters in a fictional setting.';
