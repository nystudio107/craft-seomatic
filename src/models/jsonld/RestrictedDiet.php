...
class RestrictedDiet extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RestrictedDiet';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RestrictedDiet';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A diet restricted to certain foods or preparations for cultural, religious, health or lifestyle reasons.';
