 ...
 * LinkRole - A Role that represents a Web link e.g. as expressed via the 'url' property.
...
class LinkRole extends MetaJsonLd implements LinkRoleInterface, RoleInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'LinkRole';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/LinkRole';
