...
/**
 * PublicToilet - A public toilet is a room or small building containing one
 * or more toilets (and possibly also urinals) which is available for use by
 * the general public, or by customers or employees of certain businesses.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class PublicToilet extends CivicStructure
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PublicToilet';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses.';
