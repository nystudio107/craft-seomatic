...
class BedAndBreakfast extends LodgingBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BedAndBreakfast';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BedAndBreakfast';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Bed and breakfast. See also the dedicated document on the use of schema.org for marking up hotels and other forms of accommodations.';
