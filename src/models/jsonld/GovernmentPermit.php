...
class GovernmentPermit extends Permit
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GovernmentPermit';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GovernmentPermit';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A permit issued by a government agency.';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'Permit';
