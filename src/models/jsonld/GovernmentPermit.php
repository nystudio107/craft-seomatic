...
class GovernmentPermit extends MetaJsonLd implements GovernmentPermitInterface, PermitInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'GovernmentPermit';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/GovernmentPermit';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Permit';
