 ...
 * AgreeAction - The act of expressing a consistency of opinion with the object. An agent
 ...
 */
class AgreeAction extends MetaJsonLd implements AgreeActionInterface, ReactActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
    use AgreeActionTrait;
    use ReactActionTrait;
    use AssessActionTrait;
    use ActionTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AgreeAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AgreeAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants.';
