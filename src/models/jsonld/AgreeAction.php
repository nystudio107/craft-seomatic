...
/**
 * AgreeAction - The act of expressing a consistency of opinion with the
 * object. An agent agrees to/about an object (a proposition, topic or theme)
 * with participants.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class AgreeAction extends ReactAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AgreeAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/AgreeAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants.';
