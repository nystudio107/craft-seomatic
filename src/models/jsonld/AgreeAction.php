...
class AgreeAction extends MetaJsonLd implements AgreeActionInterface, ReactActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'AgreeAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/AgreeAction';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants.';
