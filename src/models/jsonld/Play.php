...
/**
 * Play - A play is a form of literature, usually consisting of dialogue
 * between characters, intended for theatrical performance rather than just
 * reading. Note the peformance of a Play would be a TheaterEvent - the Play
...
class Play extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Play';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Play';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A play is a form of literature, usually consisting of dialogue between characters, intended for theatrical performance rather than just reading. Note the peformance of a Play would be a TheaterEvent - the Play being the workPerformed.';
