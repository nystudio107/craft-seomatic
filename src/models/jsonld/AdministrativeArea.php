...
class AdministrativeArea extends Place
{
     ...
     * @var string
     */
    static $schemaTypeName = 'AdministrativeArea';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/AdministrativeArea';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A geographical region, typically under the jurisdiction of a particular government.';
