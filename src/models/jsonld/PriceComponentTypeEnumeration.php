 ...
 * PriceComponentTypeEnumeration - Enumerates different price components that together make up the total price
...
class PriceComponentTypeEnumeration extends MetaJsonLd implements PriceComponentTypeEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PriceComponentTypeEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PriceComponentTypeEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Enumerates different price components that together make up the total price for an offered product.';
