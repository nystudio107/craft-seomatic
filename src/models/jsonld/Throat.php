 ...
 */
class Throat extends MetaJsonLd implements ThroatInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Throat';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Throat';
