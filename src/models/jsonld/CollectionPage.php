...
class CollectionPage extends MetaJsonLd implements CollectionPageInterface, WebPageInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'CollectionPage';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/CollectionPage';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Web page type: Collection page.';
