...
class PerformingArtsTheater extends CivicStructure
{
     ...
     * @var string
     */
    static $schemaTypeName = 'PerformingArtsTheater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/PerformingArtsTheater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A theater or other performing art center.';
