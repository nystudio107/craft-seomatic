 ...
 * Statement - A statement about something, for example a fun or interesting fact. If
 * known, the main entity this statement is about can be indicated using
 * mainEntity. For more formal claims (e.g. in Fact Checking), consider using
 * [[Claim]] instead. Use the [[text]] property to capture the text of the
 * statement.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class Statement extends MetaJsonLd implements StatementInterface, CreativeWorkInterface, ThingInterface
{
    use StatementTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Statement';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Statement';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A statement about something, for example a fun or interesting fact. If known, the main entity this statement is about can be indicated using mainEntity. For more formal claims (e.g. in Fact Checking), consider using [[Claim]] instead. Use the [[text]] property to capture the text of the statement.';
