 ...
 * CancelAction - The act of asserting that a future event/action is no longer going to
 * happen.  Related actions:  * [[ConfirmAction]]: The antonym of
 * CancelAction.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class CancelAction extends MetaJsonLd implements CancelActionInterface, PlanActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'CancelAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/CancelAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of asserting that a future event/action is no longer going to happen.\n\nRelated actions:\n\n* [[ConfirmAction]]: The antonym of CancelAction.';
