 ...
 */
class RecyclingCenter extends MetaJsonLd implements RecyclingCenterInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use RecyclingCenterTrait;
