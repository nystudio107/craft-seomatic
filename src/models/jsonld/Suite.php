...
class Suite extends MetaJsonLd implements SuiteInterface, AccommodationInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Suite';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Suite';
