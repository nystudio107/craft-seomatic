 ...
 * MedicalTrial - A medical trial is a type of medical study that uses scientific process
 ...
 */
class MedicalTrial extends MetaJsonLd implements MedicalTrialInterface, MedicalStudyInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalTrial';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalTrial';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalStudy';
