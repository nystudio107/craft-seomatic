...
/**
 * BrainStructure - Any anatomical structure which pertains to the soft
 * nervous tissue functioning as the coordinating center of sensation and
...
class BrainStructure extends AnatomicalStructure
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BrainStructure';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BrainStructure';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Any anatomical structure which pertains to the soft nervous tissue functioning as the coordinating center of sensation and intellectual and nervous activity.';
