 ...
 */
class ConvenienceStore extends MetaJsonLd implements ConvenienceStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use ConvenienceStoreTrait;
	use StoreTrait;
