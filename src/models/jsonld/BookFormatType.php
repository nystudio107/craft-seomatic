...
class BookFormatType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BookFormatType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BookFormatType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The publication format of the book.';
