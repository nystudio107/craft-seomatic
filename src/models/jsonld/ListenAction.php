...
class ListenAction extends ConsumeAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ListenAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ListenAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of consuming audio content.';
