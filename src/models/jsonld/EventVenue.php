 ...
 */
class EventVenue extends MetaJsonLd implements EventVenueInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use EventVenueTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EventVenue';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EventVenue';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An event venue.';
