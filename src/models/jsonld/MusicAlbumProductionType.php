 ...
 * MusicAlbumProductionType - Classification of the album by it's type of content: soundtrack, live
...
class MusicAlbumProductionType extends MetaJsonLd implements MusicAlbumProductionTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MusicAlbumProductionType';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MusicAlbumProductionType';
