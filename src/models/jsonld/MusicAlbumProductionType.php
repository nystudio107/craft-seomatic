...
/**
 * MusicAlbumProductionType - Classification of the album by it's type of
 * content: soundtrack, live album, studio album, etc.
 * Extends: Enumeration
...
class MusicAlbumProductionType extends Enumeration
{
     ...
     * @var string
     */
    static $schemaTypeName = 'MusicAlbumProductionType';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/MusicAlbumProductionType';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Classification of the album by it\'s type of content: soundtrack, live album, studio album, etc.';
