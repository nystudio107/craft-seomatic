...
class MusicAlbumProductionType extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'MusicAlbumProductionType';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Classification of the album by it\'s type of content: soundtrack, live album, studio album, etc.';
