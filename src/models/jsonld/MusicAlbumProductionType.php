 ...
 * MusicAlbumProductionType - Classification of the album by its type of content: soundtrack, live album,
 * studio album, etc.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class MusicAlbumProductionType extends MetaJsonLd implements MusicAlbumProductionTypeInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MusicAlbumProductionType';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MusicAlbumProductionType';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Classification of the album by its type of content: soundtrack, live album, studio album, etc.';
