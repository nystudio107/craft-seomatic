...
/**
 * PathologyTest - A medical test performed by a laboratory that typically
...
class PathologyTest extends MedicalTest
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PathologyTest';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist.';
    ...
    */
    public function rules()
    {
        ...
        $rules = array_merge($rules, [
            [['tissueSample'], 'validateJsonSchema'],
