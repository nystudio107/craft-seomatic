 ...
 * PathologyTest - A medical test performed by a laboratory that typically involves
 ...
 */
class PathologyTest extends MetaJsonLd implements PathologyTestInterface, MedicalTestInterface, MedicalEntityInterface, ThingInterface
{
    use PathologyTestTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'PathologyTest';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/PathologyTest';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'normalRange' => ['array', 'MedicalEnumeration', 'MedicalEnumeration[]', 'array', 'Text', 'Text[]'],
            'potentialAction' => ['array', 'Action', 'Action[]'],
            'recognizingAuthority' => ['array', 'Organization', 'Organization[]'],
            'relevantSpecialty' => ['array', 'MedicalSpecialty', 'MedicalSpecialty[]'],
            'sameAs' => ['array', 'URL', 'URL[]'],
            'signDetected' => ['array', 'MedicalSign', 'MedicalSign[]'],
            'study' => ['array', 'MedicalStudy', 'MedicalStudy[]'],
            'subjectOf' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'Event', 'Event[]'],
            'tissueSample' => ['array', 'Text', 'Text[]'],
            'url' => ['array', 'URL', 'URL[]'],
            'usedToDiagnose' => ['array', 'MedicalCondition', 'MedicalCondition[]'],
            'usesDevice' => ['array', 'MedicalDevice', 'MedicalDevice[]'],
        ];
    }
