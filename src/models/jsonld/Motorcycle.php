...
/**
 * Motorcycle - A motorcycle or motorbike is a single-track, two-wheeled motor
 * vehicle.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Motorcycle extends Vehicle
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A motorcycle or motorbike is a single-track, two-wheeled motor vehicle.';
