 ...
 * VoteAction - The act of expressing a preference from a fixed/finite/structured set of
 * choices/options.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class VoteAction extends MetaJsonLd implements VoteActionInterface, ChooseActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VoteAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/VoteAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'ChooseAction';
