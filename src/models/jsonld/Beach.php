 ...
 */
class Beach extends MetaJsonLd implements BeachInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
    use BeachTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Beach';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Beach';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'Beach.';
