 ...
 */
class Nose extends MetaJsonLd implements NoseInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Nose';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Nose';
