 ...
 */
class BookStore extends MetaJsonLd implements BookStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use BookStoreTrait;
	use StoreTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'BookStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/BookStore';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A bookstore.';
