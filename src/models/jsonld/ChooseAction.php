 ...
 * ChooseAction - The act of expressing a preference from a set of options or a large or
 ...
 */
class ChooseAction extends MetaJsonLd implements ChooseActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ChooseAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ChooseAction';
