 ...
 * AchieveAction - The act of accomplishing something via previous efforts. It is an
 ...
 */
class AchieveAction extends MetaJsonLd implements AchieveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'AchieveAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/AchieveAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process.';
