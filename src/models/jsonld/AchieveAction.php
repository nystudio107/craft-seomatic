...
class AchieveAction extends MetaJsonLd implements AchieveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'AchieveAction';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/AchieveAction';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process.';
