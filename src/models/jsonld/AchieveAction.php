...
/**
 * AchieveAction - The act of accomplishing something via previous efforts. It
 * is an instantaneous action rather than an ongoing process.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class AchieveAction extends Action
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'AchieveAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/AchieveAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of accomplishing something via previous efforts. It is an instantaneous action rather than an ongoing process.';
