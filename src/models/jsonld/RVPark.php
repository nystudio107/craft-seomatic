 ...
 * RVPark - A place offering space for "Recreational Vehicles", Caravans, mobile homes
 * and the like.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class RVPark extends MetaJsonLd implements RVParkInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'RVPark';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/RVPark';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like.';
