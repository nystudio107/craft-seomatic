...
class RVPark extends CivicStructure
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RVPark';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RVPark';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like.';
