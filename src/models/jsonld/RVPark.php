...
/**
 * RVPark - A place offering space for "Recreational Vehicles", Caravans,
...
class RVPark extends CivicStructure
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'RVPark';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/RVPark';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like.';
