 ...
 * actions: RegisterAction: antonym of UnRegisterAction. Leave: Unlike
...
class UnRegisterAction extends InteractAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'UnRegisterAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/UnRegisterAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of un-registering from a service. Related actions: RegisterAction: antonym of UnRegisterAction. Leave: Unlike LeaveAction, UnRegisterAction implies that you are unregistering from a service you werer previously registered, rather than leaving a team/group of people.';
