 ...
 */
class FloorPlan extends MetaJsonLd implements FloorPlanInterface, IntangibleInterface, ThingInterface
{
    use FloorPlanTrait;
    use IntangibleTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'FloorPlan';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/FloorPlan';
