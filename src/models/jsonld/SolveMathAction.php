 ...
 * SolveMathAction - The action that takes in a math expression and directs users to a page
 ...
 */
class SolveMathAction extends MetaJsonLd implements SolveMathActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'SolveMathAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/SolveMathAction';
