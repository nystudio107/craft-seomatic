 ...
 */
class ParentAudience extends MetaJsonLd implements ParentAudienceInterface, PeopleAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ParentAudience';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ParentAudience';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'PeopleAudience';
