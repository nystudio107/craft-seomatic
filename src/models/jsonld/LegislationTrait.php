...
trait LegislationTrait
{
     ...
     * that have legal impact, use <a
     * href="/legislationAmends">legislationAmends</a>).
     *
     * @var array|Legislation|Legislation[]
     */
    public $legislationCorrects;

    /**
     * The person or organization that countersigned the legislation. Depending on
     * the legal context, a countersignature can indicate that the signed
     * authority undertakes to assume responsibility for texts emanating from a
     * person who is inviolable and irresponsible, (for example a King, Grand Duc
     * or President), or that the authority is in charge of the implementation of
     * the text.
     *
     * @var array|Organization|Organization[]|array|Person|Person[]
     */
    public $legislationCountersignedBy;
     ...
     * distinct from the date of entry into force : a text may come in force
     * today, and state it will become applicable in 3 months.
     *
     * @var array|Date|Date[]
     */
    public $legislationDateOfApplicability;
     ...
     * not contradict to an EU regulation or decision. This implies a legal
     * meaning. Transpositions of EU Directive should be captured with <a
     * href="/legislationTransposes">legislationTransposes</a>.
     *
     * @var array|Legislation|Legislation[]
     */
    public $legislationEnsuresImplementationOf;
