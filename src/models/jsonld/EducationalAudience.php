...
class EducationalAudience extends MetaJsonLd implements EducationalAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'EducationalAudience';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/EducationalAudience';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Audience';
