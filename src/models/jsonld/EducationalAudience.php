 ...
 */
class EducationalAudience extends MetaJsonLd implements EducationalAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
    use EducationalAudienceTrait;
    use AudienceTrait;
    use IntangibleTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EducationalAudience';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EducationalAudience';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An EducationalAudience.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'educationalRole' => ['array', 'Text', 'Text[]'],
