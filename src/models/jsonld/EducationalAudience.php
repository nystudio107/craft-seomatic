...
class EducationalAudience extends MetaJsonLd implements EducationalAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'EducationalAudience';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/EducationalAudience';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An EducationalAudience.';
