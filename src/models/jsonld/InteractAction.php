...
/**
 * InteractAction - The act of interacting with another person or
 * organization.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class InteractAction extends Action
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'InteractAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/InteractAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of interacting with another person or organization.';
