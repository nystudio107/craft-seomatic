...
class InteractAction extends Action
{
     ...
     * @var string
     */
    static $schemaTypeName = 'InteractAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/InteractAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of interacting with another person or organization.';
