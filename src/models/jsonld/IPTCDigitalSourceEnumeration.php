 ...
 * IPTCDigitalSourceEnumeration - <a href="https://www.iptc.org/">IPTC</a> "Digital Source" codes for use
 ...
 */
class IPTCDigitalSourceEnumeration extends MetaJsonLd implements IPTCDigitalSourceEnumerationInterface, MediaEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'IPTCDigitalSourceEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/IPTCDigitalSourceEnumeration';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'MediaEnumeration';
