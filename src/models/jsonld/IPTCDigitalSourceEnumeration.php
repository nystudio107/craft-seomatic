...
class IPTCDigitalSourceEnumeration extends MetaJsonLd implements IPTCDigitalSourceEnumerationInterface, MediaEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'IPTCDigitalSourceEnumeration';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/IPTCDigitalSourceEnumeration';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'MediaEnumeration';
