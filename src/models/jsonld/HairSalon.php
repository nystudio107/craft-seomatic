 ...
 */
class HairSalon extends MetaJsonLd implements HairSalonInterface, HealthAndBeautyBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use HairSalonTrait;
