...
class SelfStorage extends MetaJsonLd implements SelfStorageInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'SelfStorage';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/SelfStorage';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A self-storage facility.';
