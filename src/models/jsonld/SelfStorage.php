 ...
 */
class SelfStorage extends MetaJsonLd implements SelfStorageInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use SelfStorageTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SelfStorage';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SelfStorage';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A self-storage facility.';
