...
class ParkingFacility extends CivicStructure
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ParkingFacility';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ParkingFacility';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A parking lot or other parking facility.';
