 ...
 */
class GardenStore extends MetaJsonLd implements GardenStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'GardenStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/GardenStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A garden store.';
