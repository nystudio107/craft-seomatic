 ...
 */
class PrependAction extends MetaJsonLd implements PrependActionInterface, InsertActionInterface, AddActionInterface, UpdateActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PrependAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PrependAction';
