 ...
 * MathSolver - A math solver which is capable of solving a subset of mathematical
 * problems.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class MathSolver extends MetaJsonLd implements MathSolverInterface, CreativeWorkInterface, ThingInterface
{
    use MathSolverTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'MathSolver';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/MathSolver';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A math solver which is capable of solving a subset of mathematical problems.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'mathExpression' => ['array', 'SolveMathAction', 'SolveMathAction[]', 'array', 'Text', 'Text[]'],
