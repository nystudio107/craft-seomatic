...
class MathSolver extends MetaJsonLd implements MathSolverInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'MathSolver';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/MathSolver';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A math solver which is capable of solving a subset of mathematical problems.';
