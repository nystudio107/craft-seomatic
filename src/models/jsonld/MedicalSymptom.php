...
class MedicalSymptom extends MetaJsonLd implements MedicalSymptomInterface, MedicalSignOrSymptomInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalSymptom';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalSymptom';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalSignOrSymptom';
