 ...
 */
class TaxiReservation extends MetaJsonLd implements TaxiReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
    use TaxiReservationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'TaxiReservation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/TaxiReservation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A reservation for a taxi.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].';
