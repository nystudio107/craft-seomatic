 ...
 * PodcastSeason - A single season of a podcast. Many podcasts do not break down into separate
 ...
 */
class PodcastSeason extends MetaJsonLd implements PodcastSeasonInterface, CreativeWorkSeasonInterface, CreativeWorkInterface, ThingInterface
{
	use PodcastSeasonTrait;
	use CreativeWorkSeasonTrait;
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'seasonNumber' => ['array', 'Integer', 'Integer[]', 'array', 'Text', 'Text[]'],
