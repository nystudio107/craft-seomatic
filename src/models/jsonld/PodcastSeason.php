...
/**
 * PodcastSeason - A single season of a podcast. Many podcasts do not break
 * down into separate seasons. In that case, PodcastSeries should be used.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/PodcastSeason
 */
class PodcastSeason extends CreativeWorkSeason
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PodcastSeason';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PodcastSeason';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used.';
