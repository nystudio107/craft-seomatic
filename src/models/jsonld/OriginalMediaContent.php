...
class OriginalMediaContent extends MetaJsonLd implements OriginalMediaContentInterface, MediaManipulationRatingEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'OriginalMediaContent';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/OriginalMediaContent';
