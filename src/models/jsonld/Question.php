 ...
 * Question - A specific question - e.g. from a user seeking answers online, or collected
 ...
 */
class Question extends MetaJsonLd implements QuestionInterface, CommentInterface, CreativeWorkInterface, ThingInterface
{
    use QuestionTrait;
    use CommentTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Question';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Question';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A specific question - e.g. from a user seeking answers online, or collected in a Frequently Asked Questions (FAQ) document.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'acceptedAnswer' => ['array', 'ItemList', 'ItemList[]', 'array', 'Answer', 'Answer[]'],
            ...
            'answerCount' => ['array', 'Integer', 'Integer[]'],
            ...
            'downvoteCount' => ['array', 'Integer', 'Integer[]'],
            'editEIDR' => ['array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
            'editor' => ['array', 'Person', 'Person[]'],
            'eduQuestionType' => ['array', 'Text', 'Text[]'],
            ...
            'parentItem' => ['array', 'CreativeWork', 'CreativeWork[]', 'array', 'Comment', 'Comment[]'],
            ...
            'sharedContent' => ['array', 'CreativeWork', 'CreativeWork[]'],
            ...
            'suggestedAnswer' => ['array', 'Answer', 'Answer[]', 'array', 'ItemList', 'ItemList[]'],
            ...
            'upvoteCount' => ['array', 'Integer', 'Integer[]'],
            'url' => ['array', 'URL', 'URL[]'],
