...
class RiverBodyOfWater extends BodyOfWater
{
     ...
     * @var string
     */
    static $schemaTypeName = 'RiverBodyOfWater';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/RiverBodyOfWater';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A river (for example, the broad majestic Shannon).';
