...
class ChildrensEvent extends Event
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ChildrensEvent';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ChildrensEvent';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Event type: Children\'s event.';
