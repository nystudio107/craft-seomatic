...
class ChildrensEvent extends MetaJsonLd implements ChildrensEventInterface, EventInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ChildrensEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ChildrensEvent';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'Event type: Children\'s event.';
