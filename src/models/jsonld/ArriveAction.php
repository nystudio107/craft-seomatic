 ...
 * ArriveAction - The act of arriving at a place. An agent arrives at a destination from a
 ...
 */
class ArriveAction extends MetaJsonLd implements ArriveActionInterface, MoveActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'ArriveAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/ArriveAction';
