...
class EventReservation extends MetaJsonLd implements EventReservationInterface, ReservationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EventReservation';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EventReservation';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A reservation for an event like a concert, sporting event, or lecture.\n\nNote: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use [[Offer]].';
