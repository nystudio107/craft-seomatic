 ...
 */
class DigitalDocument extends MetaJsonLd implements DigitalDocumentInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DigitalDocument';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DigitalDocument';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An electronic file or document.';
