...
class DigitalDocument extends CreativeWork
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DigitalDocument';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DigitalDocument';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An electronic file or document.';
