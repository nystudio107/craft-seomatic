...
class DigitalDocument extends MetaJsonLd implements DigitalDocumentInterface, CreativeWorkInterface, ThingInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'DigitalDocument';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/DigitalDocument';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'An electronic file or document.';
