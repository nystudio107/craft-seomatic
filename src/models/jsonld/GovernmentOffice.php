...
class GovernmentOffice extends LocalBusiness
{
     ...
     * @var string
     */
    static $schemaTypeName = 'GovernmentOffice';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/GovernmentOffice';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A government office—for example, an IRS or DMV office.';
