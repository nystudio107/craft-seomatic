...
class DepartmentStore extends MetaJsonLd implements DepartmentStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'DepartmentStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/DepartmentStore';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A department store.';
