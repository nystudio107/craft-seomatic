 ...
 */
class DepartmentStore extends MetaJsonLd implements DepartmentStoreInterface, StoreInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
    use DepartmentStoreTrait;
    use StoreTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'DepartmentStore';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/DepartmentStore';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A department store.';
