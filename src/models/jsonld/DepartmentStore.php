 ...
 */
class DepartmentStore extends MetaJsonLd implements DepartmentStoreInterface, StoreInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface
{
