...
/**
 * PreventionIndication - An indication for preventing an underlying
...
class PreventionIndication extends MedicalIndication
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An indication for preventing an underlying condition, symptom, etc.';
