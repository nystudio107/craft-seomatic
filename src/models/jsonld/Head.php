 ...
 */
class Head extends MetaJsonLd implements HeadInterface, PhysicalExamInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface, MedicalProcedureInterface, MedicalEntityInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Head';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Head';
