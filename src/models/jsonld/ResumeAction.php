...
/**
 * ResumeAction - The act of resuming a device or application which was
...
class ResumeAction extends ControlAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'ResumeAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/ResumeAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer).';
