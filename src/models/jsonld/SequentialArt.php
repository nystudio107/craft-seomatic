...
class SequentialArt extends MetaJsonLd implements SequentialArtInterface, BookInterface, CreativeWorkInterface, ThingInterface, VisualArtworkInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'SequentialArt';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/SequentialArt';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'Book';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'An art forms that use images deployed in a specific order for the purpose of graphic storytelling (i.e., narration of graphic stories) or conveying information. Examples of SequentialArt are Franco-Belgian Bande Dessinée, Comics in the USA and 漫画 (Manga) in Japan.';
