 ...
 * SequentialArt - An art forms that use images deployed in a specific order for the purpose
 * of graphic storytelling (i.e., narration of graphic stories) or conveying
 * information. Examples of SequentialArt are Franco-Belgian Bande Dessinée,
 * Comics in the USA and 漫画 (Manga) in Japan.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @see       https://schema.org/SequentialArt
 */
class SequentialArt extends MetaJsonLd implements SequentialArtInterface, BookInterface, CreativeWorkInterface, ThingInterface, VisualArtworkInterface
{
	use SequentialArtTrait;
	use BookTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'SequentialArt';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/SequentialArt';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Book';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'An art forms that use images deployed in a specific order for the purpose of graphic storytelling (i.e., narration of graphic stories) or conveying information. Examples of SequentialArt are Franco-Belgian Bande Dessinée, Comics in the USA and 漫画 (Manga) in Japan.';
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'abridged' => ['array', 'Boolean', 'Boolean[]'],
		    ...
		    'bookEdition' => ['array', 'Text', 'Text[]'],
		    'bookFormat' => ['array', 'BookFormatType', 'BookFormatType[]'],
		    ...
		    'illustrator' => ['array', 'Person', 'Person[]'],
		    ...
		    'numberOfPages' => ['array', 'Integer', 'Integer[]'],
