 ...
 */
class MedicalClinic extends MetaJsonLd implements MedicalClinicInterface, MedicalOrganizationInterface, OrganizationInterface, ThingInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'MedicalClinic';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/MedicalClinic';
