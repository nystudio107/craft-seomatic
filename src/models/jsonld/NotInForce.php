 ...
 * @package   Seomatic
 * @since     3.0.0
 * @see       http://schema.org/NotInForce
 */
class NotInForce extends LegalForceStatus
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'NotInForce';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Indicates that a legislation is currently not in force.';
