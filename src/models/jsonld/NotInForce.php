 ...
 */
class NotInForce extends MetaJsonLd implements NotInForceInterface, LegalForceStatusInterface, StatusEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'NotInForce';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/NotInForce';
