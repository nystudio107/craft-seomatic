 ...
 * BankAccount - A product or service offered by a bank whereby one may deposit, withdraw or
 ...
 */
class BankAccount extends MetaJsonLd implements BankAccountInterface, FinancialProductInterface, ServiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BankAccount';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BankAccount';
