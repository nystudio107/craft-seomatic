...
class WatchAction extends ConsumeAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'WatchAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/WatchAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'The act of consuming dynamic/moving visual content.';
