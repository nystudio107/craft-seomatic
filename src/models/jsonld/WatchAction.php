...
class WatchAction extends ConsumeAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'WatchAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/WatchAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of consuming dynamic/moving visual content.';
