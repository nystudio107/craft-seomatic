...
/**
 * ClaimReview - A fact-checking review of claims made (or reported) in some
...
class ClaimReview extends Review
{
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A fact-checking review of claims made (or reported) in some creative work (referenced via itemReviewed).';
