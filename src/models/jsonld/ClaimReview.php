 ...
 * ClaimReview - A fact-checking review of claims made (or reported) in some creative work
 ...
 */
class ClaimReview extends MetaJsonLd implements ClaimReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'ClaimReview';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/ClaimReview';
