 ...
 * HowToDirection - A direction indicating a single action to do in the instructions for how to
 * achieve a result.
 *
 * @author    nystudio107
 * @package   Seomatic
 ...
 */
class HowToDirection extends MetaJsonLd implements HowToDirectionInterface, ListItemInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
    use HowToDirectionTrait;
    use ListItemTrait;
    use IntangibleTrait;
    use ThingTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'HowToDirection';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/HowToDirection';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'ListItem';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A direction indicating a single action to do in the instructions for how to achieve a result.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'afterMedia' => ['array', 'MediaObject', 'MediaObject[]', 'array', 'URL', 'URL[]'],
            ...
            'beforeMedia' => ['array', 'MediaObject', 'MediaObject[]', 'array', 'URL', 'URL[]'],
            ...
            'duringMedia' => ['array', 'MediaObject', 'MediaObject[]', 'array', 'URL', 'URL[]'],
