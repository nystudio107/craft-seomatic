...
class HowToDirection extends MetaJsonLd implements HowToDirectionInterface, ListItemInterface, IntangibleInterface, ThingInterface, CreativeWorkInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'HowToDirection';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/HowToDirection';
