 ...
 */
class PreOrderAction extends MetaJsonLd implements PreOrderActionInterface, TradeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'PreOrderAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/PreOrderAction';
