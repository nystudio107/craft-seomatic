...
/**
 * PreOrderAction - An agent orders a (not yet released)
 * object/product/service to be delivered/sent.
 *
 * @author    nystudio107
 * @package   Seomatic
 * @since     3.0.0
...
class PreOrderAction extends TradeAction
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'PreOrderAction';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/PreOrderAction';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'An agent orders a (not yet released) object/product/service to be delivered/sent.';
