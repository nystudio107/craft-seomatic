 ...
 * MedicalBusiness - A particular physical or virtual business of an organization for medical
 ...
 */
class MedicalBusiness extends MetaJsonLd implements MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'MedicalBusiness';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/MedicalBusiness';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A particular physical or virtual business of an organization for medical purposes. Examples of MedicalBusiness include different businesses run by health professionals.';
