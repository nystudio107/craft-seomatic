...
class VitalSign extends MetaJsonLd implements VitalSignInterface, MedicalSignInterface, MedicalSignOrSymptomInterface, MedicalConditionInterface, MedicalEntityInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'VitalSign';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/VitalSign';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalSign';
