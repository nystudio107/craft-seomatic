...
use nystudio107\seomatic\models\jsonld\MedicalSign;

/**
 * VitalSign - Vital signs are measures of various physiological functions in
...
class VitalSign extends MedicalSign
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'VitalSign';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'Vital signs are measures of various physiological functions in order to assess the most basic body functions.';
