...
class Invoice extends Intangible
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Invoice';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Invoice';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'A statement of the money due for goods or services; a bill.';
