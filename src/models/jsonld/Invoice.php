...
class Invoice extends MetaJsonLd implements InvoiceInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'Invoice';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/Invoice';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A statement of the money due for goods or services; a bill.';
