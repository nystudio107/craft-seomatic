 ...
 */
class VideoGameSeries extends MetaJsonLd implements VideoGameSeriesInterface, CreativeWorkSeriesInterface, CreativeWorkInterface, ThingInterface, SeriesInterface, IntangibleInterface
{
	use VideoGameSeriesTrait;
	use CreativeWorkSeriesTrait;
	...
	public function getSchemaPropertyExpectedTypes(): array
	{
		return [
		    ...
		    'containsSeason' => ['array', 'CreativeWorkSeason', 'CreativeWorkSeason[]'],
		    ...
		    'numberOfEpisodes' => ['array', 'Integer', 'Integer[]'],
		    'numberOfPlayers' => ['array', 'QuantitativeValue', 'QuantitativeValue[]'],
		    'numberOfSeasons' => ['array', 'Integer', 'Integer[]'],
		    ...
		    'season' => ['array', 'CreativeWorkSeason', 'CreativeWorkSeason[]', 'array', 'URL', 'URL[]'],
		    'seasons' => ['array', 'CreativeWorkSeason', 'CreativeWorkSeason[]'],
