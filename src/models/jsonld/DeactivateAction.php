...
use nystudio107\seomatic\models\jsonld\ControlAction;

/**
 * DeactivateAction - The act of stopping or deactivating a device or
 * application (e.g. stopping a timer or turning off a flashlight).
...
class DeactivateAction extends ControlAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'DeactivateAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/DeactivateAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of stopping or deactivating a device or application (e.g. stopping a timer or turning off a flashlight).';

    /**
     * The Schema.org Type Extends
     * @var string
     */
    static $schemaTypeExtends = 'ControlAction';
