 ...
 */
class SearchRescueOrganization extends MetaJsonLd implements SearchRescueOrganizationInterface, OrganizationInterface, ThingInterface
{
    use SearchRescueOrganizationTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'SearchRescueOrganization';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/SearchRescueOrganization';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A Search and Rescue organization of some kind.';
