...
class InstallAction extends ConsumeAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'InstallAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/InstallAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'The act of installing an application.';
