...
/**
 * Menu - A structured representation of food or drink items available from a
 * FoodEstablishment.
 *
 * @author    nystudio107
 * @package   Seomatic
...
class Menu extends CreativeWork
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Menu';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Menu';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A structured representation of food or drink items available from a FoodEstablishment.';
