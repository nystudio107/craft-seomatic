 ...
 */
class Oncologic extends MetaJsonLd implements OncologicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'Oncologic';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/Oncologic';
