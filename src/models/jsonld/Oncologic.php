 ...
 */
class Oncologic extends MetaJsonLd implements OncologicInterface, MedicalBusinessInterface, LocalBusinessInterface, PlaceInterface, ThingInterface, OrganizationInterface, MedicalSpecialtyInterface, SpecialtyInterface, EnumerationInterface, IntangibleInterface, MedicalEnumerationInterface
{
	use OncologicTrait;
