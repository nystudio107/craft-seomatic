 ...
 * Oncologic - A specific branch of medical science that deals with benign and malignant
 ...
 */
class Oncologic extends MetaJsonLd implements OncologicInterface, MedicalBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface, MedicalSpecialtyInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, SpecialtyInterface
{
    use OncologicTrait;
