 ...
 */
class Casino extends MetaJsonLd implements CasinoInterface, EntertainmentBusinessInterface, LocalBusinessInterface, OrganizationInterface, ThingInterface, PlaceInterface
{
	use CasinoTrait;
