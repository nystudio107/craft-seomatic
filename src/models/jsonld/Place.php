...
class Place extends Thing
{
     ...
     * @var string
     */
    static $schemaTypeName = 'Place';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/Place';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'Entities that have a somewhat fixed, physical extension.';
