 ...
 */
class EndorseAction extends MetaJsonLd implements EndorseActionInterface, ReactActionInterface, AssessActionInterface, ActionInterface, ThingInterface
{
    use EndorseActionTrait;
     ...
     * @var string
     */
    public static string $schemaTypeName = 'EndorseAction';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/EndorseAction';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'An agent approves/certifies/likes/supports/sanctions an object.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'endorsee' => ['array', 'Organization', 'Organization[]', 'array', 'Person', 'Person[]'],
