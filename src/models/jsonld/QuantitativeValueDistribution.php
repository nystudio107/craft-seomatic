...
class QuantitativeValueDistribution extends StructuredValue
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'QuantitativeValueDistribution';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/QuantitativeValueDistribution';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A statistical distribution of values.';
