 ...
 * TraditionalChinese - A system of medicine based on common theoretical concepts that originated
 ...
 */
class TraditionalChinese extends MetaJsonLd implements TraditionalChineseInterface, MedicineSystemInterface, MedicalEnumerationInterface, EnumerationInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'TraditionalChinese';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/TraditionalChinese';
