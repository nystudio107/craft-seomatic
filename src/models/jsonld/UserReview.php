 ...
 * UserReview - A review created by an end-user (e.g. consumer, purchaser, attendee etc.),
 ...
 */
class UserReview extends MetaJsonLd implements UserReviewInterface, ReviewInterface, CreativeWorkInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'UserReview';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/UserReview';
