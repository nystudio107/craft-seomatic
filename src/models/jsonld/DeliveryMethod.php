...
/**
 * DeliveryMethod - A delivery method is a standardized procedure for
 * transferring the product or service to the destination of fulfillment
 * chosen by the customer. Delivery methods are characterized by the means of
 * transportation used, and by the organization or group that is the
 * contracting party for the sending organization or person. Commonly used
 * values:http://purl.org/goodrelations/v1#DeliveryModeDirectDownload
...
class DeliveryMethod extends Enumeration
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'DeliveryMethod';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/DeliveryMethod';
