...
/**
 * BusReservation - A reservation for bus travel. Note: This type is for
...
class BusReservation extends Reservation
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'BusReservation';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/BusReservation';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A reservation for bus travel. Note: This type is for information about actual reservations, e.g. in confirmation emails or HTML pages with individual confirmations of reservations. For offers of tickets, use Offer.';
