...
class FAQPage extends WebPage
{
     ...
     * @var string
     */
    static public $schemaTypeName = 'FAQPage';
     ...
     * @var string
     */
    static public $schemaTypeScope = 'https://schema.org/FAQPage';
     ...
     * @var string
     */
    static public $schemaTypeDescription = 'A FAQPage is a WebPage presenting one or more "Frequently asked questions" (see also QAPage).';
