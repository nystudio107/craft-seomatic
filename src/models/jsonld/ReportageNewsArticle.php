 ...
 * ReportageNewsArticle - The [[ReportageNewsArticle]] type is a subtype of [[NewsArticle]]
 ...
 */
class ReportageNewsArticle extends MetaJsonLd implements ReportageNewsArticleInterface, NewsArticleInterface, ArticleInterface, CreativeWorkInterface, ThingInterface
{
	use ReportageNewsArticleTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'ReportageNewsArticle';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/ReportageNewsArticle';
