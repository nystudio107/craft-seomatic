...
class EngineSpecification extends StructuredValue
{
     ...
     * https://en.wikipedia.org/wiki/Horsepower#Enginepowertest_codes. Note 2: You
    ...
    static protected $_schemaPropertyDescriptions = [
        ...
        'enginePower' => 'The power of the vehicle\'s engine. Typical unit code(s): KWT for kilowatt, BHP for brake horsepower, N12 for metric horsepower (PS, with 1 PS = 735,49875 W) Note 1: There are many different ways of measuring an engine\'s power. For an overview, see https://en.wikipedia.org/wiki/Horsepower#Enginepowertest_codes. Note 2: You can link to information about how the given value has been determined using the valueReference property. Note 3: You can use minValue and maxValue to indicate ranges.',
