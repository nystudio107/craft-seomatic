...
class EngineSpecification extends StructuredValue
{
     ...
     * pound-force per inchNote 1: You can link to information about how the given
     * value has been determined (e.g. reference RPM) using the valueReference
     * property. Note 2: You can use minValue and maxValue to indicate ranges.
     *
    ...
    static protected $_schemaPropertyDescriptions = [
        ...
        'torque' => 'The torque (turning force) of the vehicle\'s engine. Typical unit code(s): NU for newton metre (N m), F17 for pound-force per foot, or F48 for pound-force per inchNote 1: You can link to information about how the given value has been determined (e.g. reference RPM) using the valueReference property. Note 2: You can use minValue and maxValue to indicate ranges.'
    ];
