...
class EngineSpecification extends MetaJsonLd implements EngineSpecificationInterface, StructuredValueInterface, IntangibleInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'EngineSpecification';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/EngineSpecification';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'Information about the engine of the vehicle. A vehicle can have multiple engines represented by multiple engine specification entities.';
    ...
    public function getSchemaPropertyExpectedTypes(): array
    {
        return [
            ...
            'engineType' => ['array', 'QualitativeValue', 'QualitativeValue[]', 'array', 'Text', 'Text[]', 'array', 'URL', 'URL[]'],
