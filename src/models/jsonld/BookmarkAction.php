 ...
 */
class BookmarkAction extends MetaJsonLd implements BookmarkActionInterface, OrganizeActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'BookmarkAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/BookmarkAction';
