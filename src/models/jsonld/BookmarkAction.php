...
class BookmarkAction extends OrganizeAction
{
     ...
     * @var string
     */
    static $schemaTypeName = 'BookmarkAction';

    /**
     * The Schema.org Type Scope
     * @var string
     */
    static $schemaTypeScope = 'https://schema.org/BookmarkAction';

    /**
     * The Schema.org Type Description
     * @var string
     */
    static $schemaTypeDescription = 'An agent bookmarks/flags/labels/tags/marks an object.';
