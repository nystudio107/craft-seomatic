 ...
 */
class CatholicChurch extends MetaJsonLd implements CatholicChurchInterface, ChurchInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
	use CatholicChurchTrait;
	use ChurchTrait;
	use PlaceOfWorshipTrait;
	 ...
	 * @var string
	 */
	public static string $schemaTypeName = 'CatholicChurch';
	 ...
	 * @var string
	 */
	public static string $schemaTypeScope = 'https://schema.org/CatholicChurch';
	 ...
	 * @var string
	 */
	public static string $schemaTypeExtends = 'Church';
	 ...
	 * @var string
	 */
	public static string $schemaTypeDescription = 'A Catholic church.';
