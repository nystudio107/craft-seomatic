...
class CatholicChurch extends MetaJsonLd implements CatholicChurchInterface, ChurchInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CatholicChurch';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CatholicChurch';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'Church';
