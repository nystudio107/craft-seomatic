...
class CatholicChurch extends MetaJsonLd implements CatholicChurchInterface, ChurchInterface, PlaceOfWorshipInterface, CivicStructureInterface, PlaceInterface, ThingInterface
{
     ...
     * @var string
     */
    public static $schemaTypeName = 'CatholicChurch';
     ...
     * @var string
     */
    public static $schemaTypeScope = 'https://schema.org/CatholicChurch';
     ...
     * @var string
     */
    public static $schemaTypeExtends = 'Church';
     ...
     * @var string
     */
    public static $schemaTypeDescription = 'A Catholic church.';
