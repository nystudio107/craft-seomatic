...
class CheckOutAction extends MetaJsonLd implements CheckOutActionInterface, CommunicateActionInterface, InteractActionInterface, ActionInterface, ThingInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'CheckOutAction';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/CheckOutAction';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'CommunicateAction';
