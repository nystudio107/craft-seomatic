...
class Patient extends MetaJsonLd implements PatientInterface, MedicalAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface, PeopleAudienceInterface, PersonInterface
{
     ...
     * @var string
     */
    static public string $schemaTypeName = 'Patient';
     ...
     * @var string
     */
    static public string $schemaTypeScope = 'https://schema.org/Patient';
     ...
     * @var string
     */
    static public string $schemaTypeExtends = 'MedicalAudience';
