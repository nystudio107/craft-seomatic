...
class Patient extends MetaJsonLd implements PatientInterface, MedicalAudienceInterface, PeopleAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface, PersonInterface
{
     ...
     * @var string
     */
    public static string $schemaTypeName = 'Patient';
     ...
     * @var string
     */
    public static string $schemaTypeScope = 'https://schema.org/Patient';
     ...
     * @var string
     */
    public static string $schemaTypeExtends = 'MedicalAudience';
     ...
     * @var string
     */
    public static string $schemaTypeDescription = 'A patient is any person recipient of health care services.';
