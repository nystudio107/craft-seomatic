...
class Patient extends MetaJsonLd implements PatientInterface, MedicalAudienceInterface, PeopleAudienceInterface, AudienceInterface, IntangibleInterface, ThingInterface, PersonInterface
{
	 ...
	 * @var string
	 */
	public static $schemaTypeName = 'Patient';
	 ...
	 * @var string
	 */
	public static $schemaTypeScope = 'https://schema.org/Patient';
	 ...
	 * @var string
	 */
	public static $schemaTypeDescription = 'A patient is any person recipient of health care services.';
