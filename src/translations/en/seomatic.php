...
return [
    ...
    'The **SEOmatic Environment** setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The **SEOmatic Environment** setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'SEOmatic has been forced into `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled when `devMode` is on' => 'SEOmatic has been forced into `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled when `devMode` is on',
    'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled, and ' => 'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled, and ',
    'Determaines where in the HTML document the script renders.' => 'Determaines where in the HTML document the script renders.',
    'The SEOmatic Environment setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The SEOmatic Environment setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'The SEOmatic Environment setting has been overriden to `local`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The SEOmatic Environment setting has been overriden to `local`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'The __SEOmatic Environment__ setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The __SEOmatic Environment__ setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    ...
    'The SEOmatic Environment setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The SEOmatic Environment setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'The `{settingsEnv}` [SEOmatic Environment]({settingsUrl}) setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The `{settingsEnv}` [SEOmatic Environment]({settingsUrl}) setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled.<br> <br> Tracking scripts are disabled, and ' => 'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled.<br> <br> Tracking scripts are disabled, and ',
    'The SEOmatic Environment setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to {`envVar`}. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The SEOmatic Environment setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to {`envVar`}. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    ...
    'Controls whether SEOmatic will automatically add `hreflang` and `og:locale:alternate` tags.' => 'Controls whether SEOmatic will automatically add `hreflang` and `og:locale:alternate` tags.',
    'The [SEOmatic Environment]({settingsUrl}) setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The [SEOmatic Environment]({settingsUrl}) setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'Tracking scripts are disabled when <code>devMode</code> is on' => 'Tracking scripts are disabled when <code>devMode</code> is on',
    'The *SEOmatic Environment* setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The *SEOmatic Environment* setting has been overriden to `{env}`, because the `devMode` config setting is enabled. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'Determaines where in the `<body>` the script renders.' => 'Determaines where in the `<body>` the script renders.',
    'The **SEOmatic Environment** setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.' => 'The **SEOmatic Environment** setting has been overriden to `{env}`, because the `.env` setting `ENVIRONMENT` is set to `{envVar}`. Tracking scripts are disabled, and the `robots` tag is set to `none` to prevent search engine indexing.',
    'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled when `devMode` is on' => 'SEOmatic has been set to `local` environment, because the `devMode` config setting is enabled. Tracking scripts are disabled when `devMode` is on',
    'SEOmatic uses the `siteUrl` to generate the external URLs.  If you are using it in a non-standard environment, such as a headless ElementAPI server, you can override what it uses for the `siteUrl` below.' => 'SEOmatic uses the `siteUrl` to generate the external URLs.  If you are using it in a non-standard environment, such as a headless ElementAPI server, you can override what it uses for the `siteUrl` below.',
    ...
    'SEOmatic uses the `siteUrl` to generate the external URLs.  If you are using it in a non-standard environment, such as a headless GraphQL or ElementAPI server, you can override what it uses for the `siteUrl` below.' => 'SEOmatic uses the `siteUrl` to generate the external URLs.  If you are using it in a non-standard environment, such as a headless GraphQL or ElementAPI server, you can override what it uses for the `siteUrl` below.',
