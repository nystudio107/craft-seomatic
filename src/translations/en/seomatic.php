...
return [
    ...
    'Primary' => 'Primary',
    'Controls how many entries will there be per page in this sitemap. If there are more entries than this in the sitemap, they will be paginated in additional sitemap indexes.' => 'Controls how many entries will there be per page in this sitemap. If there are more entries than this in the sitemap, they will be paginated in additional sitemap indexes.',
    'An alternate public name for the website. This is used in the JSON-LD for the homepage, if the MainEntityOfPage is WebPage or WebSite.' => 'An alternate public name for the website. This is used in the JSON-LD for the homepage, if the MainEntityOfPage is WebPage or WebSite.',
    'Controls whether sitemap caches will automatically be invalidated when entries are saved.' => 'Controls whether sitemap caches will automatically be invalidated when entries are saved.',
    'Site Alternate Name' => 'Site Alternate Name',
    'Invalidate Sitemap Caches Automatically' => 'Invalidate Sitemap Caches Automatically',
    'View first page of #{currentSourceBundleType |capitalize} Sitemap' => 'View first page of #{currentSourceBundleType |capitalize} Sitemap',
    'Sitemap Page Size' => 'Sitemap Page Size',
